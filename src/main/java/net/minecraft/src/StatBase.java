...
public class StatBase {
	...
	public StatBase registerStat() {
		if(StatRegistry.byId.containsKey(Integer.valueOf(this.statId))) {
			throw new RuntimeException("Duplicate stat id: \"" + ((StatBase)StatRegistry.byId.get(Integer.valueOf(this.statId))).statName + "\" and \"" + this.statName + "\" at id " + this.statId);
		} else {
			StatRegistry.all.add(this);
			StatRegistry.byId.put(Integer.valueOf(this.statId), this);
