...
public class ItemMap extends ItemMapBase {
	...
	public Packet func_28022_b(ItemStack var1, World var2, EntityPlayer var3) {
		byte[] var4 = this.func_28012_a(var1, var2).func_28154_a(var1, var2, var3);
		return var4 == null ? null : new Packet131MapData((short)Item.mapItem.shiftedIndex, (short)var1.getItemDamage(), var4);
	}
}
