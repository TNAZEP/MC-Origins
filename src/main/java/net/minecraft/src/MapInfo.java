...
public class MapInfo {
	...
	public byte[] func_28118_a(ItemStack var1) {
		...
		if(--this.field_28121_f < 0) {
			...
			byte[] var2 = new byte[this.mapDataObj.field_28173_i.size() * 3 + 1];
			var2[0] = 1;

			for(var3 = 0; var3 < this.mapDataObj.field_28173_i.size(); ++var3) {
				MapCoord var4 = (MapCoord)this.mapDataObj.field_28173_i.get(var3);
				var2[var3 * 3 + 1] = (byte)(var4.field_28217_a + (var4.field_28219_d & 15) * 16);
				var2[var3 * 3 + 2] = var4.field_28216_b;
				var2[var3 * 3 + 3] = var4.field_28220_c;
			}
		...
		for(int var8 = 0; var8 < 10; ++var8) {
			var3 = this.field_28122_e * 11 % 128;
			++this.field_28122_e;
			if(this.field_28119_b[var3] >= 0) {
				var10 = this.field_28124_c[var3] - this.field_28119_b[var3] + 1;
				...
				for(int var7 = 0; var7 < var6.length - 3; ++var7) {
					var6[var7 + 3] = this.mapDataObj.field_28176_f[(var7 + var5) * 128 + var3];
				}

				this.field_28124_c[var3] = -1;
