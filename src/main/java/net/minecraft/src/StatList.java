...
public class StatList {
	protected static Map field_25169_C = StatRegistry.byId;
	public static List field_25188_a = StatRegistry.all;
	public static List field_25187_b = StatRegistry.basic;
