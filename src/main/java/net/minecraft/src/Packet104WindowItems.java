...
public class Packet104WindowItems extends Packet {
	...
	public void readPacketData(DataInputStream var1) throws IOException {
		...
		this.itemStack = new ItemStackData<?>[var2];
		...
		for(int var3 = 0; var3 < var2; ++var3) {
			...
			if(var4 >= 0) {
				...
				this.itemStack[var3] = new PacketItemStack(var4, var5, var6);
			}
		}
	...
	public Packet104WindowItems(int var1, List var2) {
		this.windowId = var1;
		this.itemStack = new ItemStackData<?>[var2.size()];

		for(int var3 = 0; var3 < this.itemStack.length; ++var3) {
			ItemStackData<?> var4 = (ItemStackData<?>)var2.get(var3);
