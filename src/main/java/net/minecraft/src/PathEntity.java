...
public class PathEntity {
	...
	public Vec3D getPosition(float width) {
		double var2 = (double)this.points[this.pathIndex].xCoord + (double)((int)(width + 1.0F)) * 0.5D;
		double var4 = (double)this.points[this.pathIndex].yCoord;
		double var6 = (double)this.points[this.pathIndex].zCoord + (double)((int)(width + 1.0F)) * 0.5D;
