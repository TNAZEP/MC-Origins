...
public abstract class Container {
	...
	public void onCraftGuiOpened(ICrafting var1) {
		if(this.field_20121_g.contains(var1)) {
			throw new IllegalArgumentException("Listener already listening");
		} else {
			this.field_20121_g.add(var1);
	...
	public boolean getCanCraft(EntityPlayer var1) {
		return !this.field_20918_b.contains(var1);
	}

	public void setCanCraft(EntityPlayer var1, boolean var2) {
		if(var2) {
			this.field_20918_b.remove(var1);
		} else {
			this.field_20918_b.add(var1);
		}
