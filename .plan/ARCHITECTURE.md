...
The a1 merge now has 420 shared, 270 client and 39 dedicated Java classes, with no duplicate side class names. Main compiles independently of both hosts and all references. World, entity, block/item, inventory, generation, save, packet and transport implementation lives in main. Client local singleplayer, remote-world view, rendering/input/audio and dedicated lifecycle/network handlers remain in their respective source sets. See [working source guide](../src/README.md) and its provenance ledger.
