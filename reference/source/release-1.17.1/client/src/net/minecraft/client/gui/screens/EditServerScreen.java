...
public class EditServerScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addButton = this.addRenderableWidget(
         new Button(this.width / 2 - 100, this.height / 4 + 96 + 18, 200, 20, new TranslatableComponent("addServer.add"), var1 -> this.onAdd())
      );
      this.addRenderableWidget(
   ...
   public void resize(Minecraft var1, int var2, int var3) {
      ...
      String â˜ƒx = this.nameEdit.getValue();
      this.init(â˜ƒ, â˜ƒ, â˜ƒ);
      this.ipEdit.setValue(â˜ƒ);
      this.nameEdit.setValue(â˜ƒx);
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      drawString(â˜ƒ, this.font, NAME_LABEL, this.width / 2 - 100, 53, 10526880);
      drawString(â˜ƒ, this.font, IP_LABEL, this.width / 2 - 100, 94, 10526880);
