...
public class WolfModel<T extends Wolf> extends ColorableAgeableListModel<T> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      float â˜ƒxx = 13.5F;
      PartDefinition â˜ƒxxx = â˜ƒx.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(-1.0F, 13.5F, -7.0F));
      ...
      CubeListBuilder â˜ƒxxxx = CubeListBuilder.create().texOffs(0, 18).addBox(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F);
      â˜ƒx.addOrReplaceChild("right_hind_leg", â˜ƒxxxx, PartPose.offset(-2.5F, 16.0F, 7.0F));
      â˜ƒx.addOrReplaceChild("left_hind_leg", â˜ƒxxxx, PartPose.offset(0.5F, 16.0F, 7.0F));
      â˜ƒx.addOrReplaceChild("right_front_leg", â˜ƒxxxx, PartPose.offset(-2.5F, 16.0F, -4.0F));
      â˜ƒx.addOrReplaceChild("left_front_leg", â˜ƒxxxx, PartPose.offset(0.5F, 16.0F, -4.0F));
      ...
      â˜ƒxxxxx.addOrReplaceChild("real_tail", CubeListBuilder.create().texOffs(9, 18).addBox(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F), PartPose.ZERO);
   ...
   public void prepareMobModel(T var1, float var2, float var3, float var4) {
      if (â˜ƒ.isAngry()) {
         ...
         this.tail.yRot = Mth.cos(â˜ƒ * 0.6662F) * 1.4F * â˜ƒ;
      }

      if (â˜ƒ.isInSittingPose()) {
      ...
      this.realHead.zRot = â˜ƒ.getHeadRollAngle(â˜ƒ) + â˜ƒ.getBodyRollAngle(â˜ƒ, 0.0F);
      this.upperBody.zRot = â˜ƒ.getBodyRollAngle(â˜ƒ, -0.08F);
      this.body.zRot = â˜ƒ.getBodyRollAngle(â˜ƒ, -0.16F);
      this.realTail.zRot = â˜ƒ.getBodyRollAngle(â˜ƒ, -0.2F);
   }
