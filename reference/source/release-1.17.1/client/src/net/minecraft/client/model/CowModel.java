...
public class CowModel<T extends Entity> extends QuadrupedModel<T> {
   public CowModel(ModelPart var1) {
      super(â˜ƒ, false, 10.0F, 4.0F, 2.0F, 2.0F, 24);
   }
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      CubeListBuilder â˜ƒxxx = CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F);
      â˜ƒx.addOrReplaceChild("right_hind_leg", â˜ƒxxx, PartPose.offset(-4.0F, 12.0F, 7.0F));
      â˜ƒx.addOrReplaceChild("left_hind_leg", â˜ƒxxx, PartPose.offset(4.0F, 12.0F, 7.0F));
      â˜ƒx.addOrReplaceChild("right_front_leg", â˜ƒxxx, PartPose.offset(-4.0F, 12.0F, -6.0F));
      â˜ƒx.addOrReplaceChild("left_front_leg", â˜ƒxxx, PartPose.offset(4.0F, 12.0F, -6.0F));
