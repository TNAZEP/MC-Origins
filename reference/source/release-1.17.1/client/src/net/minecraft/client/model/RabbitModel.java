...
public class RabbitModel<T extends Rabbit> extends EntityModel<T> {
   ...
   public RabbitModel(ModelPart var1) {
      this.leftRearFoot = â˜ƒ.getChild("left_hind_foot");
      this.rightRearFoot = â˜ƒ.getChild("right_hind_foot");
      this.leftHaunch = â˜ƒ.getChild("left_haunch");
      this.rightHaunch = â˜ƒ.getChild("right_haunch");
      ...
      this.rightEar = â˜ƒ.getChild("right_ear");
      this.leftEar = â˜ƒ.getChild("left_ear");
      this.tail = â˜ƒ.getChild("tail");
      this.nose = â˜ƒ.getChild("nose");
   }
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      â˜ƒx.addOrReplaceChild("head", CubeListBuilder.create().texOffs(32, 0).addBox(-2.5F, -4.0F, -5.0F, 5.0F, 4.0F, 5.0F), PartPose.offset(0.0F, 16.0F, -1.0F));
      â˜ƒx.addOrReplaceChild(
         "right_ear",
      ...
      â˜ƒx.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(32, 9).addBox(-0.5F, -2.5F, -5.5F, 1.0F, 1.0F, 1.0F), PartPose.offset(0.0F, 16.0F, -1.0F));
   ...
   public void renderToBuffer(PoseStack var1, VertexConsumer var2, int var3, int var4, float var5, float var6, float var7, float var8) {
      if (this.young) {
         float â˜ƒ = 1.5F;
         â˜ƒ.pushPose();
         â˜ƒ.scale(0.56666666F, 0.56666666F, 0.56666666F);
         â˜ƒ.translate(0.0, 1.375, 0.125);
         ImmutableList.of(this.head, this.leftEar, this.rightEar, this.nose).forEach(var8x -> var8x.render(â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ));
         â˜ƒ.popPose();
         â˜ƒ.pushPose();
         â˜ƒ.scale(0.4F, 0.4F, 0.4F);
         â˜ƒ.translate(0.0, 2.25, 0.0);
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.nose.xRot = â˜ƒ * (float) (Math.PI / 180.0);
      this.head.xRot = â˜ƒ * (float) (Math.PI / 180.0);
      this.rightEar.xRot = â˜ƒ * (float) (Math.PI / 180.0);
      this.leftEar.xRot = â˜ƒ * (float) (Math.PI / 180.0);
      this.nose.yRot = â˜ƒ * (float) (Math.PI / 180.0);
      ...
      this.jumpRotation = Mth.sin(â˜ƒ.getJumpCompletion(â˜ƒ) * (float) Math.PI);
