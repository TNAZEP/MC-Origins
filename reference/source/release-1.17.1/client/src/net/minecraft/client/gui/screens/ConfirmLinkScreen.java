...
public class ConfirmLinkScreen extends ConfirmScreen {
   ...
   public ConfirmLinkScreen(BooleanConsumer var1, String var2, boolean var3) {
      super(â˜ƒ, new TranslatableComponent(â˜ƒ ? "chat.link.confirmTrusted" : "chat.link.confirm"), new TextComponent(â˜ƒ));
      this.yesButton = (Component)(â˜ƒ ? new TranslatableComponent("chat.link.open") : CommonComponents.GUI_YES);
      this.noButton = â˜ƒ ? CommonComponents.GUI_CANCEL : CommonComponents.GUI_NO;
      this.showWarning = !â˜ƒ;
      this.url = â˜ƒ;
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (this.showWarning) {
         drawCenteredString(â˜ƒ, this.font, WARNING_TEXT, this.width / 2, 110, 16764108);
      }
   }
}
