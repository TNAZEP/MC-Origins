...
public class MouseSettingsScreen extends OptionsSubScreen {
   ...
   public MouseSettingsScreen(Screen var1, Options var2) {
      super(â˜ƒ, â˜ƒ, new TranslatableComponent("options.mouse_settings.title"));
   }
   ...
   protected void init() {
      ...
      if (InputConstants.isRawMouseInputSupported()) {
         this.list.addSmall((Option[])Stream.concat(Arrays.stream(OPTIONS), Stream.of(Option.RAW_MOUSE_INPUT)).toArray(var0 -> new Option[var0]));
      } else {
