...
public class StrayClothingLayer<T extends Mob & RangedAttackMob, M extends EntityModel<T>> extends RenderLayer<T, M> {
   ...
   public StrayClothingLayer(RenderLayerParent<T, M> var1, EntityModelSet var2) {
      super(â˜ƒ);
      this.layerModel = new SkeletonModel<>(â˜ƒ.bakeLayer(ModelLayers.STRAY_OUTER_LAYER));
   }

   public void render(PoseStack var1, MultiBufferSource var2, int var3, T var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      coloredCutoutModelCopyLayerRender(
         this.getParentModel(), this.layerModel, STRAY_CLOTHES_LOCATION, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, 1.0F, 1.0F, 1.0F
      );
   }
}
