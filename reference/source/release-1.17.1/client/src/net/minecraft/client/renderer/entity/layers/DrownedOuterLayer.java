...
public class DrownedOuterLayer<T extends Drowned> extends RenderLayer<T, DrownedModel<T>> {
   ...
   public DrownedOuterLayer(RenderLayerParent<T, DrownedModel<T>> var1, EntityModelSet var2) {
      super(â˜ƒ);
      this.model = new DrownedModel<>(â˜ƒ.bakeLayer(ModelLayers.DROWNED_OUTER_LAYER));
   }

   public void render(PoseStack var1, MultiBufferSource var2, int var3, T var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      coloredCutoutModelCopyLayerRender(
         this.getParentModel(), this.model, DROWNED_OUTER_LAYER_LOCATION, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, 1.0F, 1.0F, 1.0F
      );
   }
}
