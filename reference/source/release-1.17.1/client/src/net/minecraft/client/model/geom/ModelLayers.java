...
public class ModelLayers {
   ...
   private static ModelLayerLocation register(String var0) {
      return register(â˜ƒ, "main");
   }

   private static ModelLayerLocation register(String var0, String var1) {
      ModelLayerLocation â˜ƒ = createLocation(â˜ƒ, â˜ƒ);
      if (!ALL_MODELS.add(â˜ƒ)) {
         throw new IllegalStateException("Duplicate registration for " + â˜ƒ);
      } else {
         return â˜ƒ;
      }
   }
