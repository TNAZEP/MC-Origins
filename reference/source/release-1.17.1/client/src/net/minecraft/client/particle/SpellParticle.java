...
public class SpellParticle extends TextureSheetParticle {
   ...
   SpellParticle(ClientLevel var1, double var2, double var4, double var6, double var8, double var10, double var12, SpriteSet var14) {
      super(â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, 0.5 - RANDOM.nextDouble(), â˜ƒ, 0.5 - RANDOM.nextDouble());
      this.friction = 0.96F;
      this.gravity = -0.1F;
   ...
   private boolean isCloseToScopingPlayer() {
      ...
      return â˜ƒx != null
         && â˜ƒx.getEyePosition().distanceToSqr(this.x, this.y, this.z) <= 9.0
         && â˜ƒ.options.getCameraType().isFirstPerson()
         && â˜ƒx.isScoping();
   }
   ...
   public static class AmbientMobProvider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType var1, ClientLevel var2, double var3, double var5, double var7, double var9, double var11, double var13) {
         Particle â˜ƒ = new SpellParticle(â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, this.sprite);
         â˜ƒ.setAlpha(0.15F);
         â˜ƒ.setColor((float)â˜ƒ, (float)â˜ƒ, (float)â˜ƒ);
         return â˜ƒ;
      }
   }
   ...
   public static class InstantProvider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType var1, ClientLevel var2, double var3, double var5, double var7, double var9, double var11, double var13) {
         return new SpellParticle(â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, this.sprite);
      }
   }
   ...
   public static class WitchProvider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType var1, ClientLevel var2, double var3, double var5, double var7, double var9, double var11, double var13) {
         SpellParticle â˜ƒ = new SpellParticle(â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, this.sprite);
         float â˜ƒx = â˜ƒ.random.nextFloat() * 0.5F + 0.35F;
         â˜ƒ.setColor(1.0F * â˜ƒx, 0.0F * â˜ƒx, 1.0F * â˜ƒx);
         return â˜ƒ;
      }
   }
}
