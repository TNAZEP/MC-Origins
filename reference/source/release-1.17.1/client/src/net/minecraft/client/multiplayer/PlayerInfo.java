...
public class PlayerInfo {
   ...
   public PlayerInfo(ClientboundPlayerInfoPacket.PlayerUpdate var1) {
      this.profile = â˜ƒ.getProfile();
      this.gameMode = â˜ƒ.getGameMode();
      this.latency = â˜ƒ.getLatency();
      this.tabListDisplayName = â˜ƒ.getDisplayName();
   }
