...
public class PigRenderer extends MobRenderer<Pig, PigModel<Pig>> {
   ...
   public PigRenderer(EntityRendererProvider.Context var1) {
      super(â˜ƒ, new PigModel<>(â˜ƒ.bakeLayer(ModelLayers.PIG)), 0.7F);
      this.addLayer(new SaddleLayer<>(this, new PigModel<>(â˜ƒ.bakeLayer(ModelLayers.PIG_SADDLE)), new ResourceLocation("textures/entity/pig/pig_saddle.png")));
   }
