...
public class ParticleTypes {
   ...
   public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register(
      "dust_color_transition", DustColorTransitionOptions.DESERIALIZER, var0 -> DustColorTransitionOptions.CODEC
   );
   ...
   public static final ParticleType<VibrationParticleOption> VIBRATION = register(
      "vibration", VibrationParticleOption.DESERIALIZER, var0 -> VibrationParticleOption.CODEC
   );
   ...
   private static SimpleParticleType register(String var0, boolean var1) {
      return Registry.register(Registry.PARTICLE_TYPE, â˜ƒ, new SimpleParticleType(â˜ƒ));
   }

   private static <T extends ParticleOptions> ParticleType<T> register(
      String var0, ParticleOptions.Deserializer<T> var1, final Function<ParticleType<T>, Codec<T>> var2
   ) {
      return Registry.register(Registry.PARTICLE_TYPE, â˜ƒ, new ParticleType<T>(false, â˜ƒ) {
         @Override
         public Codec<T> codec() {
            return (Codec<T>)â˜ƒ.apply(this);
         }
      });
   }
}
