...
public class V1800 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var1) {
      ...
      registerMob(â˜ƒ, â˜ƒ, "minecraft:panda");
      â˜ƒ.register(
         â˜ƒ,
         "minecraft:pillager",
         (Function<String, TypeTemplate>)(var1x -> DSL.optionalFields("Inventory", DSL.list(References.ITEM_STACK.in(â˜ƒ)), V100.equipment(â˜ƒ)))
      );
      return â˜ƒ;
   }
}
