...
public class V2100 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var1) {
      ...
      registerMob(â˜ƒ, â˜ƒ, "minecraft:bee");
      registerMob(â˜ƒ, â˜ƒ, "minecraft:bee_stinger");
      return â˜ƒ;
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema var1) {
      ...
      â˜ƒ.register(
         â˜ƒ,
         "minecraft:beehive",
         (Supplier<TypeTemplate>)(() -> DSL.optionalFields("Bees", DSL.list(DSL.optionalFields("EntityData", References.ENTITY_TREE.in(â˜ƒ)))))
      );
      return â˜ƒ;
   }
}
