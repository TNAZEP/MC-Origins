...
public class ItemModelGenerators {
   ...
   private void generateFlatItem(Item var1, ModelTemplate var2) {
      â˜ƒ.create(ModelLocationUtils.getModelLocation(â˜ƒ), TextureMapping.layer0(â˜ƒ), this.output);
   }

   private void generateFlatItem(Item var1, String var2, ModelTemplate var3) {
      â˜ƒ.create(ModelLocationUtils.getModelLocation(â˜ƒ, â˜ƒ), TextureMapping.layer0(TextureMapping.getItemTexture(â˜ƒ, â˜ƒ)), this.output);
   }
   ...
   public void run() {
      ...
      for(int â˜ƒ = 1; â˜ƒ < 64; ++â˜ƒ) {
         this.generateFlatItem(Items.CLOCK, String.format("_%02d", â˜ƒ), ModelTemplates.FLAT_ITEM);
      }
      ...
      for(int â˜ƒ = 0; â˜ƒ < 32; ++â˜ƒ) {
         if (â˜ƒ != 16) {
            this.generateFlatItem(Items.COMPASS, String.format("_%02d", â˜ƒ), ModelTemplates.FLAT_ITEM);
         }
      }
