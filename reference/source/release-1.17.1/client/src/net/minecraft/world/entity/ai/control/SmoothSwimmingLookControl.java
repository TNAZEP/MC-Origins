...
public class SmoothSwimmingLookControl extends LookControl {
   ...
   public void tick() {
      ...
      float â˜ƒ = Mth.wrapDegrees(this.mob.yHeadRot - this.mob.yBodyRot);
      if (â˜ƒ < (float)(-this.maxYRotFromCenter)) {
         this.mob.yBodyRot -= 4.0F;
      } else if (â˜ƒ > (float)this.maxYRotFromCenter) {
         this.mob.yBodyRot += 4.0F;
      }
   }
}
