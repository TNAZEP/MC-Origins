...
public enum ArmorMaterials implements ArmorMaterial {
   ...
   private ArmorMaterials(String var3, int var4, int[] var5, int var6, SoundEvent var7, float var8, float var9, Supplier<Ingredient> var10) {
      this.name = â˜ƒ;
      this.durabilityMultiplier = â˜ƒ;
      this.slotProtections = â˜ƒ;
      this.enchantmentValue = â˜ƒ;
      this.sound = â˜ƒ;
      this.toughness = â˜ƒ;
      this.knockbackResistance = â˜ƒ;
      this.repairIngredient = new LazyLoadedValue<>(â˜ƒ);
   }

   @Override
   public int getDurabilityForSlot(EquipmentSlot var1) {
      return HEALTH_PER_SLOT[â˜ƒ.getIndex()] * this.durabilityMultiplier;
   }

   @Override
   public int getDefenseForSlot(EquipmentSlot var1) {
      return this.slotProtections[â˜ƒ.getIndex()];
   }
