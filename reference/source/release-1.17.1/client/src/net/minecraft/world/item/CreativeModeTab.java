...
public abstract class CreativeModeTab {
   ...
   public CreativeModeTab(int var1, String var2) {
      this.id = â˜ƒ;
      this.langId = â˜ƒ;
      this.displayName = new TranslatableComponent("itemGroup." + â˜ƒ);
   ...
   public CreativeModeTab setEnchantmentCategories(EnchantmentCategory... var1) {
      this.enchantmentCategories = â˜ƒ;
      return this;
   }

   public boolean hasEnchantmentCategory(@Nullable EnchantmentCategory var1) {
      if (â˜ƒ != null) {
         for(EnchantmentCategory â˜ƒ : this.enchantmentCategories) {
            if (â˜ƒ == â˜ƒ) {
               return true;
            }
         }
