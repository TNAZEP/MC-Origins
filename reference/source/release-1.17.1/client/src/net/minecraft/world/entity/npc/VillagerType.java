...
public final class VillagerType {
   ...
   private static final Map<ResourceKey<Biome>, VillagerType> BY_BIOME = Util.make(Maps.<ResourceKey<Biome>, VillagerType>newHashMap(), var0 -> {
   ...
   private static VillagerType register(String var0) {
      return Registry.register(Registry.VILLAGER_TYPE, new ResourceLocation(â˜ƒ), new VillagerType(â˜ƒ));
   }

   public static VillagerType byBiome(Optional<ResourceKey<Biome>> var0) {
      return (VillagerType)â˜ƒ.flatMap(var0x -> Optional.ofNullable((VillagerType)BY_BIOME.get(var0x))).orElse(PLAINS);
   }
}
