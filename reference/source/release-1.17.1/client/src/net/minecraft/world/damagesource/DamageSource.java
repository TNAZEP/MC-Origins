...
public class DamageSource {
   ...
   public static DamageSource sting(LivingEntity var0) {
      return new EntityDamageSource("sting", â˜ƒ);
   }

   public static DamageSource mobAttack(LivingEntity var0) {
      return new EntityDamageSource("mob", â˜ƒ);
   }

   public static DamageSource indirectMobAttack(Entity var0, @Nullable LivingEntity var1) {
      return new IndirectEntityDamageSource("mob", â˜ƒ, â˜ƒ);
   }

   public static DamageSource playerAttack(Player var0) {
      return new EntityDamageSource("player", â˜ƒ);
   }

   public static DamageSource arrow(AbstractArrow var0, @Nullable Entity var1) {
      return new IndirectEntityDamageSource("arrow", â˜ƒ, â˜ƒ).setProjectile();
   }

   public static DamageSource trident(Entity var0, @Nullable Entity var1) {
      return new IndirectEntityDamageSource("trident", â˜ƒ, â˜ƒ).setProjectile();
   }

   public static DamageSource fireworks(FireworkRocketEntity var0, @Nullable Entity var1) {
      return new IndirectEntityDamageSource("fireworks", â˜ƒ, â˜ƒ).setExplosion();
   }

   public static DamageSource fireball(Fireball var0, @Nullable Entity var1) {
      return â˜ƒ == null
         ? new IndirectEntityDamageSource("onFire", â˜ƒ, â˜ƒ).setIsFire().setProjectile()
         : new IndirectEntityDamageSource("fireball", â˜ƒ, â˜ƒ).setIsFire().setProjectile();
   }

   public static DamageSource witherSkull(WitherSkull var0, Entity var1) {
      return new IndirectEntityDamageSource("witherSkull", â˜ƒ, â˜ƒ).setProjectile();
   }

   public static DamageSource thrown(Entity var0, @Nullable Entity var1) {
      return new IndirectEntityDamageSource("thrown", â˜ƒ, â˜ƒ).setProjectile();
   }

   public static DamageSource indirectMagic(Entity var0, @Nullable Entity var1) {
      return new IndirectEntityDamageSource("indirectMagic", â˜ƒ, â˜ƒ).bypassArmor().setMagic();
   }

   public static DamageSource thorns(Entity var0) {
      return new EntityDamageSource("thorns", â˜ƒ).setThorns().setMagic();
   }

   public static DamageSource explosion(@Nullable Explosion var0) {
      return explosion(â˜ƒ != null ? â˜ƒ.getSourceMob() : null);
   }

   public static DamageSource explosion(@Nullable LivingEntity var0) {
      return â˜ƒ != null
         ? new EntityDamageSource("explosion.player", â˜ƒ).setScalesWithDifficulty().setExplosion()
   ...
   public Component getLocalizedDeathMessage(LivingEntity var1) {
      LivingEntity â˜ƒ = â˜ƒ.getKillCredit();
      String â˜ƒx = "death.attack." + this.msgId;
      String â˜ƒxx = â˜ƒx + ".player";
      return â˜ƒ != null ? new TranslatableComponent(â˜ƒxx, â˜ƒ.getDisplayName(), â˜ƒ.getDisplayName()) : new TranslatableComponent(â˜ƒx, â˜ƒ.getDisplayName());
   }
   ...
   public boolean isCreativePlayer() {
      Entity â˜ƒ = this.getEntity();
      return â˜ƒ instanceof Player && ((Player)â˜ƒ).getAbilities().instabuild;
   }
