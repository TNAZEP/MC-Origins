...
public interface WorldData {
   ...
   default void fillCrashReportCategory(CrashReportCategory var1) {
      â˜ƒ.setDetail("Known server brands", (CrashReportDetail<String>)(() -> String.join(", ", this.getKnownServerBrands())));
      â˜ƒ.setDetail("Level was modded", (CrashReportDetail<String>)(() -> Boolean.toString(this.wasModded())));
      â˜ƒ.setDetail("Level storage version", (CrashReportDetail<String>)(() -> {
         int â˜ƒ = this.getVersion();
         return String.format("0x%05X - %s", â˜ƒ, this.getStorageVersionName(â˜ƒ));
      }));
   }
