...
public class SkeletonHorse extends AbstractHorse {
   ...
   protected void playSwimSound(float var1) {
      if (this.onGround) {
         ...
         super.playSwimSound(Math.min(0.1F, â˜ƒ * 25.0F));
      }
   }
   ...
   public void addAdditionalSaveData(CompoundTag var1) {
      ...
      â˜ƒ.putBoolean("SkeletonTrap", this.isTrap());
      â˜ƒ.putInt("SkeletonTrapTime", this.trapTime);
   }

   @Override
   public void readAdditionalSaveData(CompoundTag var1) {
      super.readAdditionalSaveData(â˜ƒ);
      this.setTrap(â˜ƒ.getBoolean("SkeletonTrap"));
      this.trapTime = â˜ƒ.getInt("SkeletonTrapTime");
   }
   ...
   public AgeableMob getBreedOffspring(ServerLevel var1, AgeableMob var2) {
      return EntityType.SKELETON_HORSE.create(â˜ƒ);
   }
