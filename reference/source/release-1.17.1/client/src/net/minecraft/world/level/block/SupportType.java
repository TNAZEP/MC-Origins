...
public enum SupportType {
   FULL {
      ...
      public boolean isSupporting(BlockState var1, BlockGetter var2, BlockPos var3, Direction var4) {
         return Block.isFaceFull(â˜ƒ.getBlockSupportShape(â˜ƒ, â˜ƒ), â˜ƒ);
      }
   },
   CENTER {
      ...
      @Override
      public boolean isSupporting(BlockState var1, BlockGetter var2, BlockPos var3, Direction var4) {
         return !Shapes.joinIsNotEmpty(â˜ƒ.getBlockSupportShape(â˜ƒ, â˜ƒ).getFaceShape(â˜ƒ), this.CENTER_SUPPORT_SHAPE, BooleanOp.ONLY_SECOND);
      }
   },
   RIGID {
      ...
      @Override
      public boolean isSupporting(BlockState var1, BlockGetter var2, BlockPos var3, Direction var4) {
         return !Shapes.joinIsNotEmpty(â˜ƒ.getBlockSupportShape(â˜ƒ, â˜ƒ).getFaceShape(â˜ƒ), this.RIGID_SUPPORT_SHAPE, BooleanOp.ONLY_SECOND);
      }
   };
