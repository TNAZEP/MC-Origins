...
public class Chicken extends Animal {
   ...
   protected float getStandingEyeHeight(Pose var1, EntityDimensions var2) {
      return this.isBaby() ? â˜ƒ.height * 0.85F : â˜ƒ.height * 0.92F;
   }
   ...
   public Chicken getBreedOffspring(ServerLevel var1, AgeableMob var2) {
      return EntityType.CHICKEN.create(â˜ƒ);
   }
   ...
   protected int getExperienceReward(Player var1) {
      return this.isChickenJockey() ? 10 : super.getExperienceReward(â˜ƒ);
   }

   @Override
   public void readAdditionalSaveData(CompoundTag var1) {
      super.readAdditionalSaveData(â˜ƒ);
      this.isChickenJockey = â˜ƒ.getBoolean("IsChickenJockey");
      if (â˜ƒ.contains("EggLayTime")) {
         this.eggTime = â˜ƒ.getInt("EggLayTime");
      }
   }
   ...
   public void addAdditionalSaveData(CompoundTag var1) {
      ...
      â˜ƒ.putBoolean("IsChickenJockey", this.isChickenJockey);
      â˜ƒ.putInt("EggLayTime", this.eggTime);
   }
   ...
   public void positionRider(Entity var1) {
      ...
      float â˜ƒxx = 0.1F;
      float â˜ƒxxx = 0.0F;
      â˜ƒ.setPos(this.getX() + (double)(0.1F * â˜ƒ), this.getY(0.5) + â˜ƒ.getMyRidingOffset() + 0.0, this.getZ() - (double)(0.1F * â˜ƒx));
