...
public abstract class StructurePoolElement {
   ...
   public StructureTemplatePool.Projection getProjection() {
      StructureTemplatePool.Projection â˜ƒ = this.projection;
      if (â˜ƒ == null) {
   ...
   public static Function<StructureTemplatePool.Projection, LegacySinglePoolElement> legacy(String var0) {
      return var1 -> new LegacySinglePoolElement(Either.left(new ResourceLocation(â˜ƒ)), () -> ProcessorLists.EMPTY, var1);
   }
   ...
   public static Function<StructureTemplatePool.Projection, ListPoolElement> list(
      ...
      return var1 -> new ListPoolElement(
            (List<StructurePoolElement>)â˜ƒ.stream().map(var1x -> (StructurePoolElement)var1x.apply(var1)).collect(Collectors.toList()), var1
         );
   }
}
