...
public interface CastleTransformer extends AreaTransformer1, DimensionOffset1Transformer {
   ...
   default int applyPixel(BigContext<?> var1, Area var2, int var3, int var4) {
      return this.apply(
         â˜ƒ,
         â˜ƒ.get(this.getParentX(â˜ƒ + 1), this.getParentY(â˜ƒ + 0)),
         â˜ƒ.get(this.getParentX(â˜ƒ + 2), this.getParentY(â˜ƒ + 1)),
         â˜ƒ.get(this.getParentX(â˜ƒ + 1), this.getParentY(â˜ƒ + 2)),
         â˜ƒ.get(this.getParentX(â˜ƒ + 0), this.getParentY(â˜ƒ + 1)),
