...
public class MaterialColor {
   ...
   public int calculateRGBColor(int var1) {
      ...
      int â˜ƒ = (this.col >> 16 & 0xFF) * â˜ƒ / 255;
      int â˜ƒx = (this.col >> 8 & 0xFF) * â˜ƒ / 255;
      int â˜ƒxx = (this.col & 0xFF) * â˜ƒ / 255;
      return 0xFF000000 | â˜ƒxx << 16 | â˜ƒx << 8 | â˜ƒ;
   }
}
