...
public class BlockIgnoreProcessor extends StructureProcessor {
   public static final Codec<BlockIgnoreProcessor> CODEC = BlockState.CODEC
      ...
      .listOf()
      .fieldOf("blocks")
      .<BlockIgnoreProcessor>xmap(BlockIgnoreProcessor::new, var0 -> var0.toIgnore)
      .codec();
   ...
   public BlockIgnoreProcessor(List<Block> var1) {
      this.toIgnore = ImmutableList.copyOf(â˜ƒ);
   }
   ...
   public StructureTemplate.StructureBlockInfo processBlock(
      ...
      return this.toIgnore.contains(â˜ƒ.state.getBlock()) ? null : â˜ƒ;
   }
