...
public class SpawnPlacements {
   ...
   private static <T extends Mob> void register(EntityType<T> var0, SpawnPlacements.Type var1, Heightmap.Types var2, SpawnPlacements.SpawnPredicate<T> var3) {
      SpawnPlacements.Data â˜ƒ = (SpawnPlacements.Data)DATA_BY_TYPE.put(â˜ƒ, new SpawnPlacements.Data(â˜ƒ, â˜ƒ, â˜ƒ));
      if (â˜ƒ != null) {
         throw new IllegalStateException("Duplicate registration for type " + Registry.ENTITY_TYPE.getKey(â˜ƒ));
      }
   }

   public static SpawnPlacements.Type getPlacementType(EntityType<?> var0) {
      SpawnPlacements.Data â˜ƒ = (SpawnPlacements.Data)DATA_BY_TYPE.get(â˜ƒ);
      return â˜ƒ == null ? SpawnPlacements.Type.NO_RESTRICTIONS : â˜ƒ.placement;
   }

   public static Heightmap.Types getHeightmapType(@Nullable EntityType<?> var0) {
      SpawnPlacements.Data â˜ƒ = (SpawnPlacements.Data)DATA_BY_TYPE.get(â˜ƒ);
      return â˜ƒ == null ? Heightmap.Types.MOTION_BLOCKING_NO_LEAVES : â˜ƒ.heightMap;
   }
   ...
   public static <T extends Entity> boolean checkSpawnRules(EntityType<T> var0, ServerLevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      SpawnPlacements.Data â˜ƒ = (SpawnPlacements.Data)DATA_BY_TYPE.get(â˜ƒ);
      return â˜ƒ == null || â˜ƒ.predicate.test(â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ, â˜ƒ);
   }
