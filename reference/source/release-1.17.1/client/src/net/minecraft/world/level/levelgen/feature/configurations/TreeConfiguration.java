...
public class TreeConfiguration implements FeatureConfiguration {
   public static final Codec<TreeConfiguration> CODEC = RecordCodecBuilder.create(
      var0 -> var0.group(
               ...
               BlockStateProvider.CODEC.fieldOf("sapling_provider").forGetter(var0x -> var0x.saplingProvider),
   ...
   protected TreeConfiguration(
      ...
      this.trunkProvider = â˜ƒ;
      this.trunkPlacer = â˜ƒ;
      this.foliageProvider = â˜ƒ;
      this.foliagePlacer = â˜ƒ;
      this.dirtProvider = â˜ƒ;
      this.saplingProvider = â˜ƒ;
      this.minimumSize = â˜ƒ;
      this.decorators = â˜ƒ;
      this.ignoreVines = â˜ƒ;
      this.forceDirt = â˜ƒ;
   }
   ...
   public static class TreeConfigurationBuilder {
      ...
      public TreeConfigurationBuilder(
         BlockStateProvider var1, TrunkPlacer var2, BlockStateProvider var3, BlockStateProvider var4, FoliagePlacer var5, FeatureSize var6
      ) {
         this.trunkProvider = â˜ƒ;
         this.trunkPlacer = â˜ƒ;
         this.foliageProvider = â˜ƒ;
