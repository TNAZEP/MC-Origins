...
public class EntityTracker implements PositionTracker {
   ...
   public boolean isVisibleBy(LivingEntity var1) {
      if (!(this.entity instanceof LivingEntity)) {
         ...
         Optional<List<LivingEntity>> â˜ƒ = â˜ƒ.getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES);
         return this.entity.isAlive() && â˜ƒ.isPresent() && ((List)â˜ƒ.get()).contains(this.entity);
      }
   }
