...
public class LandOnOwnersShoulderGoal extends Goal {
   ...
   public boolean canUse() {
      ServerPlayer â˜ƒ = (ServerPlayer)this.entity.getOwner();
      boolean â˜ƒx = â˜ƒ != null && !â˜ƒ.isSpectator() && !â˜ƒ.getAbilities().flying && !â˜ƒ.isInWater() && !â˜ƒ.isInPowderSnow;
      return !this.entity.isOrderedToSit() && â˜ƒx && this.entity.canSitOnShoulder();
   }
