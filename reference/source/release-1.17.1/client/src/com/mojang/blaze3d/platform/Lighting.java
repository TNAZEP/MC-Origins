...
public class Lighting {
   ...
   public static void setupNetherLevel(Matrix4f var0) {
      RenderSystem.setupLevelDiffuseLighting(NETHER_DIFFUSE_LIGHT_0, NETHER_DIFFUSE_LIGHT_1, â˜ƒ);
   }

   public static void setupLevel(Matrix4f var0) {
      RenderSystem.setupLevelDiffuseLighting(DIFFUSE_LIGHT_0, DIFFUSE_LIGHT_1, â˜ƒ);
   }
