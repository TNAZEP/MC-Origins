...
public class RealmsNotificationsScreen extends RealmsScreen {
         ...
         (new Thread("Realms Notification Availability checker #1") {
            public void run() {
               ...
               try {
                  ...
                  if (â˜ƒx != RealmsClient.CompatibleVersionResponse.COMPATIBLE) {
                     return;
                  }
   ...
   private void drawIcons(PoseStack var1, int var2, int var3) {
      ...
      int â˜ƒx = 24;
      int â˜ƒxx = this.height / 4 + 48;
      int â˜ƒxxx = this.width / 2 + 80;
      int â˜ƒxxxx = â˜ƒxx + 48 + 2;
      int â˜ƒxxxxx = 0;
      if (hasUnreadNews) {
         ...
         GuiComponent.blit(â˜ƒ, (int)((double)(â˜ƒxxx + 2 - â˜ƒxxxxx) * 2.5), (int)((double)â˜ƒxxxx * 2.5), 0.0F, 0.0F, 40, 40, 40, 40);
         â˜ƒ.popPose();
         â˜ƒxxxxx += 14;
      }
      ...
      if (â˜ƒ != 0) {
         ...
         RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
         GuiComponent.blit(â˜ƒ, â˜ƒxxx - â˜ƒxxxxx, â˜ƒxxxx - 6, 0.0F, 0.0F, 15, 25, 31, 25);
         â˜ƒxxxxx += 16;
      }
      ...
      if (trialAvailable) {
         ...
         GuiComponent.blit(â˜ƒ, â˜ƒxxx + 4 - â˜ƒxxxxx, â˜ƒxxxx + 4, 0.0F, (float)â˜ƒ, 8, 8, 8, 16);
      }
   }
