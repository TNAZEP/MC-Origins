...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addRenderableWidget(
         CycleButton.builder(LevelType::getName)
            ...
            .create(this.width / 2 - 102, row(4), 205, 20, new TranslatableComponent("selectWorld.mapType"), (var1, var2) -> this.levelType = var2)
      );
      this.addRenderableWidget(
         CycleButton.onOffBuilder(this.generateStructures)
            .create(
               this.width / 2 - 102, row(6) - 2, 205, 20, new TranslatableComponent("selectWorld.mapFeatures"), (var1, var2) -> this.generateStructures = var2
            )
      );
      this.addRenderableWidget(
         new Button(
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      this.font.draw(â˜ƒ, SEED_LABEL, (float)(this.width / 2 - 100), (float)row(1), 10526880);
