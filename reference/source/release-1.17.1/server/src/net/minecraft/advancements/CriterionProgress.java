...
public class CriterionProgress {
   ...
   public void serializeToNetwork(FriendlyByteBuf var1) {
      â˜ƒ.writeBoolean(this.obtained != null);
      if (this.obtained != null) {
         â˜ƒ.writeDate(this.obtained);
      }
   }
   ...
   public static CriterionProgress fromNetwork(FriendlyByteBuf var0) {
      CriterionProgress â˜ƒ = new CriterionProgress();
      if (â˜ƒ.readBoolean()) {
         â˜ƒ.obtained = â˜ƒ.readDate();
      }
   ...
   public static CriterionProgress fromJson(String var0) {
      ...
      try {
         â˜ƒ.obtained = DATE_FORMAT.parse(â˜ƒ);
         return â˜ƒ;
      } catch (ParseException var3) {
         throw new JsonSyntaxException("Invalid datetime: " + â˜ƒ, var3);
      }
   }
}
