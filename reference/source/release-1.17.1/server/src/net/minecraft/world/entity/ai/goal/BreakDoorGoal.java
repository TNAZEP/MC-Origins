...
public class BreakDoorGoal extends DoorInteractGoal {
   ...
   public void tick() {
      ...
      ++this.breakTime;
      int â˜ƒ = (int)((float)this.breakTime / (float)this.getDoorBreakTime() * 10.0F);
      if (â˜ƒ != this.lastBreakProgress) {
         this.mob.level.destroyBlockProgress(this.mob.getId(), this.doorPos, â˜ƒ);
         this.lastBreakProgress = â˜ƒ;
      }
   ...
   private boolean isValidDifficulty(Difficulty var1) {
      return this.validDifficulties.test(â˜ƒ);
   }
}
