...
public class MemoryModuleType<U> {
   ...
   private MemoryModuleType(Optional<Codec<U>> var1) {
      this.codec = â˜ƒ.map(ExpirableValue::codec);
   }
   ...
   private static <U> MemoryModuleType<U> register(String var0, Codec<U> var1) {
      return Registry.register(Registry.MEMORY_MODULE_TYPE, new ResourceLocation(â˜ƒ), new MemoryModuleType<>(Optional.of(â˜ƒ)));
   }

   private static <U> MemoryModuleType<U> register(String var0) {
      return Registry.register(Registry.MEMORY_MODULE_TYPE, new ResourceLocation(â˜ƒ), new MemoryModuleType<>(Optional.empty()));
   }
}
