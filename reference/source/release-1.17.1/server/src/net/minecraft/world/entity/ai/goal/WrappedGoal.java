...
public class WrappedGoal extends Goal {
   ...
   public boolean canBeReplacedBy(WrappedGoal var1) {
      return this.isInterruptable() && â˜ƒ.getPriority() < this.getPriority();
   }
   ...
   public boolean equals(@Nullable Object var1) {
      if (this == â˜ƒ) {
         ...
         return â˜ƒ != null && this.getClass() == â˜ƒ.getClass() ? this.goal.equals(((WrappedGoal)â˜ƒ).goal) : false;
      }
   }
