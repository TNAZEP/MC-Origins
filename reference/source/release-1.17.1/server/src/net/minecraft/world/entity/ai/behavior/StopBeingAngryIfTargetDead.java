...
public class StopBeingAngryIfTargetDead<E extends Mob> extends Behavior<E> {
   ...
   protected void start(ServerLevel var1, E var2, long var3) {
      BehaviorUtils.getLivingEntityFromUUIDMemory(â˜ƒ, MemoryModuleType.ANGRY_AT).ifPresent(var2x -> {
         if (var2x.isDeadOrDying() && (var2x.getType() != EntityType.PLAYER || â˜ƒ.getGameRules().getBoolean(GameRules.RULE_FORGIVE_DEAD_PLAYERS))) {
