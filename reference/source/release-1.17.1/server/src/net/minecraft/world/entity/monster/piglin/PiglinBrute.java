...
public class PiglinBrute extends AbstractPiglin {
   ...
   protected Brain<?> makeBrain(Dynamic<?> var1) {
      return PiglinBruteAi.makeBrain(this, this.brainProvider().makeBrain(â˜ƒ));
   }
   ...
   public boolean wantsToPickUp(ItemStack var1) {
      return â˜ƒ.is(Items.GOLDEN_AXE) ? super.wantsToPickUp(â˜ƒ) : false;
   }
   ...
   public boolean hurt(DamageSource var1, float var2) {
      ...
      if (this.level.isClientSide) {
         ...
         if (â˜ƒ && â˜ƒ.getEntity() instanceof LivingEntity) {
            PiglinBruteAi.wasHurtBy(this, (LivingEntity)â˜ƒ.getEntity());
         }
