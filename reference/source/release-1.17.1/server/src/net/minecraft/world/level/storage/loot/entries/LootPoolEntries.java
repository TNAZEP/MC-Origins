...
public class LootPoolEntries {
   ...
   private static LootPoolEntryType register(String var0, Serializer<? extends LootPoolEntryContainer> var1) {
      return Registry.register(Registry.LOOT_POOL_ENTRY_TYPE, new ResourceLocation(â˜ƒ), new LootPoolEntryType(â˜ƒ));
   }

   public static Object createGsonAdapter() {
      return GsonAdapterFactory.<LootPoolEntryContainer, LootPoolEntryType>builder(
            Registry.LOOT_POOL_ENTRY_TYPE, "entry", "type", LootPoolEntryContainer::getType
         )
         .build();
   }
}
