...
public interface LevelAccessor extends CommonLevelAccessor, LevelTimeAccess {
   ...
   default boolean hasChunk(int var1, int var2) {
      return this.getChunkSource().hasChunk(â˜ƒ, â˜ƒ);
   }
