...
public final class NoiseGeneratorSettings {
   ...
   private NoiseGeneratorSettings(
      ...
      this.defaultBlock = â˜ƒ;
      this.defaultFluid = â˜ƒ;
      this.bedrockRoofPosition = â˜ƒ;
      this.bedrockFloorPosition = â˜ƒ;
      this.seaLevel = â˜ƒ;
      this.minSurfaceLevel = â˜ƒ;
      this.disableMobGeneration = â˜ƒ;
      this.aquifersEnabled = â˜ƒ;
      this.noiseCavesEnabled = â˜ƒ;
      this.deepslateEnabled = â˜ƒ;
      this.oreVeinsEnabled = â˜ƒ;
      this.noodleCavesEnabled = â˜ƒ;
   }
   ...
   public boolean stable(ResourceKey<NoiseGeneratorSettings> var1) {
      return Objects.equals(this, BuiltinRegistries.NOISE_GENERATOR_SETTINGS.get(â˜ƒ));
   }

   private static NoiseGeneratorSettings register(ResourceKey<NoiseGeneratorSettings> var0, NoiseGeneratorSettings var1) {
      BuiltinRegistries.register(BuiltinRegistries.NOISE_GENERATOR_SETTINGS, â˜ƒ.location(), â˜ƒ);
      return â˜ƒ;
   }
   ...
   private static NoiseGeneratorSettings netherLikePreset(StructureSettings var0, BlockState var1, BlockState var2) {
      ...
      â˜ƒ.put(StructureFeature.RUINED_PORTAL, new StructureFeatureConfiguration(25, 10, 34222645));
      return new NoiseGeneratorSettings(
         new StructureSettings(Optional.ofNullable(â˜ƒ.stronghold()), â˜ƒ),
         NoiseSettings.create(
            0,
            128,
