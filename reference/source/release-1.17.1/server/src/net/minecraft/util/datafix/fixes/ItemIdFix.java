...
public class ItemIdFix extends DataFix {
   private static final Int2ObjectMap<String> ITEM_NAMES = DataFixUtils.make(new Int2ObjectOpenHashMap(), var0 -> {
   ...
   public static String getItem(int var0) {
      return (String)ITEM_NAMES.get(â˜ƒ);
   }

   @Override
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> â˜ƒ = DSL.or(DSL.intType(), DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString()));
      Type<Pair<String, String>> â˜ƒx = DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString());
      OpticFinder<Either<Integer, Pair<String, String>>> â˜ƒxx = DSL.fieldFinder("id", â˜ƒ);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(References.ITEM_STACK),
         this.getOutputSchema().getType(References.ITEM_STACK),
         var2x -> var2x.update(â˜ƒ, â˜ƒ, var0x -> var0x.map(var0xx -> Pair.of(References.ITEM_NAME.typeName(), getItem(var0xx)), var0xx -> var0xx))
      );
   }
}
