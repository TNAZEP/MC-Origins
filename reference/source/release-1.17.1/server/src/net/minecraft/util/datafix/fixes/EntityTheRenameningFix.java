...
public class EntityTheRenameningFix extends SimplestEntityRenameFix {
   ...
   public EntityTheRenameningFix(Schema var1, boolean var2) {
      super("EntityTheRenameningBlock", â˜ƒ, â˜ƒ);
   }

   @Override
   protected String rename(String var1) {
      if (â˜ƒ.startsWith("minecraft:bred_")) {
         â˜ƒ = "minecraft:" + â˜ƒ.substring("minecraft:bred_".length());
      }

      return (String)RENAMED_IDS.getOrDefault(â˜ƒ, â˜ƒ);
   }
}
