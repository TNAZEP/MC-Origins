...
public class EntityIdFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> â˜ƒxx = this.getInputSchema().getType(References.ITEM_STACK);
      Type<?> â˜ƒxxx = this.getOutputSchema().getType(References.ITEM_STACK);
      return TypeRewriteRule.seq(
         this.convertUnchecked("item stack entity name hook converter", â˜ƒxx, â˜ƒxxx),
         this.fixTypeEverywhere("EntityIdFix", â˜ƒ, â˜ƒx, var0 -> var0x -> var0x.mapFirst(var0xx -> (String)ID_MAP.getOrDefault(var0xx, var0xx)))
      );
   }
}
