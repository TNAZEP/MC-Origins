      ...
      if (null != this.thread) {
         ...
         while(this.thread.isAlive()) {
            try {
               ...
               if (++â˜ƒ >= 5) {
                  LOGGER.warn("Waited {} seconds attempting force stop!", â˜ƒ);
               } else if (this.thread.isAlive()) {
                  LOGGER.warn("Thread {} ({}) failed to exit after {} second(s)", this, this.thread.getState(), â˜ƒ, new Exception("Stack:"));
