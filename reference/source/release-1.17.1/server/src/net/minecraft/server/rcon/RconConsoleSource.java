...
public class RconConsoleSource implements CommandSource {
   ...
   public CommandSourceStack createCommandSourceStack() {
      ServerLevel â˜ƒ = this.server.overworld();
      return new CommandSourceStack(this, Vec3.atLowerCornerOf(â˜ƒ.getSharedSpawnPos()), Vec2.ZERO, â˜ƒ, 4, "Rcon", RCON_COMPONENT, this.server, null);
   }

   @Override
   public void sendMessage(Component var1, UUID var2) {
      this.buffer.append(â˜ƒ.getString());
   }
