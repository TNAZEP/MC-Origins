...
public class EntityDataAccessor implements DataAccessor {
   ...
   public static final Function<String, DataCommands.DataProvider> PROVIDER = var0 -> new DataCommands.DataProvider() {
         ...
         public DataAccessor access(CommandContext<CommandSourceStack> var1) throws CommandSyntaxException {
            return new EntityDataAccessor(EntityArgument.getEntity(â˜ƒ, â˜ƒ));
         }
         ...
         public ArgumentBuilder<CommandSourceStack, ?> wrap(
            ...
            return â˜ƒ.then(Commands.literal("entity").then((ArgumentBuilder<CommandSourceStack, ?>)â˜ƒ.apply(Commands.argument(â˜ƒ, EntityArgument.entity()))));
         }
      };
   ...
   public void setData(CompoundTag var1) throws CommandSyntaxException {
      if (this.entity instanceof Player) {
         ...
         UUID â˜ƒ = this.entity.getUUID();
         this.entity.load(â˜ƒ);
         this.entity.setUUID(â˜ƒ);
      }
   }
   ...
   public Component getPrintSuccess(Tag var1) {
      return new TranslatableComponent("commands.data.entity.query", this.entity.getDisplayName(), NbtUtils.toPrettyComponent(â˜ƒ));
   }

   @Override
   public Component getPrintSuccess(NbtPathArgument.NbtPath var1, double var2, int var4) {
      return new TranslatableComponent("commands.data.entity.get", â˜ƒ, this.entity.getDisplayName(), String.format(Locale.ROOT, "%.2f", â˜ƒ), â˜ƒ);
   }
}
