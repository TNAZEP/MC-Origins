...
public class StoryAdvancements implements Consumer<Consumer<Advancement>> {
   public void accept(Consumer<Advancement> var1) {
      ...
      Advancement â˜ƒxxxxxxxxx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "story/enter_the_nether");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxxxxxxx)
         .display(
            Items.GOLDEN_APPLE,
         ...
         .save(â˜ƒ, "story/cure_zombie_villager");
      Advancement â˜ƒxxxxxxxxxx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "story/follow_ender_eye");
      Advancement.Builder.advancement()
