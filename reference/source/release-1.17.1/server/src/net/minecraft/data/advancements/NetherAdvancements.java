...
public class NetherAdvancements implements Consumer<Consumer<Advancement>> {
   ...
   public void accept(Consumer<Advancement> var1) {
      ...
      Advancement â˜ƒx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "nether/return_to_sender");
      ...
      Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "nether/uneasy_alliance");
      Advancement â˜ƒxxx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "nether/get_wither_skull");
      ...
      Advancement â˜ƒxxxxx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "nether/obtain_blaze_rod");
      ...
      Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "nether/create_full_beacon");
      ...
      Advancement â˜ƒxxxxxxxxx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "nether/obtain_ancient_debris");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxxxxxxx)
         .display(
         ...
         .save(â˜ƒ, "nether/netherite_armor");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxxxxxxx)
         .display(
            Items.LODESTONE,
         ...
         .save(â˜ƒ, "nether/use_lodestone");
      Advancement â˜ƒxxxxxxxxxx = Advancement.Builder.advancement()
         .parent(â˜ƒ)
         .display(
         ...
         .save(â˜ƒ, "nether/obtain_crying_obsidian");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxxxxxxxx)
         .display(
         ...
         .save(â˜ƒ, "nether/charge_respawn_anchor");
      Advancement â˜ƒxxxxxxxxxxx = Advancement.Builder.advancement()
         .parent(â˜ƒ)
         .display(
      ...
      AdventureAdvancements.addBiomes(Advancement.Builder.advancement(), EXPLORABLE_BIOMES)
         ...
         .save(â˜ƒ, "nether/explore_nether");
      Advancement â˜ƒxxxxxxxxxxxx = Advancement.Builder.advancement()
         .parent(â˜ƒ)
         .display(
         ...
         .save(â˜ƒ, "nether/find_bastion");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxxxxxxxxxx)
         .display(
            Blocks.CHEST,
      ...
      Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "nether/distract_piglin");
   }
}
