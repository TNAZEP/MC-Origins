...
public class TheEndAdvancements implements Consumer<Consumer<Advancement>> {
   public void accept(Consumer<Advancement> var1) {
      ...
      Advancement â˜ƒxx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "end/enter_end_gateway");
