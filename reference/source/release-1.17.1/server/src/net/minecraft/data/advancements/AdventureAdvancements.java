...
public class AdventureAdvancements implements Consumer<Consumer<Advancement>> {
   ...
   private static LightningStrikeTrigger.TriggerInstance fireCountAndBystander(MinMaxBounds.Ints var0, EntityPredicate var1) {
      return LightningStrikeTrigger.TriggerInstance.lighthingStrike(
         EntityPredicate.Builder.entity()
            ...
            .lighthingBolt(LighthingBoltPredicate.blockSetOnFire(â˜ƒ))
            .build(),
         â˜ƒ
      );
   }
   ...
   private static UsingItemTrigger.TriggerInstance lookAtThroughItem(EntityType<?> var0, Item var1) {
      return UsingItemTrigger.TriggerInstance.lookingAt(
         EntityPredicate.Builder.entity().player(PlayerPredicate.Builder.player().setLookingAt(EntityPredicate.Builder.entity().of(â˜ƒ).build()).build()),
         ItemPredicate.Builder.item().of(â˜ƒ)
      );
   }
   ...
   public void accept(Consumer<Advancement> var1) {
      ...
      Advancement â˜ƒx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "adventure/sleep_in_bed");
      addBiomes(Advancement.Builder.advancement(), EXPLORABLE_BIOMES)
         ...
         .save(â˜ƒ, "adventure/adventuring_time");
      Advancement â˜ƒxx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "adventure/trade");
      Advancement â˜ƒxxx = this.addMobsToKill(Advancement.Builder.advancement())
         .parent(â˜ƒ)
         .display(
            Items.IRON_SWORD,
      ...
      this.addMobsToKill(Advancement.Builder.advancement())
         ...
         .save(â˜ƒ, "adventure/kill_all_mobs");
      Advancement â˜ƒxxxx = Advancement.Builder.advancement()
         .parent(â˜ƒxxx)
         .display(
            Items.BOW,
         ...
         .save(â˜ƒ, "adventure/shoot_arrow");
      Advancement â˜ƒxxxxx = Advancement.Builder.advancement()
         .parent(â˜ƒxxx)
         .display(
            Items.TRIDENT,
         ...
         .save(â˜ƒ, "adventure/throw_trident");
      Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "adventure/very_very_frightening");
      Advancement.Builder.advancement()
         .parent(â˜ƒxx)
         .display(
         ...
         .save(â˜ƒ, "adventure/summon_iron_golem");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxx)
         .display(
            Items.ARROW,
         ...
         .save(â˜ƒ, "adventure/sniper_duel");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxx)
         .display(
         ...
         .save(â˜ƒ, "adventure/totem_of_undying");
      ...
      Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "adventure/whos_the_pillager_now");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxxxx)
         .display(
            Items.CROSSBOW,
         ...
         .save(â˜ƒ, "adventure/two_birds_one_arrow");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxxxx)
         .display(
            Items.CROSSBOW,
      ...
      Advancement â˜ƒxxxxxxx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "adventure/voluntary_exile");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxxxxx)
         .display(
            Raid.getLeaderBannerInstance(),
         ...
         .save(â˜ƒ, "adventure/hero_of_the_village");
      Advancement.Builder.advancement()
         .parent(â˜ƒ)
         .display(
         ...
         .save(â˜ƒ, "adventure/honey_block_slide");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxx)
         .display(
      ...
      Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "adventure/walk_on_powder_snow_with_leather_boots");
      Advancement.Builder.advancement()
         .parent(â˜ƒ)
         .display(
            Items.LIGHTNING_ROD,
         ...
         .save(â˜ƒ, "adventure/lightning_rod_with_villager_no_fire");
      Advancement â˜ƒxxxxxxxx = Advancement.Builder.advancement()
         ...
         .save(â˜ƒ, "adventure/spyglass_at_parrot");
      Advancement â˜ƒxxxxxxxxx = Advancement.Builder.advancement()
         .parent(â˜ƒxxxxxxxx)
         .display(
            Items.SPYGLASS,
         ...
         .save(â˜ƒ, "adventure/spyglass_at_ghast");
      Advancement.Builder.advancement()
         .parent(â˜ƒxxxxxxxxx)
         .display(
            Items.SPYGLASS,
         ...
         .save(â˜ƒ, "adventure/spyglass_at_dragon");
   }

   private Advancement.Builder addMobsToKill(Advancement.Builder var1) {
      for(EntityType<?> â˜ƒ : MOBS_TO_KILL) {
         â˜ƒ.addCriterion(
            Registry.ENTITY_TYPE.getKey(â˜ƒ).toString(), KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(â˜ƒ))
         );
      }
   ...
   protected static Advancement.Builder addBiomes(Advancement.Builder var0, List<ResourceKey<Biome>> var1) {
      for(ResourceKey<Biome> â˜ƒ : â˜ƒ) {
         â˜ƒ.addCriterion(â˜ƒ.location().toString(), LocationTrigger.TriggerInstance.located(LocationPredicate.inBiome(â˜ƒ)));
      }
