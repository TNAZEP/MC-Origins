...
public class ModelTemplates {
   ...
   private static ModelTemplate create(TextureSlot... var0) {
      return new ModelTemplate(Optional.empty(), Optional.empty(), â˜ƒ);
   }

   private static ModelTemplate create(String var0, TextureSlot... var1) {
      return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + â˜ƒ)), Optional.empty(), â˜ƒ);
   }

   private static ModelTemplate createItem(String var0, TextureSlot... var1) {
      return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "item/" + â˜ƒ)), Optional.empty(), â˜ƒ);
   }

   private static ModelTemplate create(String var0, String var1, TextureSlot... var2) {
      return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + â˜ƒ)), Optional.of(â˜ƒ), â˜ƒ);
   }
}
