...
public class BlockFamilies {
   ...
   private static BlockFamily.Builder familyBuilder(Block var0) {
      BlockFamily.Builder â˜ƒ = new BlockFamily.Builder(â˜ƒ);
      BlockFamily â˜ƒx = (BlockFamily)MAP.put(â˜ƒ, â˜ƒ.getFamily());
      if (â˜ƒx != null) {
         throw new IllegalStateException("Duplicate family definition for " + Registry.BLOCK.getKey(â˜ƒ));
      } else {
         return â˜ƒ;
      }
   }
