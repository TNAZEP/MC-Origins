...
public enum NoteBlockInstrument implements IStringSerializable {
   ...
   public static NoteBlockInstrument func_208087_a(IBlockState var0) {
      Block ☃ = ☃.func_177230_c();
      if (☃ == Blocks.field_150435_aG) {
         return FLUTE;
      } else if (☃ == Blocks.field_150340_R) {
         return BELL;
      } else if (☃.func_203417_a(BlockTags.field_199897_a)) {
         return GUITAR;
      } else if (☃ == Blocks.field_150403_cj) {
         return CHIME;
      } else if (☃ == Blocks.field_189880_di) {
         return XYLOPHONE;
      } else {
         Material ☃ = ☃.func_185904_a();
         if (☃ == Material.field_151576_e) {
            return BASEDRUM;
         } else if (☃ == Material.field_151595_p) {
            return SNARE;
         } else if (☃ == Material.field_151592_s) {
            return HAT;
         } else {
            return ☃ == Material.field_151575_d ? BASS : HARP;
         }
      }
   }
}
