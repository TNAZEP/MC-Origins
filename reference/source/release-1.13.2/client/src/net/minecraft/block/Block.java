...
public class Block implements IItemProvider {
   ...
   public int func_185484_c(IBlockState var1, IWorldReader var2, BlockPos var3) {
      int ☃ = ☃.func_175626_b(☃, ☃.func_185906_d());
      if (☃ == 0 && ☃.func_177230_c() instanceof BlockSlab) {
         ☃ = ☃.func_177977_b();
         ☃ = ☃.func_180495_p(☃);
         return ☃.func_175626_b(☃, ☃.func_185906_d());
      } else {
         return ☃;
      }
   }
   ...
   public static boolean func_176225_a(IBlockState var0, IBlockReader var1, BlockPos var2, EnumFacing var3) {
      ...
      if (☃.func_200017_a(☃x, ☃)) {
         return false;
      } else if (☃x.func_200132_m()) {
         Block.RenderSideCacheKey ☃ = new Block.RenderSideCacheKey(☃, ☃x, ☃);
         Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey> ☃x = (Object2ByteLinkedOpenHashMap)field_210300_r.get();
         byte ☃xx = ☃x.getAndMoveToFirst(☃);
         if (☃xx != 127) {
            return ☃xx != 0;
         } else {
            VoxelShape ☃ = ☃.func_196951_e(☃, ☃);
            VoxelShape ☃x = ☃x.func_196951_e(☃, ☃);
            boolean ☃xx = !VoxelShapes.func_197875_a(☃, ☃x, ☃);
            if (☃x.size() == 200) {
               ☃x.removeLastByte();
            }

            ☃x.putAndMoveToFirst(☃, (byte)(☃xx ? 1 : 0));
            return ☃xx;
         }
      } else {
         return true;
   ...
   public ITextComponent func_200291_n() {
      return new TextComponentTranslation(this.func_149739_a());
   }
   ...
   public float func_185485_f(IBlockState var1) {
      return ☃.func_185898_k() ? 0.2F : 1.0F;
   }
   ...
   public long func_209900_a(IBlockState var1, BlockPos var2) {
      return MathHelper.func_180186_a(☃);
   }
