...
public class BlockEndRod extends BlockDirectional {
   ...
   public void func_180655_c(IBlockState var1, World var2, BlockPos var3, Random var4) {
      ...
      double ☃x = (double)☃.func_177958_n() + 0.55 - (double)(☃.nextFloat() * 0.1F);
      double ☃xx = (double)☃.func_177956_o() + 0.55 - (double)(☃.nextFloat() * 0.1F);
      double ☃xxx = (double)☃.func_177952_p() + 0.55 - (double)(☃.nextFloat() * 0.1F);
      double ☃xxxx = (double)(0.4F - (☃.nextFloat() + ☃.nextFloat()) * 0.4F);
      if (☃.nextInt(5) == 0) {
         ☃.func_195594_a(
            Particles.field_197624_q,
            ☃x + (double)☃.func_82601_c() * ☃xxxx,
            ☃xx + (double)☃.func_96559_d() * ☃xxxx,
            ☃xxx + (double)☃.func_82599_e() * ☃xxxx,
            ☃.nextGaussian() * 0.005,
            ☃.nextGaussian() * 0.005,
            ☃.nextGaussian() * 0.005
         );
