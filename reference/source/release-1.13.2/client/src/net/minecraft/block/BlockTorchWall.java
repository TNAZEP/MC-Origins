...
public class BlockTorchWall extends BlockTorch {
   ...
   public void func_180655_c(IBlockState var1, World var2, BlockPos var3, Random var4) {
      ...
      double ☃xx = (double)☃.func_177956_o() + 0.7;
      double ☃xxx = (double)☃.func_177952_p() + 0.5;
      double ☃xxxx = 0.22;
      double ☃xxxxx = 0.27;
      EnumFacing ☃xxxxxx = ☃.func_176734_d();
      ☃.func_195594_a(
         Particles.field_197601_L, ☃x + 0.27 * (double)☃xxxxxx.func_82601_c(), ☃xx + 0.22, ☃xxx + 0.27 * (double)☃xxxxxx.func_82599_e(), 0.0, 0.0, 0.0
      );
      ☃.func_195594_a(
         Particles.field_197631_x, ☃x + 0.27 * (double)☃xxxxxx.func_82601_c(), ☃xx + 0.22, ☃xxx + 0.27 * (double)☃xxxxxx.func_82599_e(), 0.0, 0.0, 0.0
      );
   }
