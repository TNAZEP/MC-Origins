...
public class BlockBrewingStand extends BlockContainer {
   ...
   public void func_180655_c(IBlockState var1, World var2, BlockPos var3, Random var4) {
      double ☃ = (double)((float)☃.func_177958_n() + 0.4F + ☃.nextFloat() * 0.2F);
      double ☃x = (double)((float)☃.func_177956_o() + 0.7F + ☃.nextFloat() * 0.3F);
      double ☃xx = (double)((float)☃.func_177952_p() + 0.4F + ☃.nextFloat() * 0.2F);
