...
public class BlockRedstoneTorchWall extends BlockRedstoneTorch {
   ...
   public void func_180655_c(IBlockState var1, World var2, BlockPos var3, Random var4) {
      if (☃.func_177229_b(field_196531_c)) {
         EnumFacing ☃ = ((EnumFacing)☃.func_177229_b(field_196530_b)).func_176734_d();
         double ☃x = 0.27;
         double ☃xx = (double)☃.func_177958_n() + 0.5 + (☃.nextDouble() - 0.5) * 0.2 + 0.27 * (double)☃.func_82601_c();
         double ☃xxx = (double)☃.func_177956_o() + 0.7 + (☃.nextDouble() - 0.5) * 0.2 + 0.22;
         double ☃xxxx = (double)☃.func_177952_p() + 0.5 + (☃.nextDouble() - 0.5) * 0.2 + 0.27 * (double)☃.func_82599_e();
         ☃.func_195594_a(RedstoneParticleData.field_197564_a, ☃xx, ☃xxx, ☃xxxx, 0.0, 0.0, 0.0);
      }
   }
