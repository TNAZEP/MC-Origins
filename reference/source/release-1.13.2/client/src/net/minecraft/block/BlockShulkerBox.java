...
public class BlockShulkerBox extends BlockContainer {
   ...
   public void func_190948_a(ItemStack var1, @Nullable IBlockReader var2, List<ITextComponent> var3, ITooltipFlag var4) {
      ...
      if (☃ != null) {
         ...
         if (☃.func_150297_b("Items", 9)) {
            NonNullList<ItemStack> ☃x = NonNullList.func_191197_a(27, ItemStack.field_190927_a);
            ItemStackHelper.func_191283_b(☃, ☃x);
            int ☃xx = 0;
            int ☃xxx = 0;

            for(ItemStack ☃xxxx : ☃x) {
               if (!☃xxxx.func_190926_b()) {
                  ++☃xxx;
                  if (☃xx <= 4) {
                     ++☃xx;
                     ITextComponent ☃xxxxx = ☃xxxx.func_200301_q().func_212638_h();
                     ☃xxxxx.func_150258_a(" x").func_150258_a(String.valueOf(☃xxxx.func_190916_E()));
                     ☃.add(☃xxxxx);
                  }
               }
            }
            ...
            if (☃xxx - ☃xx > 0) {
               ☃.add(new TextComponentTranslation("container.shulkerBox.more", ☃xxx - ☃xx).func_211708_a(TextFormatting.ITALIC));
            }
         }
      }
   }
   ...
   public static EnumDyeColor func_190955_b(Item var0) {
      return func_190954_c(Block.func_149634_a(☃));
   }

   public static EnumDyeColor func_190954_c(Block var0) {
      return ☃ instanceof BlockShulkerBox ? ((BlockShulkerBox)☃).func_190956_e() : null;
   }
