...
public class BlockRedstoneRepeater extends BlockRedstoneDiode {
   ...
   public void func_180655_c(IBlockState var1, World var2, BlockPos var3, Random var4) {
      if (☃.func_177229_b(field_196348_c)) {
         ...
         double ☃x = (double)((float)☃.func_177958_n() + 0.5F) + (double)(☃.nextFloat() - 0.5F) * 0.2;
         double ☃xx = (double)((float)☃.func_177956_o() + 0.4F) + (double)(☃.nextFloat() - 0.5F) * 0.2;
         double ☃xxx = (double)((float)☃.func_177952_p() + 0.5F) + (double)(☃.nextFloat() - 0.5F) * 0.2;
         float ☃xxxx = -5.0F;
         if (☃.nextBoolean()) {
            ☃xxxx = (float)(☃.func_177229_b(field_176410_b) * 2 - 1);
         }

         ☃xxxx /= 16.0F;
         double ☃ = (double)(☃xxxx * (float)☃.func_82601_c());
         double ☃x = (double)(☃xxxx * (float)☃.func_82599_e());
         ☃.func_195594_a(RedstoneParticleData.field_197564_a, ☃x + ☃, ☃xx, ☃xxx + ☃x, 0.0, 0.0, 0.0);
      }
   }
