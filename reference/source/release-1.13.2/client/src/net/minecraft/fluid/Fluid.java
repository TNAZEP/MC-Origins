...
public abstract class Fluid {
   ...
   protected Fluid() {
      StateContainer.Builder<Fluid, IFluidState> ☃ = new StateContainer.Builder<>(this);
      this.func_207184_a(☃);
      this.field_207202_e = ☃.func_206893_a(FluidState::new);
      this.func_207183_f(this.field_207202_e.func_177621_b());
   }
   ...
   public static void func_207195_i() {
      ...
      for(Fluid ☃ : IRegistry.field_212619_h) {
         for(IFluidState ☃x : ☃.func_207182_e().func_177619_a()) {
            field_207201_d.func_195867_b(☃x);
         }
      }
   }

   private static void func_207198_a(String var0, Fluid var1) {
      func_207194_a(new ResourceLocation(☃), ☃);
   }

   private static void func_207194_a(ResourceLocation var0, Fluid var1) {
      IRegistry.field_212619_h.func_82595_a(☃, ☃);
   }
}
