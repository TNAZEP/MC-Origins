...
public interface IFluidState extends IStateHolder<IFluidState> {
   ...
   default boolean func_205586_a(IBlockReader var1, BlockPos var2) {
      for(int ☃ = -1; ☃ <= 1; ++☃) {
         for(int ☃x = -1; ☃x <= 1; ++☃x) {
            BlockPos ☃xx = ☃.func_177982_a(☃, 0, ☃x);
            IFluidState ☃xxx = ☃.func_204610_c(☃xx);
            if (!☃xxx.func_206886_c().func_207187_a(this.func_206886_c()) && !☃.func_180495_p(☃xx).func_200015_d(☃, ☃xx)) {
               return true;
            }
         }
      }
   ...
   default void func_206881_a(World var1, BlockPos var2, Random var3) {
      this.func_206886_c().func_204522_a(☃, ☃, this, ☃);
   }
