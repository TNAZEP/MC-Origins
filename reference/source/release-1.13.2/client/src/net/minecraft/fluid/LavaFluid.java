...
public abstract class LavaFluid extends FlowingFluid {
   ...
   public void func_204522_a(World var1, BlockPos var2, IFluidState var3, Random var4) {
      ...
      if (☃.func_180495_p(☃).func_196958_f() && !☃.func_180495_p(☃).func_200015_d(☃, ☃)) {
         if (☃.nextInt(100) == 0) {
            double ☃x = (double)((float)☃.func_177958_n() + ☃.nextFloat());
            double ☃xx = (double)(☃.func_177956_o() + 1);
            double ☃xxx = (double)((float)☃.func_177952_p() + ☃.nextFloat());
            ☃.func_195594_a(Particles.field_197595_F, ☃x, ☃xx, ☃xxx, 0.0, 0.0, 0.0);
            ☃.func_184134_a(☃x, ☃xx, ☃xxx, SoundEvents.field_187662_cZ, SoundCategory.BLOCKS, 0.2F + ☃.nextFloat() * 0.2F, 0.9F + ☃.nextFloat() * 0.15F, false);
         }
