...
public class TileEntityEnchantmentTable extends TileEntity implements IInteractionObject, ITickable {
   ...
   public NBTTagCompound func_189515_b(NBTTagCompound var1) {
      ...
      if (this.func_145818_k_()) {
         ☃.func_74778_a("CustomName", ITextComponent.Serializer.func_150696_a(this.field_195521_p));
      }
   ...
   public void func_145839_a(NBTTagCompound var1) {
      ...
      if (☃.func_150297_b("CustomName", 8)) {
         this.field_195521_p = ITextComponent.Serializer.func_150699_a(☃.func_74779_i("CustomName"));
      }
   }
   ...
   public void func_73660_a() {
      ...
      EntityPlayer ☃ = this.field_145850_b
         .func_184137_a(
            (double)((float)this.field_174879_c.func_177958_n() + 0.5F),
            (double)((float)this.field_174879_c.func_177956_o() + 0.5F),
            (double)((float)this.field_174879_c.func_177952_p() + 0.5F),
            3.0,
            false
         );
      if (☃ != null) {
         double ☃x = ☃.field_70165_t - (double)((float)this.field_174879_c.func_177958_n() + 0.5F);
         double ☃xx = ☃.field_70161_v - (double)((float)this.field_174879_c.func_177952_p() + 0.5F);
         this.field_195531_n = (float)MathHelper.func_181159_b(☃xx, ☃x);
         this.field_195527_j += 0.1F;
         if (this.field_195527_j < 0.5F || field_195532_o.nextInt(40) == 0) {
            float ☃xxx = this.field_195525_h;

            do {
               this.field_195525_h += (float)(field_195532_o.nextInt(4) - field_195532_o.nextInt(4));
            } while(☃xxx == this.field_195525_h);
         }
      } else {
      ...
      while(this.field_195529_l >= (float) Math.PI) {
         this.field_195529_l -= (float) (Math.PI * 2);
      }
      ...
      float ☃ = this.field_195531_n - this.field_195529_l;
      ...
      this.field_195529_l += ☃ * 0.4F;
      this.field_195527_j = MathHelper.func_76131_a(this.field_195527_j, 0.0F, 1.0F);
      ++this.field_195522_a;
      this.field_195524_g = this.field_195523_f;
      float ☃x = (this.field_195525_h - this.field_195523_f) * 0.4F;
      float ☃xx = 0.2F;
      ☃x = MathHelper.func_76131_a(☃x, -0.2F, 0.2F);
      this.field_195526_i += (☃x - this.field_195526_i) * 0.9F;
      this.field_195523_f += this.field_195526_i;
   }

   @Override
   public ITextComponent func_200200_C_() {
      return (ITextComponent)(this.field_195521_p != null ? this.field_195521_p : new TextComponentTranslation("container.enchant"));
   }
   ...
   public Container func_174876_a(InventoryPlayer var1, EntityPlayer var2) {
      return new ContainerEnchantment(☃, this.field_145850_b, this.field_174879_c);
   }
