...
public class TileEntityEndGateway extends TileEntityEndPortal implements ITickable {
   ...
   public float func_195497_a(float var1) {
      return MathHelper.func_76131_a(((float)this.field_195504_f + ☃) / 200.0F, 0.0F, 1.0F);
   }

   public float func_195491_b(float var1) {
      return 1.0F - MathHelper.func_76131_a(((float)this.field_195505_g - ☃) / 40.0F, 0.0F, 1.0F);
   }
   ...
   public boolean func_184313_a(EnumFacing var1) {
      return Block.func_176225_a(this.func_195044_w(), this.field_145850_b, this.func_174877_v(), ☃);
   }
