...
public class BlockTags {
   private static TagCollection<Block> field_199899_c = new TagCollection<>(var0 -> false, var0 -> null, "", false, "");
   ...
   private static Tag<Block> func_199894_a(String var0) {
      return new BlockTags.Wrapper(new ResourceLocation(☃));
   }
   ...
   static class Wrapper extends Tag<Block> {
      ...
      public boolean func_199685_a_(Block var1) {
         ...
         return this.field_199893_b.func_199685_a_(☃);
      }
