...
public class ItemLingeringPotion extends ItemPotion {
   ...
   public void func_77624_a(ItemStack var1, @Nullable World var2, List<ITextComponent> var3, ITooltipFlag var4) {
      PotionUtils.func_185182_a(☃, ☃, 0.25F);
   }

   @Override
   public ActionResult<ItemStack> func_77659_a(World var1, EntityPlayer var2, EnumHand var3) {
      ItemStack ☃ = ☃.func_184586_b(☃);
      ItemStack ☃x = ☃.field_71075_bZ.field_75098_d ? ☃.func_77946_l() : ☃.func_77979_a(1);
      ☃.func_184148_a(
         null,
         ☃.field_70165_t,
         ☃.field_70163_u,
         ☃.field_70161_v,
         SoundEvents.field_187756_df,
      ...
      if (!☃.field_72995_K) {
         ...
         ☃xx.func_184538_a(☃, ☃.field_70125_A, ☃.field_70177_z, -20.0F, 0.5F, 1.0F);
         ☃.func_72838_d(☃xx);
      }
