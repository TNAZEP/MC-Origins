...
public final class ItemStack {
   ...
   public List<ITextComponent> func_82840_a(@Nullable EntityPlayer var1, ITooltipFlag var2) {
      List<ITextComponent> ☃ = Lists.<ITextComponent>newArrayList();
      ITextComponent ☃x = new TextComponentString("").func_150257_a(this.func_200301_q()).func_211708_a(this.func_77953_t().field_77937_e);
      if (this.func_82837_s()) {
         ☃x.func_211708_a(TextFormatting.ITALIC);
      }

      ☃.add(☃x);
      if (!☃.func_194127_a() && !this.func_82837_s() && this.func_77973_b() == Items.field_151098_aY) {
         ☃.add(new TextComponentString("#" + ItemMap.func_195949_f(this)).func_211708_a(TextFormatting.GRAY));
      }

      int ☃ = 0;
      if (this.func_77942_o() && this.field_77990_d.func_150297_b("HideFlags", 99)) {
         ☃ = this.field_77990_d.func_74762_e("HideFlags");
      }

      if ((☃ & 32) == 0) {
         this.func_77973_b().func_77624_a(this, ☃ == null ? null : ☃.field_70170_p, ☃, ☃);
      }

      if (this.func_77942_o()) {
         if ((☃ & 1) == 0) {
            NBTTagList ☃ = this.func_77986_q();
         ...
         if (this.field_77990_d.func_150297_b("display", 10)) {
            NBTTagCompound ☃ = this.field_77990_d.func_74775_l("display");
            if (☃.func_150297_b("color", 3)) {
               if (☃.func_194127_a()) {
                  ☃.add(new TextComponentTranslation("item.color", String.format("#%06X", ☃.func_74762_e("color"))).func_211708_a(TextFormatting.GRAY));
               } else {
                  ☃.add(new TextComponentTranslation("item.dyed").func_211709_a(new TextFormatting[]{TextFormatting.GRAY, TextFormatting.ITALIC}));
               }
            }

            if (☃.func_150299_b("Lore") == 9) {
               NBTTagList ☃ = ☃.func_150295_c("Lore", 8);

               for(int ☃x = 0; ☃x < ☃.size(); ++☃x) {
                  ☃.add(new TextComponentString(☃.func_150307_f(☃x)).func_211709_a(new TextFormatting[]{TextFormatting.DARK_PURPLE, TextFormatting.ITALIC}));
               }
            }
         }
      }
      ...
      for(EntityEquipmentSlot ☃ : EntityEquipmentSlot.values()) {
         Multimap<String, AttributeModifier> ☃x = this.func_111283_C(☃);
         if (!☃x.isEmpty() && (☃ & 2) == 0) {
            ☃.add(new TextComponentString(""));
            ☃.add(new TextComponentTranslation("item.modifiers." + ☃.func_188450_d()).func_211708_a(TextFormatting.GRAY));

            for(Entry<String, AttributeModifier> ☃xx : ☃x.entries()) {
               AttributeModifier ☃xxx = (AttributeModifier)☃xx.getValue();
               double ☃xxxx = ☃xxx.func_111164_d();
               boolean ☃xxxxx = false;
               if (☃ != null) {
                  if (☃xxx.func_111167_a() == Item.field_111210_e) {
                     ☃xxxx += ☃.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111125_b();
                     ☃xxxx += (double)EnchantmentHelper.func_152377_a(this, CreatureAttribute.UNDEFINED);
                     ☃xxxxx = true;
                  } else if (☃xxx.func_111167_a() == Item.field_185050_h) {
                     ☃xxxx += ☃.func_110148_a(SharedMonsterAttributes.field_188790_f).func_111125_b();
                     ☃xxxxx = true;
                  }
               }

               double ☃xxx;
               if (☃xxx.func_111169_c() != 1 && ☃xxx.func_111169_c() != 2) {
                  ☃xxx = ☃xxxx;
               } else {
                  ☃xxx = ☃xxxx * 100.0;
               }
               ...
               if (☃xxxxx) {
                     ...
                     new TextComponentString(" ")
                        .func_150257_a(
                           new TextComponentTranslation(
                              "attribute.modifier.equals." + ☃xxx.func_111169_c(),
                              field_111284_a.format(☃xxx),
                              new TextComponentTranslation("attribute.name." + (String)☃xx.getKey())
                           )
                        )
                  ...
                  ☃.add(
                     new TextComponentTranslation(
                           "attribute.modifier.plus." + ☃xxx.func_111169_c(),
                           field_111284_a.format(☃xxx),
                           new TextComponentTranslation("attribute.name." + (String)☃xx.getKey())
                        )
                  ...
                  ☃.add(
                     new TextComponentTranslation(
                           "attribute.modifier.take." + ☃xxx.func_111169_c(),
                           field_111284_a.format(☃xxx),
                           new TextComponentTranslation("attribute.name." + (String)☃xx.getKey())
                        )
      ...
      if (this.func_77942_o() && this.func_77978_p().func_74767_n("Unbreakable") && (☃ & 4) == 0) {
         ☃.add(new TextComponentTranslation("item.unbreakable").func_211708_a(TextFormatting.BLUE));
      }

      if (this.func_77942_o() && this.field_77990_d.func_150297_b("CanDestroy", 9) && (☃ & 8) == 0) {
         NBTTagList ☃ = this.field_77990_d.func_150295_c("CanDestroy", 8);
         if (!☃.isEmpty()) {
            ☃.add(new TextComponentString(""));
            ☃.add(new TextComponentTranslation("item.canBreak").func_211708_a(TextFormatting.GRAY));

            for(int ☃x = 0; ☃x < ☃.size(); ++☃x) {
               ☃.addAll(func_206845_f(☃.func_150307_f(☃x)));
            }
         }
      }

      if (this.func_77942_o() && this.field_77990_d.func_150297_b("CanPlaceOn", 9) && (☃ & 16) == 0) {
         NBTTagList ☃ = this.field_77990_d.func_150295_c("CanPlaceOn", 8);
         if (!☃.isEmpty()) {
            ☃.add(new TextComponentString(""));
            ☃.add(new TextComponentTranslation("item.canPlace").func_211708_a(TextFormatting.GRAY));
      ...
      if (☃.func_194127_a()) {
         if (this.func_77951_h()) {
            ☃.add(new TextComponentTranslation("item.durability", this.func_77958_k() - this.func_77952_i(), this.func_77958_k()));
         }

         ☃.add(new TextComponentString(IRegistry.field_212630_s.func_177774_c(this.func_77973_b()).toString()).func_211708_a(TextFormatting.DARK_GRAY));
         if (this.func_77942_o()) {
            ☃.add(new TextComponentTranslation("item.nbt_tags", this.func_77978_p().func_150296_c().size()).func_211708_a(TextFormatting.DARK_GRAY));
         }
      }
   ...
   private static Collection<ITextComponent> func_206845_f(String var0) {
      try {
         BlockStateParser ☃ = new BlockStateParser(new StringReader(☃), true).func_197243_a(true);
         IBlockState ☃x = ☃.func_197249_b();
         ResourceLocation ☃xx = ☃.func_199829_d();
         boolean ☃xxx = ☃x != null;
         boolean ☃xxxx = ☃xx != null;
         if (☃xxx || ☃xxxx) {
            if (☃xxx) {
               return Lists.<ITextComponent>newArrayList(☃x.func_177230_c().func_200291_n().func_211708_a(TextFormatting.DARK_GRAY));
            }

            Tag<Block> ☃xxxxx = BlockTags.func_199896_a().func_199910_a(☃xx);
            if (☃xxxxx != null) {
               Collection<Block> ☃xxxxxx = ☃xxxxx.func_199885_a();
               if (!☃xxxxxx.isEmpty()) {
                  return (Collection<ITextComponent>)☃xxxxxx.stream()
                     .map(Block::func_200291_n)
                     .map(var0x -> var0x.func_211708_a(TextFormatting.DARK_GRAY))
      ...
      return Lists.<ITextComponent>newArrayList(new TextComponentString("missingno").func_211708_a(TextFormatting.DARK_GRAY));
   }
