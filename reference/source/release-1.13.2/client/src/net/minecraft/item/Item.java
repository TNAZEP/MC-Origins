...
public class Item implements IItemProvider {
   ...
   private static final IItemPropertyGetter field_185046_b = (var0, var1, var2) -> var0.func_77951_h() ? 1.0F : 0.0F;
   private static final IItemPropertyGetter field_185047_c = (var0, var1, var2) -> MathHelper.func_76131_a(
         (float)var0.func_77952_i() / (float)var0.func_77958_k(), 0.0F, 1.0F
      );
   private static final IItemPropertyGetter field_185048_d = (var0, var1, var2) -> var2 != null && var2.func_184591_cq() != EnumHandSide.RIGHT ? 1.0F : 0.0F;
   private static final IItemPropertyGetter field_185049_e = (var0, var1, var2) -> var2 instanceof EntityPlayer
         ? ((EntityPlayer)var2).func_184811_cZ().func_185143_a(var0.func_77973_b(), 0.0F)
         : 0.0F;
   ...
   private final Map<ResourceLocation, IItemPropertyGetter> field_185051_m = Maps.<ResourceLocation, IItemPropertyGetter>newHashMap();
   ...
   public static int func_150891_b(Item var0) {
      return ☃ == null ? 0 : IRegistry.field_212630_s.func_148757_b(☃);
   }

   public static Item func_150899_d(int var0) {
      return IRegistry.field_212630_s.func_148754_a(☃);
   }

   @Deprecated
   public static Item func_150898_a(Block var0) {
      Item ☃ = (Item)field_179220_a.get(☃);
      return ☃ == null ? Items.field_190931_a : ☃;
   }
   ...
   public Item(Item.Properties var1) {
      ...
      this.field_77701_a = ☃.field_200923_d;
      this.field_208075_l = ☃.field_208104_e;
      this.field_77700_c = ☃.field_200922_c;
      this.field_77699_b = ☃.field_200921_b;
      this.field_77777_bU = ☃.field_200920_a;
   ...
   public IItemPropertyGetter func_185045_a(ResourceLocation var1) {
      return (IItemPropertyGetter)this.field_185051_m.get(☃);
   }
   ...
   public ITextComponent func_200296_o() {
      return new TextComponentTranslation(this.func_77658_a());
   }
   ...
   public ITextComponent func_200295_i(ItemStack var1) {
      return new TextComponentTranslation(this.func_77667_c(☃));
   }
   ...
   protected RayTraceResult func_77621_a(World var1, EntityPlayer var2, boolean var3) {
      ...
      double ☃xxx = ☃.field_70163_u + (double)☃.func_70047_e();
      double ☃xxxx = ☃.field_70161_v;
      Vec3d ☃xxxxx = new Vec3d(☃xx, ☃xxx, ☃xxxx);
      float ☃xxxxxx = MathHelper.func_76134_b(-☃x * (float) (Math.PI / 180.0) - (float) Math.PI);
      float ☃xxxxxxx = MathHelper.func_76126_a(-☃x * (float) (Math.PI / 180.0) - (float) Math.PI);
      float ☃xxxxxxxx = -MathHelper.func_76134_b(-☃ * (float) (Math.PI / 180.0));
      float ☃xxxxxxxxx = MathHelper.func_76126_a(-☃ * (float) (Math.PI / 180.0));
      float ☃xxxxxxxxxx = ☃xxxxxxx * ☃xxxxxxxx;
      float ☃xxxxxxxxxxx = ☃xxxxxx * ☃xxxxxxxx;
      double ☃xxxxxxxxxxxx = 5.0;
      Vec3d ☃xxxxxxxxxxxxx = ☃xxxxx.func_72441_c((double)☃xxxxxxxxxx * 5.0, (double)☃xxxxxxxxx * 5.0, (double)☃xxxxxxxxxxx * 5.0);
      return ☃.func_200259_a(☃xxxxx, ☃xxxxxxxxxxxxx, ☃ ? RayTraceFluidMode.SOURCE_ONLY : RayTraceFluidMode.NEVER, false, false);
   }
   ...
   protected boolean func_194125_a(ItemGroup var1) {
      ItemGroup ☃ = this.func_77640_w();
      return ☃ != null && (☃ == ItemGroup.field_78027_g || ☃ == ☃);
   }
   ...
   public static void func_150900_l() {
      ...
      func_195936_a(
         "turtle_helmet", new ItemArmor(ArmorMaterial.TURTLE, EntityEquipmentSlot.HEAD, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      ...
      func_195936_a(
         "leather_helmet", new ItemArmorDyeable(ArmorMaterial.LEATHER, EntityEquipmentSlot.HEAD, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "leather_chestplate",
         new ItemArmorDyeable(ArmorMaterial.LEATHER, EntityEquipmentSlot.CHEST, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "leather_leggings",
         new ItemArmorDyeable(ArmorMaterial.LEATHER, EntityEquipmentSlot.LEGS, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "leather_boots", new ItemArmorDyeable(ArmorMaterial.LEATHER, EntityEquipmentSlot.FEET, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "chainmail_helmet", new ItemArmor(ArmorMaterial.CHAIN, EntityEquipmentSlot.HEAD, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "chainmail_chestplate", new ItemArmor(ArmorMaterial.CHAIN, EntityEquipmentSlot.CHEST, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "chainmail_leggings", new ItemArmor(ArmorMaterial.CHAIN, EntityEquipmentSlot.LEGS, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "chainmail_boots", new ItemArmor(ArmorMaterial.CHAIN, EntityEquipmentSlot.FEET, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      ...
      func_195936_a(
         "iron_chestplate", new ItemArmor(ArmorMaterial.IRON, EntityEquipmentSlot.CHEST, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      ...
      func_195936_a(
         "diamond_helmet", new ItemArmor(ArmorMaterial.DIAMOND, EntityEquipmentSlot.HEAD, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "diamond_chestplate", new ItemArmor(ArmorMaterial.DIAMOND, EntityEquipmentSlot.CHEST, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "diamond_leggings", new ItemArmor(ArmorMaterial.DIAMOND, EntityEquipmentSlot.LEGS, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "diamond_boots", new ItemArmor(ArmorMaterial.DIAMOND, EntityEquipmentSlot.FEET, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      ...
      func_195936_a(
         "golden_chestplate", new ItemArmor(ArmorMaterial.GOLD, EntityEquipmentSlot.CHEST, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      func_195936_a(
         "golden_leggings", new ItemArmor(ArmorMaterial.GOLD, EntityEquipmentSlot.LEGS, new Item.Properties().func_200916_a(ItemGroup.field_78037_j))
      );
      ...
      func_195936_a(
         "golden_apple",
         new ItemAppleGold(4, 1.2F, false, new Item.Properties().func_200916_a(ItemGroup.field_78039_h).func_208103_a(EnumRarity.RARE)).func_77848_i()
      );
      func_195936_a(
         "enchanted_golden_apple",
         new ItemAppleGoldEnchanted(4, 1.2F, false, new Item.Properties().func_200916_a(ItemGroup.field_78039_h).func_208103_a(EnumRarity.EPIC)).func_77848_i()
      );
      func_195936_a("sign", new ItemSign(new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c)));
      Item ☃ = new ItemBucket(Fluids.field_204541_a, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78026_f));
      func_195936_a("bucket", ☃);
      func_195936_a(
         "water_bucket", new ItemBucket(Fluids.field_204546_a, new Item.Properties().func_200919_a(☃).func_200917_a(1).func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "lava_bucket", new ItemBucket(Fluids.field_204547_b, new Item.Properties().func_200919_a(☃).func_200917_a(1).func_200916_a(ItemGroup.field_78026_f))
      );
      ...
      func_195936_a("milk_bucket", new ItemBucketMilk(new Item.Properties().func_200919_a(☃).func_200917_a(1).func_200916_a(ItemGroup.field_78026_f)));
      func_195936_a(
         "pufferfish_bucket",
         new ItemBucketFish(EntityType.field_203779_Z, Fluids.field_204546_a, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "salmon_bucket",
         new ItemBucketFish(EntityType.field_203778_ae, Fluids.field_204546_a, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "cod_bucket",
         new ItemBucketFish(EntityType.field_203780_j, Fluids.field_204546_a, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "tropical_fish_bucket",
         new ItemBucketFish(EntityType.field_204262_at, Fluids.field_204546_a, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f))
      );
      ...
      func_195936_a(
         "chest_minecart", new ItemMinecart(EntityMinecart.Type.CHEST, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78029_e))
      );
      func_195936_a(
         "furnace_minecart", new ItemMinecart(EntityMinecart.Type.FURNACE, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78029_e))
      );
      ...
      func_195936_a(
         "chicken",
         new ItemFood(2, 0.3F, true, new Item.Properties().func_200916_a(ItemGroup.field_78039_h))
            .func_185070_a(new PotionEffect(MobEffects.field_76438_s, 600, 0), 0.3F)
      );
      func_195936_a("cooked_chicken", new ItemFood(6, 0.6F, true, new Item.Properties().func_200916_a(ItemGroup.field_78039_h)));
      func_195936_a(
         "rotten_flesh",
         new ItemFood(4, 0.1F, true, new Item.Properties().func_200916_a(ItemGroup.field_78039_h))
            .func_185070_a(new PotionEffect(MobEffects.field_76438_s, 600, 0), 0.8F)
      );
      ...
      Item ☃x = new ItemGlassBottle(new Item.Properties().func_200916_a(ItemGroup.field_78038_k));
      func_195936_a("glass_bottle", ☃x);
      func_195936_a(
         "spider_eye",
         new ItemFood(2, 0.8F, false, new Item.Properties().func_200916_a(ItemGroup.field_78039_h))
            .func_185070_a(new PotionEffect(MobEffects.field_76436_u, 100, 0), 1.0F)
      );
      ...
      func_195936_a(
         "blaze_spawn_egg", new ItemSpawnEgg(EntityType.field_200792_f, 16167425, 16775294, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "cave_spider_spawn_egg", new ItemSpawnEgg(EntityType.field_200794_h, 803406, 11013646, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "chicken_spawn_egg", new ItemSpawnEgg(EntityType.field_200795_i, 10592673, 16711680, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "cod_spawn_egg", new ItemSpawnEgg(EntityType.field_203780_j, 12691306, 15058059, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "cow_spawn_egg", new ItemSpawnEgg(EntityType.field_200796_j, 4470310, 10592673, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      ...
      func_195936_a(
         "dolphin_spawn_egg", new ItemSpawnEgg(EntityType.field_205137_n, 2243405, 16382457, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "donkey_spawn_egg", new ItemSpawnEgg(EntityType.field_200798_l, 5457209, 8811878, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "drowned_spawn_egg", new ItemSpawnEgg(EntityType.field_204724_o, 9433559, 7969893, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "elder_guardian_spawn_egg",
         new ItemSpawnEgg(EntityType.field_200800_n, 13552826, 7632531, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      ...
      func_195936_a(
         "endermite_spawn_egg", new ItemSpawnEgg(EntityType.field_200804_r, 1447446, 7237230, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "evoker_spawn_egg", new ItemSpawnEgg(EntityType.field_200806_t, 9804699, 1973274, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "ghast_spawn_egg", new ItemSpawnEgg(EntityType.field_200811_y, 16382457, 12369084, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "guardian_spawn_egg", new ItemSpawnEgg(EntityType.field_200761_A, 5931634, 15826224, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "horse_spawn_egg", new ItemSpawnEgg(EntityType.field_200762_B, 12623485, 15656192, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "husk_spawn_egg", new ItemSpawnEgg(EntityType.field_200763_C, 7958625, 15125652, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "llama_spawn_egg", new ItemSpawnEgg(EntityType.field_200769_I, 12623485, 10051392, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "magma_cube_spawn_egg", new ItemSpawnEgg(EntityType.field_200771_K, 3407872, 16579584, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "mooshroom_spawn_egg", new ItemSpawnEgg(EntityType.field_200780_T, 10489616, 12040119, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "mule_spawn_egg", new ItemSpawnEgg(EntityType.field_200779_S, 1769984, 5321501, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "ocelot_spawn_egg", new ItemSpawnEgg(EntityType.field_200781_U, 15720061, 5653556, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "parrot_spawn_egg", new ItemSpawnEgg(EntityType.field_200783_W, 894731, 16711680, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "phantom_spawn_egg", new ItemSpawnEgg(EntityType.field_203097_aH, 4411786, 8978176, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "pig_spawn_egg", new ItemSpawnEgg(EntityType.field_200784_X, 15771042, 14377823, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "polar_bear_spawn_egg", new ItemSpawnEgg(EntityType.field_200786_Z, 15921906, 9803152, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "pufferfish_spawn_egg", new ItemSpawnEgg(EntityType.field_203779_Z, 16167425, 3654642, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "rabbit_spawn_egg", new ItemSpawnEgg(EntityType.field_200736_ab, 10051392, 7555121, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "salmon_spawn_egg", new ItemSpawnEgg(EntityType.field_203778_ae, 10489616, 951412, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "sheep_spawn_egg", new ItemSpawnEgg(EntityType.field_200737_ac, 15198183, 16758197, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "shulker_spawn_egg", new ItemSpawnEgg(EntityType.field_200738_ad, 9725844, 5060690, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "silverfish_spawn_egg", new ItemSpawnEgg(EntityType.field_200740_af, 7237230, 3158064, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "skeleton_spawn_egg", new ItemSpawnEgg(EntityType.field_200741_ag, 12698049, 4802889, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "skeleton_horse_spawn_egg",
         new ItemSpawnEgg(EntityType.field_200742_ah, 6842447, 15066584, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "slime_spawn_egg", new ItemSpawnEgg(EntityType.field_200743_ai, 5349438, 8306542, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "spider_spawn_egg", new ItemSpawnEgg(EntityType.field_200748_an, 3419431, 11013646, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "squid_spawn_egg", new ItemSpawnEgg(EntityType.field_200749_ao, 2243405, 7375001, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "stray_spawn_egg", new ItemSpawnEgg(EntityType.field_200750_ap, 6387319, 14543594, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "tropical_fish_spawn_egg",
         new ItemSpawnEgg(EntityType.field_204262_at, 15690005, 16775663, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "turtle_spawn_egg", new ItemSpawnEgg(EntityType.field_203099_aq, 15198183, 44975, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "vex_spawn_egg", new ItemSpawnEgg(EntityType.field_200755_au, 8032420, 15265265, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "villager_spawn_egg", new ItemSpawnEgg(EntityType.field_200756_av, 5651507, 12422002, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "vindicator_spawn_egg", new ItemSpawnEgg(EntityType.field_200758_ax, 9804699, 2580065, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "witch_spawn_egg", new ItemSpawnEgg(EntityType.field_200759_ay, 3407872, 5349438, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "wither_skeleton_spawn_egg",
         new ItemSpawnEgg(EntityType.field_200722_aA, 1315860, 4672845, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "wolf_spawn_egg", new ItemSpawnEgg(EntityType.field_200724_aC, 14144467, 13545366, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "zombie_spawn_egg", new ItemSpawnEgg(EntityType.field_200725_aD, 44975, 7969893, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "zombie_horse_spawn_egg", new ItemSpawnEgg(EntityType.field_200726_aE, 3232308, 9945732, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "zombie_pigman_spawn_egg",
         new ItemSpawnEgg(EntityType.field_200785_Y, 15373203, 5009705, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      func_195936_a(
         "zombie_villager_spawn_egg",
         new ItemSpawnEgg(EntityType.field_200727_aF, 5651507, 7969893, new Item.Properties().func_200916_a(ItemGroup.field_78026_f))
      );
      ...
      func_195936_a(
         "poisonous_potato",
         new ItemFood(2, 0.3F, false, new Item.Properties().func_200916_a(ItemGroup.field_78039_h))
            .func_185070_a(new PotionEffect(MobEffects.field_76436_u, 100, 0), 0.6F)
      );
      ...
      func_200126_a(
         new ItemWallOrFloor(
            Blocks.field_196703_eM, Blocks.field_196701_eL, new Item.Properties().func_200916_a(ItemGroup.field_78031_c).func_208103_a(EnumRarity.UNCOMMON)
         )
      );
      func_200126_a(
         new ItemWallOrFloor(
            Blocks.field_196705_eO, Blocks.field_196704_eN, new Item.Properties().func_200916_a(ItemGroup.field_78031_c).func_208103_a(EnumRarity.UNCOMMON)
         )
      );
      func_200126_a(
         new ItemSkull(
            Blocks.field_196710_eS, Blocks.field_196709_eR, new Item.Properties().func_200916_a(ItemGroup.field_78031_c).func_208103_a(EnumRarity.UNCOMMON)
         )
      );
      func_200126_a(
         new ItemWallOrFloor(
            Blocks.field_196708_eQ, Blocks.field_196707_eP, new Item.Properties().func_200916_a(ItemGroup.field_78031_c).func_208103_a(EnumRarity.UNCOMMON)
         )
      );
      func_200126_a(
         new ItemWallOrFloor(
            Blocks.field_196714_eU, Blocks.field_196712_eT, new Item.Properties().func_200916_a(ItemGroup.field_78031_c).func_208103_a(EnumRarity.UNCOMMON)
         )
      );
      func_200126_a(
         new ItemWallOrFloor(
            Blocks.field_196716_eW, Blocks.field_196715_eV, new Item.Properties().func_200916_a(ItemGroup.field_78031_c).func_208103_a(EnumRarity.UNCOMMON)
         )
      );
      ...
      func_195936_a(
         "hopper_minecart", new ItemMinecart(EntityMinecart.Type.HOPPER, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78029_e))
      );
      ...
      func_195936_a(
         "white_banner",
         new ItemBanner(Blocks.field_196784_gT, Blocks.field_196843_hj, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "orange_banner",
         new ItemBanner(Blocks.field_196786_gU, Blocks.field_196845_hk, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "magenta_banner",
         new ItemBanner(Blocks.field_196788_gV, Blocks.field_196847_hl, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "light_blue_banner",
         new ItemBanner(Blocks.field_196790_gW, Blocks.field_196849_hm, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "yellow_banner",
         new ItemBanner(Blocks.field_196792_gX, Blocks.field_196851_hn, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "lime_banner",
         new ItemBanner(Blocks.field_196794_gY, Blocks.field_196853_ho, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "pink_banner",
         new ItemBanner(Blocks.field_196796_gZ, Blocks.field_196855_hp, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "gray_banner",
         new ItemBanner(Blocks.field_196826_ha, Blocks.field_196857_hq, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "light_gray_banner",
         new ItemBanner(Blocks.field_196827_hb, Blocks.field_196859_hr, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "cyan_banner",
         new ItemBanner(Blocks.field_196829_hc, Blocks.field_196861_hs, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "purple_banner",
         new ItemBanner(Blocks.field_196831_hd, Blocks.field_196863_ht, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "blue_banner",
         new ItemBanner(Blocks.field_196833_he, Blocks.field_196865_hu, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "brown_banner",
         new ItemBanner(Blocks.field_196835_hf, Blocks.field_196867_hv, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "green_banner",
         new ItemBanner(Blocks.field_196837_hg, Blocks.field_196869_hw, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "red_banner",
         new ItemBanner(Blocks.field_196839_hh, Blocks.field_196871_hx, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      func_195936_a(
         "black_banner",
         new ItemBanner(Blocks.field_196841_hi, Blocks.field_196873_hy, new Item.Properties().func_200917_a(16).func_200916_a(ItemGroup.field_78031_c))
      );
      ...
      func_195936_a(
         "dragon_breath", new Item(new Item.Properties().func_200919_a(☃x).func_200916_a(ItemGroup.field_78038_k).func_208103_a(EnumRarity.UNCOMMON))
      );
      ...
      func_195936_a(
         "elytra", new ItemElytra(new Item.Properties().func_200918_c(432).func_200916_a(ItemGroup.field_78029_e).func_208103_a(EnumRarity.UNCOMMON))
      );
      ...
      func_195936_a(
         "totem_of_undying", new Item(new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78037_j).func_208103_a(EnumRarity.UNCOMMON))
      );
      ...
      func_195936_a(
         "music_disc_13",
         new ItemRecord(
            1, SoundEvents.field_187828_ep, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_cat",
         new ItemRecord(
            2, SoundEvents.field_187832_er, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_blocks",
         new ItemRecord(
            3, SoundEvents.field_187830_eq, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_chirp",
         new ItemRecord(
            4, SoundEvents.field_187834_es, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_far",
         new ItemRecord(
            5, SoundEvents.field_187836_et, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_mall",
         new ItemRecord(
            6, SoundEvents.field_187838_eu, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_mellohi",
         new ItemRecord(
            7, SoundEvents.field_187840_ev, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_stal",
         new ItemRecord(
            8, SoundEvents.field_187842_ew, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_strad",
         new ItemRecord(
            9, SoundEvents.field_187844_ex, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_ward",
         new ItemRecord(
            10, SoundEvents.field_187848_ez, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_11",
         new ItemRecord(
            11, SoundEvents.field_187826_eo, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
      func_195936_a(
         "music_disc_wait",
         new ItemRecord(
            12, SoundEvents.field_187846_ey, new Item.Properties().func_200917_a(1).func_200916_a(ItemGroup.field_78026_f).func_208103_a(EnumRarity.RARE)
         )
      );
   ...
   public static class Properties {
      ...
      public Item.Properties func_200915_b(int var1) {
         return this.field_200921_b == 0 ? this.func_200918_c(☃) : this;
      }
