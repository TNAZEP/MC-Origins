...
public class ItemWrittenBook extends Item {
   ...
   public void func_77624_a(ItemStack var1, @Nullable World var2, List<ITextComponent> var3, ITooltipFlag var4) {
      if (☃.func_77942_o()) {
         NBTTagCompound ☃ = ☃.func_77978_p();
         String ☃x = ☃.func_74779_i("author");
         if (!StringUtils.func_151246_b(☃x)) {
            ☃.add(new TextComponentTranslation("book.byAuthor", ☃x).func_211708_a(TextFormatting.GRAY));
         }

         ☃.add(new TextComponentTranslation("book.generation." + ☃.func_74762_e("generation")).func_211708_a(TextFormatting.GRAY));
      }
   }
