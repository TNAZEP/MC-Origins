...
public class ScoreObjective {
   ...
   public ITextComponent func_197890_e() {
      return TextComponentUtils.func_197676_a(
         this.field_96683_d
            .func_212638_h()
            .func_211710_a(var1 -> var1.func_150209_a(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponentString(this.func_96679_b()))))
      );
   }
