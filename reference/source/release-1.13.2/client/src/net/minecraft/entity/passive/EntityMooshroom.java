...
public class EntityMooshroom extends EntityCow {
   public EntityMooshroom(World var1) {
      super(EntityType.field_200780_T, ☃);
   ...
   public boolean func_184645_a(EntityPlayer var1, EnumHand var2) {
      ...
      if (☃.func_77973_b() == Items.field_151054_z && this.func_70874_b() >= 0 && !☃.field_71075_bZ.field_75098_d) {
         ☃.func_190918_g(1);
         if (☃.func_190926_b()) {
            ☃.func_184611_a(☃, new ItemStack(Items.field_151009_A));
         } else if (!☃.field_71071_by.func_70441_a(new ItemStack(Items.field_151009_A))) {
            ☃.func_71019_a(new ItemStack(Items.field_151009_A), false);
         }

         return true;
      } else if (☃.func_77973_b() == Items.field_151097_aZ && this.func_70874_b() >= 0) {
         this.field_70170_p
            .func_195594_a(
               Particles.field_197627_t, this.field_70165_t, this.field_70163_u + (double)(this.field_70131_O / 2.0F), this.field_70161_v, 0.0, 0.0, 0.0
            );
         if (!this.field_70170_p.field_72995_K) {
            ...
            ☃.func_70606_j(this.func_110143_aJ());
            ☃.field_70761_aq = this.field_70761_aq;
