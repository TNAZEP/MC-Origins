...
public class InventoryPlayer implements IInventory {
   ...
   public int func_184429_b(ItemStack var1) {
      for(int ☃ = 0; ☃ < this.field_70462_a.size(); ++☃) {
         if (!this.field_70462_a.get(☃).func_190926_b() && this.func_184431_b(☃, this.field_70462_a.get(☃))) {
            return ☃;
         }
      }
   ...
   public void func_195409_a(double var1) {
      ...
      this.field_70461_c = (int)((double)this.field_70461_c - ☃);
   ...
   public boolean func_199712_a(Tag<Item> var1) {
      for(List<ItemStack> ☃ : this.field_184440_g) {
         for(ItemStack ☃x : ☃) {
            if (!☃x.func_190926_b() && ☃.func_199685_a_(☃x.func_77973_b())) {
               return true;
            }
         }
      }
