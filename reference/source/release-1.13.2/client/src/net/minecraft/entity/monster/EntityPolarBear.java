...
public class EntityPolarBear extends EntityAnimal {
   ...
   public EntityPolarBear(World var1) {
      super(EntityType.field_200786_Z, ☃);
   ...
   public boolean func_205020_a(IWorld var1, boolean var2) {
      ...
      Biome ☃xxxx = ☃.func_180494_b(☃xxx);
      if (☃xxxx != Biomes.field_76776_l && ☃xxxx != Biomes.field_203620_Z) {
         return super.func_205020_a(☃, ☃);
      } else {
         return ☃.func_201669_a(☃xxx, 0) > 8 && ☃.func_180495_p(☃xxx.func_177977_b()).func_177230_c() == Blocks.field_150432_aD;
      }
   }
   ...
   public void func_189794_p(boolean var1) {
      this.field_70180_af.func_187227_b(field_189798_bx, ☃);
   }

   public float func_189795_r(float var1) {
      return (this.field_189799_by + (this.field_189800_bz - this.field_189799_by) * ☃) / 6.0F;
   }
   ...
   public IEntityLivingData func_204210_a(DifficultyInstance var1, @Nullable IEntityLivingData var2, @Nullable NBTTagCompound var3) {
      if (☃ instanceof EntityPolarBear.GroupData) {
         if (((EntityPolarBear.GroupData)☃).field_190101_a) {
      ...
      public boolean func_75250_a() {
         if (EntityPolarBear.this.func_70631_g_()) {
            ...
            if (super.func_75250_a()) {
               for(EntityPolarBear ☃ : EntityPolarBear.this.field_70170_p
                  .func_72872_a(EntityPolarBear.class, EntityPolarBear.this.func_174813_aQ().func_72314_b(8.0, 4.0, 8.0))) {
                  if (☃.func_70631_g_()) {
                     return true;
                  }
               }
   ...
   class AIHurtByTarget extends EntityAIHurtByTarget {
      ...
      protected void func_179446_a(EntityCreature var1, EntityLivingBase var2) {
         if (☃ instanceof EntityPolarBear && !☃.func_70631_g_()) {
            super.func_179446_a(☃, ☃);
         }
      }
   }
