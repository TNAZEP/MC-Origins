...
public class EntityAIOcelotAttack extends EntityAIBase {
   ...
   public EntityAIOcelotAttack(EntityLiving var1) {
      this.field_75409_b = ☃;
      this.field_75411_a = ☃.field_70170_p;
      this.func_75248_a(3);
   }

   @Override
   public boolean func_75250_a() {
      EntityLivingBase ☃ = this.field_75409_b.func_70638_az();
      if (☃ == null) {
         return false;
      } else {
         this.field_75410_c = ☃;
   ...
   public void func_75246_d() {
      ...
      double ☃ = (double)(this.field_75409_b.field_70130_N * 2.0F * this.field_75409_b.field_70130_N * 2.0F);
      double ☃x = this.field_75409_b
         .func_70092_e(this.field_75410_c.field_70165_t, this.field_75410_c.func_174813_aQ().field_72338_b, this.field_75410_c.field_70161_v);
      double ☃xx = 0.8;
      if (☃x > ☃ && ☃x < 16.0) {
         ☃xx = 1.33;
      } else if (☃x < 225.0) {
      ...
      this.field_75409_b.func_70661_as().func_75497_a(this.field_75410_c, ☃xx);
