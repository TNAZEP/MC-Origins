...
public class EntityAIAttackRangedBow<T extends EntityMob & IRangedAttackMob> extends EntityAIBase {
   ...
   public void func_75246_d() {
      EntityLivingBase ☃ = this.field_188499_a.func_70638_az();
      if (☃ != null) {
         double ☃x = this.field_188499_a.func_70092_e(☃.field_70165_t, ☃.func_174813_aQ().field_72338_b, ☃.field_70161_v);
         boolean ☃xx = this.field_188499_a.func_70635_at().func_75522_a(☃);
         boolean ☃xxx = this.field_188504_f > 0;
         if (☃xx != ☃xxx) {
            this.field_188504_f = 0;
         }
         ...
         if (!(☃x > (double)this.field_188502_d) && this.field_188504_f >= 20) {
            this.field_188499_a.func_70661_as().func_75499_g();
            ++this.field_188507_i;
         } else {
            this.field_188499_a.func_70661_as().func_75497_a(☃, this.field_188500_b);
         ...
         if (this.field_188507_i > -1) {
            if (☃x > (double)(this.field_188502_d * 0.75F)) {
               this.field_188506_h = false;
            } else if (☃x < (double)(this.field_188502_d * 0.25F)) {
            ...
            this.field_188499_a.func_70625_a(☃, 30.0F, 30.0F);
         } else {
            this.field_188499_a.func_70671_ap().func_75651_a(☃, 30.0F, 30.0F);
         }

         if (this.field_188499_a.func_184587_cr()) {
            if (!☃xx && this.field_188504_f < -60) {
               this.field_188499_a.func_184602_cy();
            } else if (☃xx) {
               int ☃x = this.field_188499_a.func_184612_cw();
               if (☃x >= 20) {
                  this.field_188499_a.func_184602_cy();
                  this.field_188499_a.func_82196_d(☃, ItemBow.func_185059_b(☃x));
