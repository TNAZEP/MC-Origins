...
public class EntityWitherSkull extends EntityFireball {
   ...
   public EntityWitherSkull(World var1) {
      super(EntityType.field_200723_aB, ☃, 0.3125F, 0.3125F);
   }
   ...
   public float func_180428_a(Explosion var1, IBlockReader var2, BlockPos var3, IBlockState var4, IFluidState var5, float var6) {
      return this.func_82342_d() && EntityWither.func_181033_a(☃.func_177230_c()) ? Math.min(0.8F, ☃) : ☃;
   }
      ...
      if (!this.field_70170_p.field_72995_K) {
         if (☃.field_72308_g != null) {
            if (this.field_70235_a != null) {
               if (☃.field_72308_g.func_70097_a(DamageSource.func_76358_a(this.field_70235_a), 8.0F)) {
                  if (☃.field_72308_g.func_70089_S()) {
               ...
               ☃.field_72308_g.func_70097_a(DamageSource.field_76376_m, 5.0F);
            }
            ...
            if (☃.field_72308_g instanceof EntityLivingBase) {
               ...
               if (☃ > 0) {
                  ((EntityLivingBase)☃.field_72308_g).func_195064_c(new PotionEffect(MobEffects.field_82731_v, 20 * ☃, 1));
               }
            }
         }
   ...
   public void func_82343_e(boolean var1) {
      this.field_70180_af.func_187227_b(field_184565_e, ☃);
   }
