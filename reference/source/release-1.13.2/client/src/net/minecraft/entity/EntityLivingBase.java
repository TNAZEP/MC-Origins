...
public abstract class EntityLivingBase extends Entity {
   ...
   public float func_205015_b(float var1) {
      return this.func_205016_b(this.field_205018_bM, this.field_205017_bL, ☃);
   }
   ...
   public void func_70103_a(byte var1) {
      ...
      if (☃ == 2 || ☃ || ☃x || ☃xx) {
         ...
         DamageSource ☃xxx;
         if (☃xx) {
            ☃xxx = DamageSource.field_76370_b;
         } else if (☃x) {
            ☃xxx = DamageSource.field_76369_e;
         } else {
            ☃xxx = DamageSource.field_76377_j;
         }

         SoundEvent ☃xxx = this.func_184601_bQ(☃xxx);
         if (☃xxx != null) {
            this.func_184185_a(☃xxx, this.func_70599_aP(), (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2F + 1.0F);
         }
         ...
         SoundEvent ☃ = this.func_184615_bR();
         if (☃ != null) {
            this.func_184185_a(☃, this.func_70599_aP(), (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2F + 1.0F);
         }
   ...
   public void func_180426_a(double var1, double var3, double var5, float var7, float var8, int var9, boolean var10) {
      this.field_184623_bh = ☃;
      this.field_184624_bi = ☃;
      this.field_184625_bj = ☃;
      this.field_184626_bk = (double)☃;
      this.field_70709_bj = (double)☃;
      this.field_70716_bi = ☃;
   }

   @Override
   public void func_208000_a(float var1, int var2) {
      this.field_208001_bq = (double)☃;
      this.field_208002_br = ☃;
   }
   ...
   public float func_70678_g(float var1) {
      float ☃ = this.field_70733_aJ - this.field_70732_aI;
      if (☃ < 0.0F) {
         ++☃;
      }
