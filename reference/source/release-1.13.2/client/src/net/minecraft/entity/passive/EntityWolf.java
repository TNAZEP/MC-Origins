...
public class EntityWolf extends EntityTameable {
   ...
   public float func_70915_j(float var1) {
      return 0.75F + (this.field_70927_j + (this.field_70929_i - this.field_70927_j) * ☃) / 2.0F * 0.25F;
   }

   public float func_70923_f(float var1, float var2) {
      float ☃ = (this.field_70927_j + (this.field_70929_i - this.field_70927_j) * ☃ + ☃) / 1.8F;
      if (☃ < 0.0F) {
         ☃ = 0.0F;
      } else if (☃ > 1.0F) {
         ☃ = 1.0F;
   ...
   public float func_70917_k(float var1) {
      return (this.field_70924_f + (this.field_70926_e - this.field_70924_f) * ☃) * 0.15F * (float) Math.PI;
   }
