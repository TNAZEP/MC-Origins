...
public class EntityHorse extends AbstractHorse {
   ...
   private void func_110247_cG() {
      int ☃ = this.func_110202_bQ();
      int ☃x = (☃ & 0xFF) % 7;
      int ☃xx = ((☃ & 0xFF00) >> 8) % 5;
      HorseArmorType ☃xxx = this.func_184783_dl();
      this.field_110280_bR[0] = field_110268_bz[☃x];
      this.field_110280_bR[1] = field_110291_bB[☃xx];
      this.field_110280_bR[2] = ☃xxx.func_188574_d();
      this.field_110286_bQ = "horse/" + field_110269_bA[☃x] + field_110292_bC[☃xx] + ☃xxx.func_188573_b();
   }
