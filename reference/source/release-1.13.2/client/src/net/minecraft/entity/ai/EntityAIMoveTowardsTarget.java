   ...
   public boolean func_75250_a() {
      ...
      if (this.field_75429_b == null) {
         ...
         Vec3d ☃ = RandomPositionGenerator.func_75464_a(
            this.field_75431_a, 16, 7, new Vec3d(this.field_75429_b.field_70165_t, this.field_75429_b.field_70163_u, this.field_75429_b.field_70161_v)
         );
         if (☃ == null) {
            return false;
         } else {
            this.field_75430_c = ☃.field_72450_a;
            this.field_75427_d = ☃.field_72448_b;
            this.field_75428_e = ☃.field_72449_c;
            return true;
         }
      }
   }
