...
public class EntityTurtle extends EntityAnimal {
   ...
   public static final Predicate<Entity> field_203029_bx = var0 -> {
   ...
   public EntityTurtle(World var1) {
      super(EntityType.field_203099_aq, ☃);
   ...
   public void func_203011_g(BlockPos var1) {
      this.field_70180_af.func_187227_b(field_203030_by, ☃);
   }
   ...
   private void func_203019_h(BlockPos var1) {
      this.field_70180_af.func_187227_b(field_203025_bC, ☃);
   }
   ...
   private void func_203017_r(boolean var1) {
      this.field_70180_af.func_187227_b(field_203031_bz, ☃);
   }
   ...
   private void func_203015_s(boolean var1) {
      this.field_203028_bF = ☃ ? 1 : 0;
      this.field_70180_af.func_187227_b(field_203024_bB, ☃);
   }
   ...
   private void func_203012_t(boolean var1) {
      this.field_70180_af.func_187227_b(field_203026_bD, ☃);
   }
   ...
   private void func_203021_u(boolean var1) {
      this.field_70180_af.func_187227_b(field_203027_bE, ☃);
   }
   ...
   public void func_70014_b(NBTTagCompound var1) {
      super.func_70014_b(☃);
      ☃.func_74768_a("HomePosX", this.func_203018_dA().func_177958_n());
      ☃.func_74768_a("HomePosY", this.func_203018_dA().func_177956_o());
      ☃.func_74768_a("HomePosZ", this.func_203018_dA().func_177952_p());
      ☃.func_74757_a("HasEgg", this.func_203020_dx());
      ☃.func_74768_a("TravelPosX", this.func_203013_dB().func_177958_n());
      ☃.func_74768_a("TravelPosY", this.func_203013_dB().func_177956_o());
      ☃.func_74768_a("TravelPosZ", this.func_203013_dB().func_177952_p());
   }

   @Override
   public void func_70037_a(NBTTagCompound var1) {
      int ☃ = ☃.func_74762_e("HomePosX");
      int ☃x = ☃.func_74762_e("HomePosY");
      int ☃xx = ☃.func_74762_e("HomePosZ");
      this.func_203011_g(new BlockPos(☃, ☃x, ☃xx));
      super.func_70037_a(☃);
      this.func_203017_r(☃.func_74767_n("HasEgg"));
      int ☃xxx = ☃.func_74762_e("TravelPosX");
      int ☃xxxx = ☃.func_74762_e("TravelPosY");
      int ☃xxxxx = ☃.func_74762_e("TravelPosZ");
      this.func_203019_h(new BlockPos(☃xxx, ☃xxxx, ☃xxxxx));
   }
   ...
   public boolean func_205020_a(IWorld var1, boolean var2) {
      ...
      return ☃.func_177956_o() < ☃.func_181545_F() + 4 && super.func_205020_a(☃, ☃);
   }

   @Override
   protected void func_184651_r() {
      this.field_70714_bg.func_75776_a(0, new EntityTurtle.AIPanic(this, 1.2));
      this.field_70714_bg.func_75776_a(1, new EntityTurtle.AIMate(this, 1.0));
      this.field_70714_bg.func_75776_a(1, new EntityTurtle.AILayEgg(this, 1.0));
      this.field_70714_bg.func_75776_a(2, new EntityTurtle.AIPlayerTempt(this, 1.1, Blocks.field_203198_aQ.func_199767_j()));
      this.field_70714_bg.func_75776_a(3, new EntityTurtle.AIGoToWater(this, 1.0));
      this.field_70714_bg.func_75776_a(4, new EntityTurtle.AIGoHome(this, 1.0));
      this.field_70714_bg.func_75776_a(7, new EntityTurtle.AITravel(this, 1.0));
      this.field_70714_bg.func_75776_a(8, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
      this.field_70714_bg.func_75776_a(9, new EntityTurtle.AIWander(this, 1.0, 100));
   }
   ...
   protected void func_180429_a(BlockPos var1, IBlockState var2) {
      SoundEvent ☃ = this.func_70631_g_() ? SoundEvents.field_203267_iG : SoundEvents.field_203266_iF;
      this.func_184185_a(☃, 0.15F, 1.0F);
   }
   ...
   public void func_98054_a(boolean var1) {
      this.func_98055_j(☃ ? 0.3F : 1.0F);
   }

   @Override
   protected PathNavigate func_175447_b(World var1) {
      return new EntityTurtle.PathNavigater(this, ☃);
   }
   ...
   public boolean func_70877_b(ItemStack var1) {
      return ☃.func_77973_b() == Blocks.field_203198_aQ.func_199767_j();
   }

   @Override
   public float func_205022_a(BlockPos var1, IWorldReaderBase var2) {
      return !this.func_203022_dF() && ☃.func_204610_c(☃).func_206884_a(FluidTags.field_206959_a) ? 10.0F : super.func_205022_a(☃, ☃);
   }
   ...
   public void func_70636_d() {
      ...
      if (this.func_203023_dy() && this.field_203028_bF >= 1 && this.field_203028_bF % 5 == 0) {
         ...
         if (this.field_70170_p.func_180495_p(☃.func_177977_b()).func_177230_c() == Blocks.field_150354_m) {
            this.field_70170_p.func_175718_b(2001, ☃, Block.func_196246_j(Blocks.field_150354_m.func_176223_P()));
         }
      }
   }
   ...
   public void func_70645_a(DamageSource var1) {
      super.func_70645_a(☃);
      if (☃ == DamageSource.field_180137_b) {
   ...
   static class AIGoHome extends EntityAIBase {
      ...
      public void func_75246_d() {
         BlockPos ☃ = this.field_203127_a.func_203018_dA();
         boolean ☃x = this.field_203127_a.func_174818_b(☃) <= 256.0;
         if (☃x) {
            ++this.field_203130_d;
         }

         if (this.field_203127_a.func_70661_as().func_75500_f()) {
            Vec3d ☃ = RandomPositionGenerator.func_203155_a(
               this.field_203127_a, 16, 3, new Vec3d((double)☃.func_177958_n(), (double)☃.func_177956_o(), (double)☃.func_177952_p()), (float) (Math.PI / 10)
            );
            if (☃ == null) {
               ☃ = RandomPositionGenerator.func_75464_a(
                  this.field_203127_a, 8, 7, new Vec3d((double)☃.func_177958_n(), (double)☃.func_177956_o(), (double)☃.func_177952_p())
               );
            }

            if (☃ != null && !☃x && this.field_203127_a.field_70170_p.func_180495_p(new BlockPos(☃)).func_177230_c() != Blocks.field_150355_j) {
               ☃ = RandomPositionGenerator.func_75464_a(
                  this.field_203127_a, 16, 5, new Vec3d((double)☃.func_177958_n(), (double)☃.func_177956_o(), (double)☃.func_177952_p())
               );
            }
   ...
   static class AIGoToWater extends EntityAIMoveToBlock {
      ...
      @Override
      public boolean func_75253_b() {
         return !this.field_203121_f.func_70090_H()
            && this.field_179493_e <= 1200
            && this.func_179488_a(this.field_203121_f.field_70170_p, this.field_179494_b);
      }
      ...
      public boolean func_75250_a() {
         if (this.field_203121_f.func_70631_g_() && !this.field_203121_f.func_70090_H()) {
            ...
            return !this.field_203121_f.func_203022_dF() && !this.field_203121_f.func_70090_H() && !this.field_203121_f.func_203020_dx()
               ? super.func_75250_a()
               : false;
         }
      }
   ...
   static class AILayEgg extends EntityAIMoveToBlock {
      ...
      @Override
      public boolean func_75250_a() {
         return this.field_203122_f.func_203020_dx() && this.field_203122_f.func_174818_b(this.field_203122_f.func_203018_dA()) < 81.0
            ? super.func_75250_a()
            : false;
      }
      ...
      public void func_75246_d() {
         super.func_75246_d();
         BlockPos ☃ = new BlockPos(this.field_203122_f);
         if (!this.field_203122_f.func_70090_H() && this.func_179487_f()) {
            if (this.field_203122_f.field_203028_bF < 1) {
               ...
               World ☃x = this.field_203122_f.field_70170_p;
               ☃x.func_184133_a(null, ☃, SoundEvents.field_203278_iw, SoundCategory.BLOCKS, 0.3F, 0.9F + ☃x.field_73012_v.nextFloat() * 0.2F);
               ☃x.func_180501_a(
                  this.field_179494_b.func_177984_a(),
                  Blocks.field_203213_jA
                     .func_176223_P()
                     .func_206870_a(BlockTurtleEgg.field_203171_b, Integer.valueOf(this.field_203122_f.field_70146_Z.nextInt(4) + 1)),
                  3
               );
   ...
   static class AIMate extends EntityAIMate {
      ...
      protected void func_75388_i() {
         EntityPlayerMP ☃ = this.field_75390_d.func_191993_do();
         if (☃ == null && this.field_75391_e.func_191993_do() != null) {
            ☃ = this.field_75391_e.func_191993_do();
         }

         if (☃ != null) {
            ☃.func_195066_a(StatList.field_151186_x);
            CriteriaTriggers.field_192134_n.func_192168_a(☃, this.field_75390_d, this.field_75391_e, null);
         }

         this.field_203107_f.func_203017_r(true);
         this.field_75390_d.func_70875_t();
         this.field_75391_e.func_70875_t();
         Random ☃ = this.field_75390_d.func_70681_au();
         if (this.field_75394_a.func_82736_K().func_82766_b("doMobLoot")) {
            this.field_75394_a
               .func_72838_d(
                  new EntityXPOrb(
                     this.field_75394_a, this.field_75390_d.field_70165_t, this.field_75390_d.field_70163_u, this.field_75390_d.field_70161_v, ☃.nextInt(7) + 1
                  )
               );
         }
      }
   ...
   static class AIPanic extends EntityAIPanic {
      ...
      public boolean func_75250_a() {
         if (this.field_75267_a.func_70643_av() == null && !this.field_75267_a.func_70027_ad()) {
            ...
            BlockPos ☃ = this.func_188497_a(this.field_75267_a.field_70170_p, this.field_75267_a, 7, 4);
            if (☃ != null) {
   ...
   static class AIPlayerTempt extends EntityAIBase {
      ...
      AIPlayerTempt(EntityTurtle var1, double var2, Item var4) {
         this.field_203132_a = ☃;
         this.field_203133_b = ☃;
         this.field_203136_e = Sets.<Item>newHashSet(☃);
         this.func_75248_a(3);
      }
      ...
      private boolean func_203131_a(ItemStack var1) {
         return this.field_203136_e.contains(☃.func_77973_b());
      }
      ...
      public void func_75246_d() {
         this.field_203132_a
            .func_70671_ap()
            .func_75651_a(this.field_203134_c, (float)(this.field_203132_a.func_184649_cE() + 20), (float)this.field_203132_a.func_70646_bf());
   ...
   static class AITravel extends EntityAIBase {
      ...
      public void func_75249_e() {
         int ☃ = 512;
         int ☃x = 4;
         Random ☃xx = this.field_203137_a.field_70146_Z;
         int ☃xxx = ☃xx.nextInt(1025) - 512;
         int ☃xxxx = ☃xx.nextInt(9) - 4;
         int ☃xxxxx = ☃xx.nextInt(1025) - 512;
         if ((double)☃xxxx + this.field_203137_a.field_70163_u > (double)(this.field_203137_a.field_70170_p.func_181545_F() - 1)) {
            ☃xxxx = 0;
         }

         BlockPos ☃ = new BlockPos(
            (double)☃xxx + this.field_203137_a.field_70165_t,
            (double)☃xxxx + this.field_203137_a.field_70163_u,
            (double)☃xxxxx + this.field_203137_a.field_70161_v
         );
         this.field_203137_a.func_203019_h(☃);
      ...
      public void func_75246_d() {
         if (this.field_203137_a.func_70661_as().func_75500_f()) {
            BlockPos ☃ = this.field_203137_a.func_203013_dB();
            Vec3d ☃x = RandomPositionGenerator.func_203155_a(
               this.field_203137_a, 16, 3, new Vec3d((double)☃.func_177958_n(), (double)☃.func_177956_o(), (double)☃.func_177952_p()), (float) (Math.PI / 10)
            );
            if (☃x == null) {
               ☃x = RandomPositionGenerator.func_75464_a(
                  this.field_203137_a, 8, 7, new Vec3d((double)☃.func_177958_n(), (double)☃.func_177956_o(), (double)☃.func_177952_p())
               );
            }

            if (☃x != null) {
               int ☃ = MathHelper.func_76128_c(☃x.field_72450_a);
               int ☃x = MathHelper.func_76128_c(☃x.field_72449_c);
               int ☃xx = 34;
               MutableBoundingBox ☃xxx = new MutableBoundingBox(☃ - 34, 0, ☃x - 34, ☃ + 34, 0, ☃x + 34);
               if (!this.field_203137_a.field_70170_p.func_175711_a(☃xxx)) {
                  ☃x = null;
               }
            }
            ...
            this.field_203137_a.func_70661_as().func_75492_a(☃x.field_72450_a, ☃x.field_72448_b, ☃x.field_72449_c, this.field_203138_b);
         }
      }

      @Override
      public boolean func_75253_b() {
         return !this.field_203137_a.func_70661_as().func_75500_f()
            && !this.field_203139_c
            && !this.field_203137_a.func_203022_dF()
            && !this.field_203137_a.func_70880_s()
            && !this.field_203137_a.func_203020_dx();
      }
   ...
   static class AIWander extends EntityAIWander {
      ...
      @Override
      public boolean func_75250_a() {
         return !this.field_75457_a.func_70090_H() && !this.field_203123_h.func_203022_dF() && !this.field_203123_h.func_203020_dx()
            ? super.func_75250_a()
            : false;
      }
   }
   ...
   static class MoveHelper extends EntityMoveHelper {
      ...
      public void func_75641_c() {
         ...
         if (this.field_188491_h == EntityMoveHelper.Action.MOVE_TO && !this.field_203103_i.func_70661_as().func_75500_f()) {
            double ☃ = this.field_75646_b - this.field_203103_i.field_70165_t;
            double ☃x = this.field_75647_c - this.field_203103_i.field_70163_u;
            double ☃xx = this.field_75644_d - this.field_203103_i.field_70161_v;
            ...
            this.field_203103_i.field_70177_z = this.func_75639_a(this.field_203103_i.field_70177_z, ☃xxxx, 90.0F);
            this.field_203103_i.field_70761_aq = this.field_203103_i.field_70177_z;
            float ☃xxxxx = (float)(this.field_75645_e * this.field_203103_i.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111126_e());
            this.field_203103_i.func_70659_e(this.field_203103_i.func_70689_ay() + (☃xxxxx - this.field_203103_i.func_70689_ay()) * 0.125F);
            this.field_203103_i.field_70181_x += (double)this.field_203103_i.func_70689_ay() * ☃x * 0.1;
         } else {
   ...
   static class PathNavigater extends PathNavigateSwimmer {
      ...
      public boolean func_188555_b(BlockPos var1) {
         if (this.field_75515_a instanceof EntityTurtle) {
            EntityTurtle ☃ = (EntityTurtle)this.field_75515_a;
            if (☃.func_203014_dG()) {
               return this.field_75513_b.func_180495_p(☃).func_177230_c() == Blocks.field_150355_j;
            }
         }

         return !this.field_75513_b.func_180495_p(☃.func_177977_b()).func_196958_f();
      }
   }
}
