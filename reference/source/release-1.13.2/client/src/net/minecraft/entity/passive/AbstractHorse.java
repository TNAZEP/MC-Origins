...
public abstract class AbstractHorse extends EntityAnimal implements IInventoryChangedListener, IJumpingMount {
   ...
   public float func_110258_o(float var1) {
      return this.field_110284_bK + (this.field_110283_bJ - this.field_110284_bK) * ☃;
   }

   public float func_110223_p(float var1) {
      return this.field_110282_bM + (this.field_110281_bL - this.field_110282_bM) * ☃;
   }

   public float func_110201_q(float var1) {
      return this.field_110288_bO + (this.field_110287_bN - this.field_110288_bO) * ☃;
   }
   ...
   public void func_110206_u(int var1) {
      if (this.func_110257_ck()) {
         ...
         if (☃ >= 90) {
            ...
            this.field_110277_bt = 0.4F + 0.4F * (float)☃ / 90.0F;
         }
      }
   }
   ...
   protected void func_110216_r(boolean var1) {
      IParticleData ☃ = ☃ ? Particles.field_197633_z : Particles.field_197601_L;

      for(int ☃x = 0; ☃x < 7; ++☃x) {
         double ☃xx = this.field_70146_Z.nextGaussian() * 0.02;
         double ☃xxx = this.field_70146_Z.nextGaussian() * 0.02;
         double ☃xxxx = this.field_70146_Z.nextGaussian() * 0.02;
         this.field_70170_p
            .func_195594_a(
               ☃,
               this.field_70165_t + (double)(this.field_70146_Z.nextFloat() * this.field_70130_N * 2.0F) - (double)this.field_70130_N,
