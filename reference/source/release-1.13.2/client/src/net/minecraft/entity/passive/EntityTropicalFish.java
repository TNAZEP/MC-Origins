...
public class EntityTropicalFish extends AbstractGroupFish {
   ...
   public static String func_212324_b(int var0) {
      return "entity.minecraft.tropical_fish.predefined." + ☃;
   }

   public static EnumDyeColor func_212326_d(int var0) {
      return EnumDyeColor.func_196056_a(func_204216_dH(☃));
   }

   public static EnumDyeColor func_212323_p(int var0) {
      return EnumDyeColor.func_196056_a(func_204212_dI(☃));
   }

   public static String func_212327_q(int var0) {
      int ☃ = func_212325_s(☃);
      int ☃x = func_204213_dJ(☃);
      return "entity.minecraft.tropical_fish.type." + EntityTropicalFish.Type.func_212548_a(☃, ☃x);
   }
   ...
   private static int func_204213_dJ(int var0) {
      return Math.min((☃ & 0xFF00) >> 8, 5);
   }

   public ResourceLocation func_204220_dF() {
      return func_212325_s(this.func_204221_dB()) == 0
         ? field_204225_bx[func_204213_dJ(this.func_204221_dB())]
         : field_204226_by[func_204213_dJ(this.func_204221_dB())];
   }
   ...
   static enum Type {
      ...
      public static String func_212548_a(int var0, int var1) {
         return field_212554_o[☃ + 6 * ☃].func_212549_c();
      }
