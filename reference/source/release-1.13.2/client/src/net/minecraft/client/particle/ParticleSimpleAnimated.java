...
public class ParticleSimpleAnimated extends Particle {
   ...
   public void func_187146_c(int var1) {
      float ☃ = (float)((☃ & 0xFF0000) >> 16) / 255.0F;
      float ☃x = (float)((☃ & 0xFF00) >> 8) / 255.0F;
      float ☃xx = (float)((☃ & 0xFF) >> 0) / 255.0F;
      float ☃xxx = 1.0F;
      this.func_70538_b(☃ * 1.0F, ☃x * 1.0F, ☃xx * 1.0F);
   }

   public void func_187145_d(int var1) {
      this.field_187150_I = (float)((☃ & 0xFF0000) >> 16) / 255.0F;
      this.field_187151_J = (float)((☃ & 0xFF00) >> 8) / 255.0F;
      this.field_187152_K = (float)((☃ & 0xFF) >> 0) / 255.0F;
