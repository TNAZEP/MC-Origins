...
public class TutorialToast implements IToast {
   ...
   public TutorialToast(TutorialToast.Icons var1, ITextComponent var2, @Nullable ITextComponent var3, boolean var4) {
      this.field_193671_c = ☃;
      this.field_193672_d = ☃.func_150254_d();
      this.field_193673_e = ☃ == null ? null : ☃.func_150254_d();
      this.field_193678_j = ☃;
   }
   ...
   public IToast.Visibility func_193653_a(GuiToast var1, long var2) {
      ...
      ☃.func_73729_b(0, 0, 0, 96, 160, 32);
      this.field_193671_c.func_193697_a(☃, 6, 6);
      if (this.field_193673_e == null) {
         ☃.func_192989_b().field_71466_p.func_211126_b(this.field_193672_d, 30.0F, 12.0F, -11534256);
      } else {
         ☃.func_192989_b().field_71466_p.func_211126_b(this.field_193672_d, 30.0F, 7.0F, -11534256);
         ☃.func_192989_b().field_71466_p.func_211126_b(this.field_193673_e, 30.0F, 18.0F, -16777216);
      }

      if (this.field_193678_j) {
         Gui.func_73734_a(3, 28, 157, 29, -1);
         float ☃x = (float)MathHelper.func_151238_b(
            (double)this.field_193676_h, (double)this.field_193677_i, (double)((float)(☃ - this.field_193675_g) / 100.0F)
         );
         int ☃;
         ...
         Gui.func_73734_a(3, 28, (int)(3.0F + 154.0F * ☃x), 29, ☃);
         this.field_193676_h = ☃x;
         this.field_193675_g = ☃;
      }
   ...
   public static enum Icons {
      ...
      public void func_193697_a(Gui var1, int var2, int var3) {
         ...
         ☃.func_73729_b(☃, ☃, 176 + this.field_193703_f * 20, this.field_193704_g * 20, 20, 20);
         GlStateManager.func_179147_l();
      }
   }
}
