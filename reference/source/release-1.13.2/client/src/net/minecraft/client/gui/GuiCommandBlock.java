...
public class GuiCommandBlock extends GuiCommandBlockBase {
   ...
   protected void func_73866_w_() {
      super.func_73866_w_();
      this.field_184079_s = this.func_189646_b(
         new GuiButton(5, this.field_146294_l / 2 - 50 - 100 - 4, 165, 100, 20, I18n.func_135052_a("advMode.mode.sequence")) {
            @Override
      ...
      this.field_184081_u = this.func_189646_b(
         new GuiButton(7, this.field_146294_l / 2 + 50 + 4, 165, 100, 20, I18n.func_135052_a("advMode.mode.redstoneTriggered")) {
            @Override
            public void func_194829_a(double var1, double var3) {
   ...
   public void func_184075_a() {
      CommandBlockBaseLogic ☃ = this.field_184078_g.func_145993_a();
      this.field_195237_a.func_146180_a(☃.func_145753_i());
      this.field_195238_s = ☃.func_175571_m();
   ...
   protected void func_195235_a(CommandBlockBaseLogic var1) {
      this.field_146297_k
         .func_147114_u()
         .func_147297_a(
            new CPacketUpdateCommandBlock(
               new BlockPos(☃.func_210165_f()),
               this.field_195237_a.func_146179_b(),
               this.field_184082_w,
               ☃.func_175571_m(),
               this.field_184084_y,
               this.field_184085_z
