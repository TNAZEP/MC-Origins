...
public class DebugRenderer {
   ...
   public DebugRenderer(Minecraft var1) {
      this.field_188286_a = new DebugRendererPathfinding(☃);
      this.field_188287_b = new DebugRendererWater(☃);
      this.field_190077_c = new DebugRendererChunkBorder(☃);
      this.field_190078_d = new DebugRendererHeightMap(☃);
      this.field_191325_e = new DebugRendererCollisionBox(☃);
      this.field_191557_f = new DebugRendererNeighborsUpdate(☃);
      this.field_201747_g = new DebugRendererCave(☃);
      this.field_201748_h = new DebugRendererStructure(☃);
      this.field_201749_i = new DebugRendererLight(☃);
      this.field_201750_j = new DebugRendererWorldGenAttempts(☃);
      this.field_193852_g = new DebugRendererSolidFace(☃);
   }
   ...
   public void func_190073_a(float var1, long var2) {
      if (this.field_190080_f) {
         this.field_188286_a.func_190060_a(☃, ☃);
      }

      if (this.field_190079_e && !Minecraft.func_71410_x().func_189648_am()) {
         this.field_190077_c.func_190060_a(☃, ☃);
      }

      if (this.field_190081_g) {
         this.field_188287_b.func_190060_a(☃, ☃);
      }

      if (this.field_190082_h) {
         this.field_190078_d.func_190060_a(☃, ☃);
      }

      if (this.field_191326_j) {
         this.field_191325_e.func_190060_a(☃, ☃);
      }

      if (this.field_191558_l) {
         this.field_191557_f.func_190060_a(☃, ☃);
      }

      if (this.field_201751_r) {
         this.field_201747_g.func_190060_a(☃, ☃);
      }

      if (this.field_201752_s) {
         this.field_201748_h.func_190060_a(☃, ☃);
      }

      if (this.field_201753_t) {
         this.field_201749_i.func_190060_a(☃, ☃);
      }

      if (this.field_201754_u) {
         this.field_201750_j.func_190060_a(☃, ☃);
      }

      if (this.field_193853_n) {
         this.field_193852_g.func_190060_a(☃, ☃);
      }
   }

   public static void func_191556_a(String var0, int var1, int var2, int var3, float var4, int var5) {
      func_190076_a(☃, (double)☃ + 0.5, (double)☃ + 0.5, (double)☃ + 0.5, ☃, ☃);
   }
   ...
   public static void func_190076_a(String var0, double var1, double var3, double var5, float var7, int var8) {
      ...
      if (☃.field_71439_g != null && ☃.func_175598_ae() != null && ☃.func_175598_ae().field_78733_k != null) {
         FontRenderer ☃x = ☃.field_71466_p;
         EntityPlayer ☃xx = ☃.field_71439_g;
         double ☃xxx = ☃xx.field_70142_S + (☃xx.field_70165_t - ☃xx.field_70142_S) * (double)☃;
         double ☃xxxx = ☃xx.field_70137_T + (☃xx.field_70163_u - ☃xx.field_70137_T) * (double)☃;
         double ☃xxxxx = ☃xx.field_70136_U + (☃xx.field_70161_v - ☃xx.field_70136_U) * (double)☃;
         GlStateManager.func_179094_E();
         GlStateManager.func_179109_b((float)(☃ - ☃xxx), (float)(☃ - ☃xxxx) + 0.07F, (float)(☃ - ☃xxxxx));
         GlStateManager.func_187432_a(0.0F, 1.0F, 0.0F);
         GlStateManager.func_179152_a(0.02F, -0.02F, 0.02F);
         RenderManager ☃xxxxxx = ☃.func_175598_ae();
         GlStateManager.func_179114_b(-☃xxxxxx.field_78735_i, 0.0F, 1.0F, 0.0F);
         GlStateManager.func_179114_b((float)(☃xxxxxx.field_78733_k.field_74320_O == 2 ? 1 : -1) * ☃xxxxxx.field_78732_j, 1.0F, 0.0F, 0.0F);
         GlStateManager.func_179140_f();
         GlStateManager.func_179098_w();
         GlStateManager.func_179126_j();
         GlStateManager.func_179132_a(true);
         GlStateManager.func_179152_a(-1.0F, 1.0F, 1.0F);
         ☃x.func_211126_b(☃, (float)(-☃x.func_78256_a(☃) / 2), 0.0F, ☃);
