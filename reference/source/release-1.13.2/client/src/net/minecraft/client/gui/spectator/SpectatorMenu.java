...
public class SpectatorMenu {
   ...
   public ISpectatorMenuObject func_178643_a(int var1) {
      int ☃ = ☃ + this.field_178658_j * 6;
      if (this.field_178658_j > 0 && ☃ == 0) {
         return field_178656_c;
      } else if (☃ == 7) {
         return ☃ < this.field_178659_h.func_178669_a().size() ? field_178653_d : field_178654_e;
      } else if (☃ == 8) {
         return field_178655_b;
      } else {
         return ☃ >= 0 && ☃ < this.field_178659_h.func_178669_a().size()
            ? MoreObjects.firstNonNull((ISpectatorMenuObject)this.field_178659_h.func_178669_a().get(☃), field_178657_a)
            : field_178657_a;
      }
   }

   public List<ISpectatorMenuObject> func_178642_a() {
      List<ISpectatorMenuObject> ☃ = Lists.<ISpectatorMenuObject>newArrayList();

      for(int ☃x = 0; ☃x <= 8; ++☃x) {
         ☃.add(this.func_178643_a(☃x));
      }
   ...
   public void func_178644_b(int var1) {
      ISpectatorMenuObject ☃ = this.func_178643_a(☃);
      if (☃ != field_178657_a) {
         if (this.field_178660_i == ☃ && ☃.func_178662_A_()) {
            ☃.func_178661_a(this);
         } else {
            this.field_178660_i = ☃;
         }
   ...
   static class MoveMenuObject implements ISpectatorMenuObject {
      ...
      @Override
      public void func_178661_a(SpectatorMenu var1) {
         ☃.field_178658_j = ☃.field_178658_j + this.field_178666_a;
      }

      @Override
      public ITextComponent func_178664_z_() {
         return this.field_178666_a < 0 ? new TextComponentTranslation("spectatorMenu.previous_page") : new TextComponentTranslation("spectatorMenu.next_page");
      }
