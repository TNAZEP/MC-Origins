...
public class GuiSleepMP extends GuiChat {
   ...
   private void func_146418_g() {
      NetHandlerPlayClient ☃ = this.field_146297_k.field_71439_g.field_71174_a;
      ☃.func_147297_a(new CPacketEntityAction(this.field_146297_k.field_71439_g, CPacketEntityAction.Action.STOP_SLEEPING));
   }
}
