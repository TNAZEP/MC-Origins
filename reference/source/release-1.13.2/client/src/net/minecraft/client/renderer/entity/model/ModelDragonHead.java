...
public class ModelDragonHead extends ModelBase {
   ...
   public void func_78088_a(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.field_187071_b.field_78795_f = (float)(Math.sin((double)(☃ * (float) Math.PI * 0.2F)) + 1.0) * 0.2F;
      this.field_187070_a.field_78796_g = ☃ * (float) (Math.PI / 180.0);
      this.field_187070_a.field_78795_f = ☃ * (float) (Math.PI / 180.0);
      GlStateManager.func_179109_b(0.0F, -0.374375F, 0.0F);
      GlStateManager.func_179152_a(0.75F, 0.75F, 0.75F);
      this.field_187070_a.func_78785_a(☃);
   }
}
