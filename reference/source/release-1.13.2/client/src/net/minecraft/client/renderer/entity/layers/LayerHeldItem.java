...
public class LayerHeldItem implements LayerRenderer<EntityLivingBase> {
   ...
   public void func_177141_a(EntityLivingBase var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      ...
      if (!☃x.func_190926_b() || !☃xx.func_190926_b()) {
         ...
         this.func_188358_a(☃, ☃xx, ItemCameraTransforms.TransformType.THIRD_PERSON_RIGHT_HAND, EnumHandSide.RIGHT);
         this.func_188358_a(☃, ☃x, ItemCameraTransforms.TransformType.THIRD_PERSON_LEFT_HAND, EnumHandSide.LEFT);
   ...
   private void func_188358_a(EntityLivingBase var1, ItemStack var2, ItemCameraTransforms.TransformType var3, EnumHandSide var4) {
      if (!☃.func_190926_b()) {
         ...
         GlStateManager.func_179109_b((float)(☃ ? -1 : 1) / 16.0F, 0.125F, -0.625F);
         Minecraft.func_71410_x().func_175597_ag().func_187462_a(☃, ☃, ☃, ☃);
         GlStateManager.func_179121_F();
      }
   }

   protected void func_191361_a(EnumHandSide var1) {
      ((ModelBiped)this.field_177206_a.func_177087_b()).func_187073_a(0.0625F, ☃);
   }
