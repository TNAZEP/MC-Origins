...
public class ModelBed extends ModelBase {
   ...
   public ModelBed() {
      ...
      this.field_193774_c[0].field_78795_f = (float) (Math.PI / 2);
      this.field_193774_c[1].field_78795_f = (float) (Math.PI / 2);
      this.field_193774_c[2].field_78795_f = (float) (Math.PI / 2);
      this.field_193774_c[3].field_78795_f = (float) (Math.PI / 2);
      this.field_193774_c[0].field_78808_h = 0.0F;
      this.field_193774_c[1].field_78808_h = (float) (Math.PI / 2);
      this.field_193774_c[2].field_78808_h = (float) (Math.PI * 3.0 / 2.0);
      this.field_193774_c[3].field_78808_h = (float) Math.PI;
   }
   ...
   public void func_193769_a(boolean var1) {
      this.field_193772_a.field_78806_j = ☃;
      this.field_193773_b.field_78806_j = !☃;
      this.field_193774_c[0].field_78806_j = !☃;
      this.field_193774_c[1].field_78806_j = ☃;
      this.field_193774_c[2].field_78806_j = !☃;
      this.field_193774_c[3].field_78806_j = ☃;
   }
}
