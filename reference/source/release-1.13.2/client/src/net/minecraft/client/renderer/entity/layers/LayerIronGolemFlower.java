   ...
   public void func_177141_a(EntityIronGolem var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      if (☃.func_70853_p() != 0) {
         ...
         GlStateManager.func_179114_b(
            5.0F + 180.0F * ((ModelIronGolem)this.field_177154_a.func_177087_b()).func_205071_a().field_78795_f / (float) Math.PI, 1.0F, 0.0F, 0.0F
         );
         ...
         int ☃xxx = ☃xx % 65536;
         int ☃xxxx = ☃xx / 65536;
         OpenGlHelper.func_77475_a(OpenGlHelper.field_77476_b, (float)☃xxx, (float)☃xxxx);
         GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
         this.field_177154_a.func_110776_a(TextureMap.field_110575_b);
         ☃.func_175016_a(Blocks.field_196606_bd.func_176223_P(), 1.0F);
