...
public class GuiWorldSelection extends GuiScreen {
   ...
   public boolean mouseScrolled(double var1) {
      return this.field_184866_u.mouseScrolled(☃);
   }
   ...
   protected void func_73866_w_() {
      ...
      this.field_212352_g.func_195609_a((var1, var2) -> this.field_184866_u.func_212330_a(() -> var2, false));
      this.field_184866_u = new GuiListWorldSelection(
         this,
         this.field_146297_k,
         this.field_146294_l,
         this.field_146295_m,
         48,
         this.field_146295_m - 64,
         36,
         () -> this.field_212352_g.func_146179_b(),
         this.field_184866_u
      );
      this.field_146641_z = this.func_189646_b(
         new GuiButton(1, this.field_146294_l / 2 - 154, this.field_146295_m - 52, 150, 20, I18n.func_135052_a("selectWorld.select")) {
            @Override
            public void func_194829_a(double var1, double var3) {
               GuiListWorldSelectionEntry ☃ = GuiWorldSelection.this.field_184866_u.func_186794_f();
               if (☃ != null) {
                  ☃.func_186774_a();
               }
            }
      ...
      this.field_146630_A = this.func_189646_b(
         new GuiButton(4, this.field_146294_l / 2 - 154, this.field_146295_m - 28, 72, 20, I18n.func_135052_a("selectWorld.edit")) {
            @Override
            public void func_194829_a(double var1, double var3) {
               GuiListWorldSelectionEntry ☃ = GuiWorldSelection.this.field_184866_u.func_186794_f();
               if (☃ != null) {
      ...
      this.field_146642_y = this.func_189646_b(
         new GuiButton(2, this.field_146294_l / 2 - 76, this.field_146295_m - 28, 72, 20, I18n.func_135052_a("selectWorld.delete")) {
            @Override
            public void func_194829_a(double var1, double var3) {
               GuiListWorldSelectionEntry ☃ = GuiWorldSelection.this.field_184866_u.func_186794_f();
               if (☃ != null) {
      ...
      this.field_184865_t = this.func_189646_b(
         new GuiButton(5, this.field_146294_l / 2 + 4, this.field_146295_m - 28, 72, 20, I18n.func_135052_a("selectWorld.recreate")) {
            @Override
            public void func_194829_a(double var1, double var3) {
               GuiListWorldSelectionEntry ☃ = GuiWorldSelection.this.field_184866_u.func_186794_f();
               if (☃ != null) {
   ...
   public void func_184863_a(@Nullable GuiListWorldSelectionEntry var1) {
      boolean ☃ = ☃ != null;
      this.field_146641_z.field_146124_l = ☃;
      this.field_146642_y.field_146124_l = ☃;
      this.field_146630_A.field_146124_l = ☃;
      this.field_184865_t.field_146124_l = ☃;
   }
