...
public class CraftPlanksStep implements ITutorialStep {
   ...
   public void func_193245_a() {
      ...
      if (this.field_193288_c.func_194072_f() != GameType.SURVIVAL) {
         ...
         if (this.field_193290_e == 1) {
            EntityPlayerSP ☃ = this.field_193288_c.func_193295_e().field_71439_g;
            if (☃ != null) {
               if (☃.field_71071_by.func_199712_a(ItemTags.field_199905_b)) {
                  this.field_193288_c.func_193292_a(TutorialSteps.NONE);
                  return;
               }

               if (func_199761_a(☃, ItemTags.field_199905_b)) {
                  this.field_193288_c.func_193292_a(TutorialSteps.NONE);
                  return;
               }
            }
   ...
   public void func_193252_a(ItemStack var1) {
      Item ☃ = ☃.func_77973_b();
      if (ItemTags.field_199905_b.func_199685_a_(☃)) {
         this.field_193288_c.func_193292_a(TutorialSteps.NONE);
      }
   }
   ...
   public static boolean func_199761_a(EntityPlayerSP var0, Tag<Item> var1) {
      for(Item ☃ : ☃.func_199885_a()) {
         if (☃.func_146107_m().func_77444_a(StatList.field_188066_af.func_199076_b(☃)) > 0) {
            return true;
         }
      }
