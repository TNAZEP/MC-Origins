...
public abstract class ChunkRenderContainer {
   ...
   public void func_178003_a(RenderChunk var1) {
      BlockPos ☃ = ☃.func_178568_j();
      GlStateManager.func_179109_b(
         (float)((double)☃.func_177958_n() - this.field_178008_c),
         (float)((double)☃.func_177956_o() - this.field_178005_d),
         (float)((double)☃.func_177952_p() - this.field_178006_e)
      );
   }

   public void func_178002_a(RenderChunk var1, BlockRenderLayer var2) {
      this.field_178009_a.add(☃);
   }
