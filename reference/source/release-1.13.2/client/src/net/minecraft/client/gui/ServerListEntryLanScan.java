...
public class ServerListEntryLanScan extends ServerSelectionList.Entry {
   ...
   public void func_194999_a(int var1, int var2, int var3, int var4, boolean var5, float var6) {
      int ☃x = this.func_195001_c() + ☃ / 2 - this.field_148288_a.field_71466_p.field_78288_b / 2;
      this.field_148288_a
         .field_71466_p
         .func_211126_b(
      ...
      this.field_148288_a
         ...
         .func_211126_b(
            ☃,
            (float)(this.field_148288_a.field_71462_r.field_146294_l / 2 - this.field_148288_a.field_71466_p.func_78256_a(☃) / 2),
            (float)(☃x + this.field_148288_a.field_71466_p.field_78288_b),
            8421504
         );
   }
}
