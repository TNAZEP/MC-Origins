...
public class RenderHorseUndead extends RenderAbstractHorse<EntityHorse> {
   private static final Map<Class<?>, ResourceLocation> field_195638_a = Maps.newHashMap(
      ImmutableMap.of(
   ...
   public RenderHorseUndead(RenderManager var1) {
      super(☃, new ModelHorseArmorBase(), 1.0F);
   }

   protected ResourceLocation func_110775_a(AbstractHorse var1) {
      return (ResourceLocation)field_195638_a.get(☃.getClass());
   }
}
