...
public class ModelPufferFishSmall extends ModelBase {
   ...
   public void func_78088_a(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.func_78087_a(☃, ☃, ☃, ☃, ☃, ☃, ☃);
      this.field_203754_a.func_78785_a(☃);
      this.field_203755_b.func_78785_a(☃);
      this.field_203756_c.func_78785_a(☃);
      this.field_203759_f.func_78785_a(☃);
      this.field_203757_d.func_78785_a(☃);
      this.field_203758_e.func_78785_a(☃);
   }

   @Override
   public void func_78087_a(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      this.field_203757_d.field_78808_h = -0.2F + 0.4F * MathHelper.func_76126_a(☃ * 0.2F);
      this.field_203758_e.field_78808_h = 0.2F - 0.4F * MathHelper.func_76126_a(☃ * 0.2F);
   }
}
