...
public class PlayerMenuObject implements ISpectatorMenuObject {
   ...
   public PlayerMenuObject(GameProfile var1) {
      ...
      Map<Type, MinecraftProfileTexture> ☃x = ☃.func_152342_ad().func_152788_a(☃);
      if (☃x.containsKey(Type.SKIN)) {
         this.field_178667_b = ☃.func_152342_ad().func_152792_a((MinecraftProfileTexture)☃x.get(Type.SKIN), Type.SKIN);
      } else {
         this.field_178667_b = DefaultPlayerSkin.func_177334_a(EntityPlayer.func_146094_a(☃));
      }
   }
   ...
   public void func_178663_a(float var1, int var2) {
      ...
      GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, (float)☃ / 255.0F);
