...
public class ModelPhantom extends ModelBase {
   ...
   public void func_78088_a(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.field_203070_a.func_78785_a(☃);
   }

   @Override
   public void func_78087_a(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      float ☃ = ((float)(☃.func_145782_y() * 3) + ☃) * 0.13F;
      float ☃x = 16.0F;
      this.field_203071_b.field_78808_h = (0.0F + MathHelper.func_76134_b(☃) * 16.0F) * (float) (Math.PI / 180.0);
      this.field_203072_c.field_78808_h = (0.0F + MathHelper.func_76134_b(☃) * 16.0F) * (float) (Math.PI / 180.0);
      ...
      this.field_204233_g.field_78795_f = -(5.0F + MathHelper.func_76134_b(☃ * 2.0F) * 5.0F) * (float) (Math.PI / 180.0);
      this.field_204234_h.field_78795_f = -(5.0F + MathHelper.func_76134_b(☃ * 2.0F) * 5.0F) * (float) (Math.PI / 180.0);
   }
}
