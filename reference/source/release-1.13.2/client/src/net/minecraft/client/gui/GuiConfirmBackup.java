...
public class GuiConfirmBackup extends GuiScreen {
   ...
   protected void func_73866_w_() {
      ...
      this.func_189646_b(
         new GuiOptionButton(0, this.field_146294_l / 2 - 155, 100 + (this.field_212112_u.size() + 1) * this.field_146289_q.field_78288_b, this.field_212114_g) {
            @Override
      ...
      this.func_189646_b(
         new GuiOptionButton(
            1, this.field_146294_l / 2 - 155 + 160, 100 + (this.field_212112_u.size() + 1) * this.field_146289_q.field_78288_b, this.field_212115_h
         ) {
            @Override
            public void func_194829_a(double var1, double var3) {
      ...
      this.func_189646_b(
         new GuiButton(
            1, this.field_146294_l / 2 - 155 + 80, 124 + (this.field_212112_u.size() + 1) * this.field_146289_q.field_78288_b, 150, 20, this.field_212116_i
         ) {
            @Override
            public void func_194829_a(double var1, double var3) {
   ...
   public void func_73863_a(int var1, int var2, float var3) {
      ...
      for(String ☃x : this.field_212112_u) {
