...
public class NetworkPlayerInfo {
   ...
   public NetworkPlayerInfo(SPacketPlayerListItem.AddPlayerData var1) {
      this.field_178867_a = ☃.func_179962_a();
      this.field_178866_b = ☃.func_179960_c();
      this.field_78829_b = ☃.func_179963_b();
      this.field_178872_h = ☃.func_179961_d();
   }
   ...
   public ResourceLocation func_178837_g() {
      this.func_178841_j();
      return MoreObjects.firstNonNull((ResourceLocation)this.field_187107_a.get(Type.SKIN), DefaultPlayerSkin.func_177334_a(this.field_178867_a.getId()));
   }
