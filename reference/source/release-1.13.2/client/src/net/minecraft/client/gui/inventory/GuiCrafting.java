...
public class GuiCrafting extends GuiContainer implements IRecipeShownListener {
   ...
   protected void func_73866_w_() {
      ...
      this.field_192050_x
         .func_201520_a(this.field_146294_l, this.field_146295_m, this.field_146297_k, this.field_193112_y, (ContainerRecipeBook)this.field_147002_h);
      ...
      this.func_189646_b(
         new GuiButtonImage(10, this.field_147003_i + 5, this.field_146295_m / 2 - 49, 20, 18, 0, 0, 19, field_201559_w) {
            @Override
            public void func_194829_a(double var1, double var3) {
               ...
               GuiCrafting.this.field_147003_i = GuiCrafting.this.field_192050_x
                  .func_193011_a(GuiCrafting.this.field_193112_y, GuiCrafting.this.field_146294_l, GuiCrafting.this.field_146999_f);
   ...
   public void func_73863_a(int var1, int var2, float var3) {
      ...
      if (this.field_192050_x.func_191878_b() && this.field_193112_y) {
         this.func_146976_a(☃, ☃, ☃);
         this.field_192050_x.func_191861_a(☃, ☃, ☃);
      } else {
         this.field_192050_x.func_191861_a(☃, ☃, ☃);
         super.func_73863_a(☃, ☃, ☃);
         this.field_192050_x.func_191864_a(this.field_147003_i, this.field_147009_r, true, ☃);
      }

      this.func_191948_b(☃, ☃);
      this.field_192050_x.func_191876_c(this.field_147003_i, this.field_147009_r, ☃, ☃);
   }
   ...
   protected boolean func_195359_a(int var1, int var2, int var3, int var4, double var5, double var7) {
      return (!this.field_193112_y || !this.field_192050_x.func_191878_b()) && super.func_195359_a(☃, ☃, ☃, ☃, ☃, ☃);
   }

   @Override
   public boolean mouseClicked(double var1, double var3, int var5) {
      if (this.field_192050_x.mouseClicked(☃, ☃, ☃)) {
         return true;
      } else {
         return this.field_193112_y && this.field_192050_x.func_191878_b() ? true : super.mouseClicked(☃, ☃, ☃);
      }
   }
   ...
   protected boolean func_195361_a(double var1, double var3, int var5, int var6, int var7) {
      ...
      return this.field_192050_x.func_195604_a(☃, ☃, this.field_147003_i, this.field_147009_r, this.field_146999_f, this.field_147000_g, ☃) && ☃;
   }

   @Override
   protected void func_184098_a(Slot var1, int var2, int var3, ClickType var4) {
      super.func_184098_a(☃, ☃, ☃, ☃);
      this.field_192050_x.func_191874_a(☃);
   }
