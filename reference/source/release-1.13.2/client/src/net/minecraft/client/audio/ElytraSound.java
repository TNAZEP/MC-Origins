   ...
   public void func_73660_a() {
      ...
      if (!this.field_189405_m.field_70128_L && (this.field_189406_n <= 20 || this.field_189405_m.func_184613_cA())) {
         ...
         float ☃ = MathHelper.func_76133_a(
            this.field_189405_m.field_70159_w * this.field_189405_m.field_70159_w
               + this.field_189405_m.field_70179_y * this.field_189405_m.field_70179_y
               + this.field_189405_m.field_70181_x * this.field_189405_m.field_70181_x
         );
         float ☃x = ☃ / 2.0F;
         if ((double)☃ >= 0.01) {
            this.field_147662_b = MathHelper.func_76131_a(☃x * ☃x, 0.0F, 1.0F);
         } else {
         ...
         if (this.field_189406_n < 20) {
            ...
            this.field_147662_b = (float)((double)this.field_147662_b * ((double)(this.field_189406_n - 20) / 20.0));
         }
