...
public class MusicTicker implements ITickable {
   ...
   public void func_73660_a() {
      MusicTicker.MusicType ☃ = this.field_147677_b.func_147109_W();
      if (this.field_147678_c != null) {
         if (!☃.func_188768_a().func_187503_a().equals(this.field_147678_c.func_147650_b())) {
            this.field_147677_b.func_147118_V().func_147683_b(this.field_147678_c);
            this.field_147676_d = MathHelper.func_76136_a(this.field_147679_a, 0, ☃.func_148634_b() / 2);
         ...
         if (!this.field_209508_e && !this.field_147677_b.func_147118_V().func_147692_c(this.field_147678_c)) {
            ...
            this.field_147676_d = Math.min(MathHelper.func_76136_a(this.field_147679_a, ☃.func_148634_b(), ☃.func_148633_c()), this.field_147676_d);
         } else if (this.field_147677_b.func_147118_V().func_147692_c(this.field_147678_c)) {
            this.field_209508_e = false;
         }
      }

      this.field_147676_d = Math.min(this.field_147676_d, ☃.func_148633_c());
   ...
   public void func_181558_a(MusicTicker.MusicType var1) {
      this.field_147678_c = SimpleSound.func_184370_a(☃.func_188768_a());
   ...
   public boolean func_209100_b(MusicTicker.MusicType var1) {
      return this.field_147678_c == null ? false : ☃.func_188768_a().func_187503_a().equals(this.field_147678_c.func_147650_b());
   }
