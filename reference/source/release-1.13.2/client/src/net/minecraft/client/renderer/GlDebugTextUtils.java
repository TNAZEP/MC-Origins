...
public class GlDebugTextUtils {
   ...
   private static String func_209245_c(int var0) {
      return "Unknown (0x" + Integer.toHexString(☃).toUpperCase() + ")";
   }
   ...
   private static void func_209244_a(int var0, int var1, int var2, int var3, int var4, long var5, long var7) {
      field_209253_d.info(
         ...
         func_209248_e(☃),
         func_209246_f(☃),
         GLDebugMessageCallback.getMessage(☃, ☃)
      );
   }

   private static void func_209243_a(int var0, String var1) {
      field_209256_g.merge(☃, ☃, (var0x, var1x) -> var0x + "/" + var1x);
   }
   ...
   public static void func_209247_b(int var0) {
      if (☃ > 0) {
         ...
         if (☃.GL_KHR_debug) {
            ...
            for(int ☃x = 0; ☃x < field_209257_h.size(); ++☃x) {
               boolean ☃xx = ☃x < ☃;
               KHRDebug.glDebugMessageControl(4352, 4352, field_209257_h.get(☃x), (int[])null, ☃xx);
            }

            KHRDebug.glDebugMessageCallback(
               Util.func_200696_a(GLDebugMessageCallback.create(GlDebugTextUtils::func_209244_a), LWJGLMemoryUntracker::func_211545_a), 0L
            );
         } else if (☃.GL_ARB_debug_output) {
            for(int ☃ = 0; ☃ < field_209258_i.size(); ++☃) {
               boolean ☃x = ☃ < ☃;
               ARBDebugOutput.glDebugMessageControlARB(4352, 4352, field_209258_i.get(☃), (int[])null, ☃x);
            }

            ARBDebugOutput.glDebugMessageCallbackARB(
               Util.func_200696_a(GLDebugMessageARBCallback.create(GlDebugTextUtils::func_209244_a), LWJGLMemoryUntracker::func_211545_a), 0L
            );
         }
      }
   }
