...
public class GuiCreateWorld extends GuiScreen {
   ...
   protected void func_73866_w_() {
      ...
      this.field_195355_B = this.func_189646_b(
         new GuiButton(0, this.field_146294_l / 2 - 155, this.field_146295_m - 28, 150, 20, I18n.func_135052_a("selectWorld.create")) {
            @Override
      ...
      this.field_146324_A = this.func_189646_b(
         new GuiButton(3, this.field_146294_l / 2 - 75, 187, 150, 20, I18n.func_135052_a("selectWorld.moreWorldOptions")) {
            @Override
            public void func_194829_a(double var1, double var3) {
   ...
   private void func_146314_g() {
      ...
      for(char ☃ : SharedConstants.field_71567_b) {
   ...
   public static String func_146317_a(ISaveFormat var0, String var1) {
      ...
      for(String ☃ : field_146327_L) {
         if (☃.equalsIgnoreCase(☃)) {
            ☃ = "_" + ☃ + "_";
         }
      }

      while(☃.func_75803_c(☃) != null) {
         ☃ = ☃ + "-";
      }
   ...
   private void func_195352_j() {
      ...
      if (!this.field_146345_x) {
         ...
         String ☃x = this.field_146335_h.func_146179_b();
         ...
         WorldSettings ☃ = new WorldSettings(
            ☃, GameType.func_77142_a(this.field_146342_r), this.field_146341_s, this.field_146337_w, WorldType.field_77139_a[this.field_146331_K]
         );
         ☃.func_205390_a(Dynamic.convert(NBTDynamicOps.field_210820_a, JsonOps.INSTANCE, this.field_146334_a));
         if (this.field_146338_v && !this.field_146337_w) {
            ☃.func_77159_a();
         }
         ...
         this.field_146297_k.func_71371_a(this.field_146336_i, this.field_146333_g.func_146179_b().trim(), ☃);
      }
   }

   private boolean func_175299_g() {
      WorldType ☃ = WorldType.field_77139_a[this.field_146331_K];
      if (☃ == null || !☃.func_77126_d()) {
         return false;
      } else {
         return ☃ == WorldType.field_180272_g ? func_146272_n() : true;
      }
   }
   ...
   public boolean keyPressed(int var1, int var2, int var3) {
      if (this.field_146333_g.func_146206_l() && !this.field_146344_y) {
         this.field_146333_g.keyPressed(☃, ☃, ☃);
         this.field_146330_J = this.field_146333_g.func_146179_b();
         this.field_195355_B.field_146124_l = !this.field_146333_g.func_146179_b().isEmpty();
         this.func_146314_g();
      } else if (this.field_146335_h.func_146206_l() && this.field_146344_y) {
         this.field_146335_h.keyPressed(☃, ☃, ☃);
         this.field_146329_I = this.field_146335_h.func_146179_b();
      }

      if (this.field_195355_B.field_146124_l && (☃ == 257 || ☃ == 335)) {
         this.func_195352_j();
      }
   ...
   public boolean mouseClicked(double var1, double var3, int var5) {
      if (super.mouseClicked(☃, ☃, ☃)) {
         ...
         return this.field_146344_y ? this.field_146335_h.mouseClicked(☃, ☃, ☃) : this.field_146333_g.mouseClicked(☃, ☃, ☃);
      }
   }
   ...
   public void func_73863_a(int var1, int var2, float var3) {
      ...
      if (this.field_146344_y) {
         ...
         this.field_146335_h.func_195608_a(☃, ☃, ☃);
         ...
         this.field_146333_g.func_195608_a(☃, ☃, ☃);
   ...
   public void func_146318_a(WorldInfo var1) {
      this.field_146330_J = I18n.func_135052_a("selectWorld.newWorld.copyOf", ☃.func_76065_j());
      this.field_146329_I = ☃.func_76063_b() + "";
      WorldType ☃ = ☃.func_76067_t() == WorldType.field_180271_f ? WorldType.field_77137_b : ☃.func_76067_t();
      this.field_146331_K = ☃.func_82747_f();
      this.field_146334_a = ☃.func_211027_A();
      this.field_146341_s = ☃.func_76089_r();
      this.field_146340_t = ☃.func_76086_u();
      if (☃.func_76093_s()) {
         this.field_146342_r = "hardcore";
      } else if (☃.func_76077_q().func_77144_e()) {
         this.field_146342_r = "survival";
      } else if (☃.func_76077_q().func_77145_d()) {
