...
public class GuiScreenServerList extends GuiScreen {
   ...
   protected void func_73866_w_() {
      ...
      this.field_195170_a = this.func_189646_b(
         new GuiButton(0, this.field_146294_l / 2 - 100, this.field_146295_m / 4 + 96 + 12, I18n.func_135052_a("selectServer.select")) {
            @Override
   ...
   public void func_175273_b(Minecraft var1, int var2, int var3) {
      String ☃ = this.field_146302_g.func_146179_b();
      this.func_146280_a(☃, ☃, ☃);
      this.field_146302_g.func_146180_a(☃);
   }
   ...
   public boolean charTyped(char var1, int var2) {
      if (this.field_146302_g.charTyped(☃, ☃)) {
         this.func_195168_i();
         return true;
      } else {
         return false;
   ...
   public void func_73863_a(int var1, int var2, float var3) {
      ...
      this.field_146302_g.func_195608_a(☃, ☃, ☃);
      super.func_73863_a(☃, ☃, ☃);
   }
}
