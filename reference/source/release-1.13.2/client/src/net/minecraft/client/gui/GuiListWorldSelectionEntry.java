...
public final class GuiListWorldSelectionEntry extends GuiListExtended.IGuiListEntry<GuiListWorldSelectionEntry> implements AutoCloseable {
   ...
   public GuiListWorldSelectionEntry(GuiListWorldSelection var1, WorldSummary var2, ISaveFormat var3) {
      this.field_186788_i = ☃;
      this.field_186785_f = ☃.func_186796_g();
      this.field_186786_g = ☃;
      this.field_186784_e = Minecraft.func_71410_x();
      this.field_186787_h = new ResourceLocation("worlds/" + Hashing.sha1().hashUnencodedChars(☃.func_75786_a()) + "/icon");
      this.field_186789_j = ☃.func_186352_b(☃.func_75786_a(), "icon.png");
   ...
   public void func_194999_a(int var1, int var2, int var3, int var4, boolean var5, float var6) {
      ...
      String ☃xx = this.field_186786_g.func_75788_b();
      String ☃xxx = this.field_186786_g.func_75786_a() + " (" + field_186781_b.format(new Date(this.field_186786_g.func_75784_e())) + ")";
      String ☃xxxx = "";
      if (StringUtils.isEmpty(☃xx)) {
         ☃xx = I18n.func_135052_a("selectWorld.world") + " " + (this.func_195003_b() + 1);
      }

      if (this.field_186786_g.func_75785_d()) {
         ☃xxxx = I18n.func_135052_a("selectWorld.conversion") + " " + ☃xxxx;
      } else {
         ☃xxxx = I18n.func_135052_a("gameMode." + this.field_186786_g.func_75790_f().func_77149_b());
         if (this.field_186786_g.func_75789_g()) {
            ☃xxxx = TextFormatting.DARK_RED + I18n.func_135052_a("gameMode.hardcore") + TextFormatting.RESET;
         }

         if (this.field_186786_g.func_75783_h()) {
            ☃xxxx = ☃xxxx + ", " + I18n.func_135052_a("selectWorld.cheats");
         }

         String ☃ = this.field_186786_g.func_200538_i().func_150254_d();
         if (this.field_186786_g.func_186355_l()) {
            if (this.field_186786_g.func_186356_m()) {
               ☃xxxx = ☃xxxx + ", " + I18n.func_135052_a("selectWorld.version") + " " + TextFormatting.RED + ☃ + TextFormatting.RESET;
            } else {
               ☃xxxx = ☃xxxx + ", " + I18n.func_135052_a("selectWorld.version") + " " + TextFormatting.ITALIC + ☃ + TextFormatting.RESET;
            }
         } else {
            ☃xxxx = ☃xxxx + ", " + I18n.func_135052_a("selectWorld.version") + " " + ☃;
         }
      }

      this.field_186784_e.field_71466_p.func_211126_b(☃xx, (float)(☃x + 32 + 3), (float)(☃ + 1), 16777215);
      this.field_186784_e.field_71466_p.func_211126_b(☃xxx, (float)(☃x + 32 + 3), (float)(☃ + this.field_186784_e.field_71466_p.field_78288_b + 3), 8421504);
      this.field_186784_e
         .field_71466_p
         .func_211126_b(
            ☃xxxx,
            (float)(☃x + 32 + 3),
            (float)(☃ + this.field_186784_e.field_71466_p.field_78288_b + this.field_186784_e.field_71466_p.field_78288_b + 3),
            8421504
         );
      ...
      if (this.field_186784_e.field_71474_y.field_85185_A || ☃) {
         ...
         int ☃x = ☃ < 32 ? 32 : 0;
         if (this.field_186786_g.func_186355_l()) {
            Gui.func_146110_a(☃x, ☃, 32.0F, (float)☃x, 32, 32, 256.0F, 256.0F);
            if (this.field_186786_g.func_202842_n()) {
               Gui.func_146110_a(☃x, ☃, 96.0F, (float)☃x, 32, 32, 256.0F, 256.0F);
               if (☃ < 32) {
                  ITextComponent ☃xx = new TextComponentTranslation("selectWorld.tooltip.unsupported", this.field_186786_g.func_200538_i())
                     .func_211708_a(TextFormatting.RED);
                  this.field_186785_f.func_184861_a(this.field_186784_e.field_71466_p.func_78280_d(☃xx.func_150254_d(), 175));
               }
            ...
            Gui.func_146110_a(☃x, ☃, 0.0F, (float)☃x, 32, 32, 256.0F, 256.0F);
         }
      }
   }
   ...
   public boolean mouseClicked(double var1, double var3, int var5) {
      ...
      if (☃ - (double)this.func_195002_d() <= 32.0) {
         this.func_186774_a();
         return true;
   ...
   public void func_186774_a() {
      if (this.field_186786_g.func_197731_n() || this.field_186786_g.func_202842_n()) {
         String ☃ = I18n.func_135052_a("selectWorld.backupQuestion");
         String ☃x = I18n.func_135052_a("selectWorld.backupWarning", this.field_186786_g.func_200538_i().func_150254_d(), "1.13.2");
         if (this.field_186786_g.func_202842_n()) {
            ☃ = I18n.func_135052_a("selectWorld.backupQuestion.customized");
            ☃x = I18n.func_135052_a("selectWorld.backupWarning.customized");
         }

         this.field_186784_e.func_147108_a(new GuiConfirmBackup(this.field_186785_f, var1x -> {
            if (var1x) {
               String ☃ = this.field_186786_g.func_75786_a();
               GuiWorldEdit.func_200212_a(this.field_186784_e.func_71359_d(), ☃);
            }
         ...
         this.field_186784_e
            .func_147108_a(
               new GuiYesNo(
                           ...
                           this.field_186784_e
                              .func_147108_a(
                                 new GuiScreenAlert(
                                    ...
                                    new TextComponentTranslation("selectWorld.futureworld.error.title"),
                                    new TextComponentTranslation("selectWorld.futureworld.error.text")
                                 )
                              );
                        }
                     } else {
                  ...
                  I18n.func_135052_a("selectWorld.versionWarning", this.field_186786_g.func_200538_i().func_150254_d()),
            ...
            new GuiYesNo(
               (var1, var2) -> {
                  if (var1) {
                     ...
                     ISaveFormat ☃ = this.field_186784_e.func_71359_d();
                     ☃.func_75800_d();
                     ☃.func_75802_e(this.field_186786_g.func_75786_a());
               ...
               I18n.func_135052_a("selectWorld.deleteWarning", this.field_186786_g.func_75788_b()),
   ...
   public void func_186779_d() {
      try {
         this.field_186784_e.func_147108_a(new GuiScreenWorking());
         GuiCreateWorld ☃ = new GuiCreateWorld(this.field_186785_f);
         ISaveHandler ☃x = this.field_186784_e.func_71359_d().func_197715_a(this.field_186786_g.func_75786_a(), null);
               ...
               this.field_186784_e
                  .func_147108_a(
                     new GuiYesNo(
                        (var2x, var3x) -> {
                           if (var2x) {
                              this.field_186784_e.func_147108_a(☃);
                           } else {
                              this.field_186784_e.func_147108_a(this.field_186785_f);
                           }
                        },
                        I18n.func_135052_a("selectWorld.recreate.customized.title"),
                        I18n.func_135052_a("selectWorld.recreate.customized.text"),
                        I18n.func_135052_a("gui.proceed"),
                        I18n.func_135052_a("gui.cancel"),
                        0
                     )
                  );
         ...
         this.field_186784_e
            .func_147108_a(
               new GuiScreenAlert(
                  () -> this.field_186784_e.func_147108_a(this.field_186785_f),
                  new TextComponentTranslation("selectWorld.recreate.error.title"),
                  new TextComponentTranslation("selectWorld.recreate.error.text")
               )
            );
      }
   }
   ...
   private DynamicTexture func_195033_j() {
      boolean ☃ = this.field_186789_j != null && this.field_186789_j.isFile();
      if (☃) {
         try {
            InputStream ☃x = new FileInputStream(this.field_186789_j);
            Throwable var3 = null;

            DynamicTexture var6;
            try {
               NativeImage ☃xx = NativeImage.func_195713_a(☃x);
               Validate.validState(☃xx.func_195702_a() == 64, "Must be 64 pixels wide");
               Validate.validState(☃xx.func_195714_b() == 64, "Must be 64 pixels high");
               DynamicTexture ☃xxx = new DynamicTexture(☃xx);
               this.field_186784_e.func_110434_K().func_110579_a(this.field_186787_h, ☃xxx);
               var6 = ☃xxx;
