...
public class VertexBuffer {
   ...
   public void func_181722_a(ByteBuffer var1) {
      this.func_177359_a();
      OpenGlHelper.func_176071_a(OpenGlHelper.field_176089_P, ☃, 35044);
      this.func_177361_b();
      this.field_177364_c = ☃.limit() / this.field_177363_b.func_177338_f();
   }

   public void func_177358_a(int var1) {
      GlStateManager.func_187439_f(☃, 0, this.field_177364_c);
   }
