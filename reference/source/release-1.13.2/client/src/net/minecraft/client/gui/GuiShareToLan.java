...
public class GuiShareToLan extends GuiScreen {
   ...
   protected void func_73866_w_() {
      this.func_189646_b(
         new GuiButton(101, this.field_146294_l / 2 - 155, this.field_146295_m - 28, 150, 20, I18n.func_135052_a("lanServer.start")) {
            @Override
            public void func_194829_a(double var1, double var3) {
               GuiShareToLan.this.field_146297_k.func_147108_a(null);
               int ☃x = HttpUtil.func_76181_a();
               ITextComponent ☃;
               if (GuiShareToLan.this.field_146297_k
                  .func_71401_C()
                  .func_195565_a(GameType.func_77142_a(GuiShareToLan.this.field_146599_h), GuiShareToLan.this.field_146600_i, ☃x)) {
                  ☃ = new TextComponentTranslation("commands.publish.started", ☃x);
               } else {
                  ☃ = new TextComponentTranslation("commands.publish.failed");
               }
   
               GuiShareToLan.this.field_146297_k.field_71456_v.func_146158_b().func_146227_a(☃);
            }
         }
      );
