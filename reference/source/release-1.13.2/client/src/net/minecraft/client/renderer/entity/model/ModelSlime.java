...
public class ModelSlime extends ModelBase {
   ...
   public ModelSlime(int var1) {
      if (☃ > 0) {
         this.field_78200_a = new ModelRenderer(this, 0, ☃);
   ...
   public void func_78088_a(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      this.field_78200_a.func_78785_a(☃);
      if (this.field_78198_b != null) {
         this.field_78198_b.func_78785_a(☃);
         this.field_78199_c.func_78785_a(☃);
         this.field_78197_d.func_78785_a(☃);
      }
   }
}
