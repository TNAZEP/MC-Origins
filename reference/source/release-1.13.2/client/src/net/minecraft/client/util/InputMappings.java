...
public class InputMappings {
   public static final InputMappings.Input field_197958_a = InputMappings.Type.KEYSYM.func_197944_a(-1);

   public static boolean func_197956_a(int var0) {
      return GLFW.glfwGetKey(Minecraft.func_71410_x().field_195558_d.func_198092_i(), ☃) == 1;
   }

   public static InputMappings.Input func_197954_a(int var0, int var1) {
      return ☃ == -1 ? InputMappings.Type.SCANCODE.func_197944_a(☃) : InputMappings.Type.KEYSYM.func_197944_a(☃);
   }

   public static InputMappings.Input func_197955_a(String var0) {
      if (InputMappings.Input.field_199875_d.containsKey(☃)) {
         return (InputMappings.Input)InputMappings.Input.field_199875_d.get(☃);
      } else {
         for(InputMappings.Type ☃ : InputMappings.Type.values()) {
            if (☃.startsWith(☃.field_197952_f)) {
               String ☃x = ☃.substring(☃.field_197952_f.length() + 1);
               return ☃.func_197944_a(Integer.parseInt(☃x));
            }
         }
   ...
   public static final class Input {
      ...
      public String func_197936_a() {
         ...
         switch(this.field_197940_b) {
            case KEYSYM:
               ☃ = GLFW.glfwGetKeyName(this.field_197941_c, -1);
               break;
            case SCANCODE:
               ☃ = GLFW.glfwGetKeyName(-1, this.field_197941_c);
               break;
            case MOUSE:
               String ☃x = I18n.func_135052_a(this.field_197939_a);
               ☃ = Objects.equals(☃x, this.field_197939_a) ? I18n.func_135052_a(InputMappings.Type.MOUSE.field_197952_f, this.field_197941_c + 1) : ☃x;
         }

         return ☃ == null ? I18n.func_135052_a(this.field_197939_a) : ☃;
      }
      ...
      public boolean equals(Object var1) {
         if (this == ☃) {
            ...
            InputMappings.Input ☃ = (InputMappings.Input)☃;
            return this.field_197941_c == ☃.field_197941_c && this.field_197940_b == ☃.field_197940_b;
         } else {
            return false;
         }
      }
   ...
   public static enum Type {
      ...
      private static void func_197943_a(InputMappings.Type var0, String var1, int var2) {
         InputMappings.Input ☃ = new InputMappings.Input(☃, ☃, ☃);
         ☃.field_197951_e.func_76038_a(☃, ☃);
      }
      ...
      public InputMappings.Input func_197944_a(int var1) {
         if (this.field_197951_e.func_76037_b(☃)) {
            return this.field_197951_e.func_76041_a(☃);
         } else {
            String ☃;
            if (this == MOUSE) {
               if (☃ <= 2) {
            ...
            InputMappings.Input ☃ = new InputMappings.Input(this.field_197952_f + ☃, this, ☃);
            this.field_197951_e.func_76038_a(☃, ☃);
            return ☃;
         }
      }
