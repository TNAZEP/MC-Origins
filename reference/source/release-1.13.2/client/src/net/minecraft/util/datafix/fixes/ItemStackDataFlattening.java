...
public class ItemStackDataFlattening extends DataFix {
   private static final Map<String, String> field_199176_a = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   private static final Set<String> field_199177_b = (Set<String>)field_199176_a.keySet()
      .stream()
      .map(var0 -> var0.substring(0, var0.indexOf(46)))
      .collect(Collectors.toSet());
   private static final Set<String> field_199178_c = Sets.newHashSet(
      "minecraft:bow",
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", ☃, var2x -> {
         ...
         if (!☃.isPresent()) {
            ...
            int ☃xx = ☃x.getInt("Damage");
            String ☃xxx = func_199175_a((String)((Pair)☃.get()).getSecond(), ☃xx);
            if (☃xxx != null) {
               ☃ = var2x.set(☃, Pair.of(TypeReferences.field_211301_q.typeName(), ☃xxx));
            }

            if (field_199178_c.contains(((Pair)☃.get()).getSecond())) {
               Typed<?> ☃ = var2x.getOrCreateTyped(☃);
               Dynamic<?> ☃x = ☃.get(DSL.remainderFinder());
               ☃x = ☃x.set("Damage", ☃x.createInt(☃xx));
               ☃ = ☃.set(☃, ☃.set(DSL.remainderFinder(), ☃x));
            }

            return ☃.set(DSL.remainderFinder(), ☃x.remove("Damage"));
         }
      });
   }
   ...
   public static String func_199175_a(@Nullable String var0, int var1) {
      if (field_199177_b.contains(☃)) {
         String ☃ = (String)field_199176_a.get(☃ + '.' + ☃);
         return ☃ == null ? (String)field_199176_a.get(☃ + ".0") : ☃;
      } else {
         return null;
      }
   }
