   ...
   public static enum EnumOS {
      ...
      WINDOWS {
         ...
         protected String[] func_195643_b(URL var1) {
            return new String[]{"rundll32", "url.dll,FileProtocolHandler", ☃.toString()};
         }
      },
      OSX {
         @Override
      ...
      public void func_195639_a(URL var1) {
         try {
            Process ☃ = (Process)AccessController.doPrivileged(() -> Runtime.getRuntime().exec(this.func_195643_b(☃)));

            for(String ☃x : IOUtils.readLines(☃.getErrorStream())) {
               Util.field_195650_a.error(☃x);
            }
            ...
            Util.field_195650_a.error("Couldn't open url '{}'", ☃, var5);
         }
      }

      public void func_195642_a(URI var1) {
         try {
            this.func_195639_a(☃.toURL());
         } catch (MalformedURLException var3) {
            Util.field_195650_a.error("Couldn't open uri '{}'", ☃, var3);
         }
      }

      public void func_195641_a(File var1) {
         try {
            this.func_195639_a(☃.toURI().toURL());
         } catch (MalformedURLException var3) {
            Util.field_195650_a.error("Couldn't open file '{}'", ☃, var3);
         }
      }
      ...
      public void func_195640_a(String var1) {
         try {
            this.func_195639_a(new URI(☃).toURL());
