...
public abstract class VoxelShapePart {
   ...
   public int func_197826_a(EnumFacing.Axis var1, int var2, int var3) {
      int ☃ = this.func_197819_a(☃);
      if (☃ >= 0 && ☃ >= 0) {
         EnumFacing.Axis ☃x = AxisRotation.FORWARD.func_197513_a(☃);
         EnumFacing.Axis ☃xx = AxisRotation.BACKWARD.func_197513_a(☃);
         if (☃ < this.func_197819_a(☃x) && ☃ < this.func_197819_a(☃xx)) {
            AxisRotation ☃xxx = AxisRotation.func_197516_a(EnumFacing.Axis.X, ☃);

            for(int ☃xxxx = 0; ☃xxxx < ☃; ++☃xxxx) {
               if (this.func_197829_b(☃xxx, ☃xxxx, ☃, ☃)) {
                  return ☃xxxx;
               }
            }
   ...
   public int func_197836_b(EnumFacing.Axis var1, int var2, int var3) {
      if (☃ >= 0 && ☃ >= 0) {
         EnumFacing.Axis ☃ = AxisRotation.FORWARD.func_197513_a(☃);
         EnumFacing.Axis ☃x = AxisRotation.BACKWARD.func_197513_a(☃);
         if (☃ < this.func_197819_a(☃) && ☃ < this.func_197819_a(☃x)) {
            int ☃xx = this.func_197819_a(☃);
            AxisRotation ☃xxx = AxisRotation.func_197516_a(EnumFacing.Axis.X, ☃);

            for(int ☃xxxx = ☃xx - 1; ☃xxxx >= 0; --☃xxxx) {
               if (this.func_197829_b(☃xxx, ☃xxxx, ☃, ☃)) {
                  return ☃xxxx + 1;
               }
            }
   ...
   public void func_197828_a(VoxelShapePart.LineConsumer var1, boolean var2) {
      this.func_197832_a(☃, AxisRotation.NONE, ☃);
      this.func_197832_a(☃, AxisRotation.FORWARD, ☃);
      this.func_197832_a(☃, AxisRotation.BACKWARD, ☃);
   }

   private void func_197832_a(VoxelShapePart.LineConsumer var1, AxisRotation var2, boolean var3) {
      AxisRotation ☃ = ☃.func_197514_a();
      int ☃x = this.func_197819_a(☃.func_197513_a(EnumFacing.Axis.X));
      int ☃xx = this.func_197819_a(☃.func_197513_a(EnumFacing.Axis.Y));
      int ☃xxx = this.func_197819_a(☃.func_197513_a(EnumFacing.Axis.Z));

      for(int ☃xxxx = 0; ☃xxxx <= ☃x; ++☃xxxx) {
         for(int ☃xxxxx = 0; ☃xxxxx <= ☃xx; ++☃xxxxx) {
            int ☃xxxxxx = -1;
            ...
            for(int ☃xxxxxxx = 0; ☃xxxxxxx <= ☃xxx; ++☃xxxxxxx) {
               ...
               for(int ☃xxxxxxxxxx = 0; ☃xxxxxxxxxx <= 1; ++☃xxxxxxxxxx) {
                  for(int ☃xxxxxxxxxxx = 0; ☃xxxxxxxxxxx <= 1; ++☃xxxxxxxxxxx) {
                     if (this.func_197824_a(☃, ☃xxxx + ☃xxxxxxxxxx - 1, ☃xxxxx + ☃xxxxxxxxxxx - 1, ☃xxxxxxx)) {
                        ++☃xxxxxxxx;
               ...
               if (☃xxxxxxxx == 1 || ☃xxxxxxxx == 3 || ☃xxxxxxxx == 2 && (☃xxxxxxxxx & 1) == 0) {
                  if (☃) {
                     if (☃xxxxxx == -1) {
                        ☃xxxxxx = ☃xxxxxxx;
                     }
                     ...
                     ☃.consume(
                        ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxxx, EnumFacing.Axis.X),
                        ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxxx, EnumFacing.Axis.Y),
                        ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxxx, EnumFacing.Axis.Z),
                        ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxxx + 1, EnumFacing.Axis.X),
                        ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxxx + 1, EnumFacing.Axis.Y),
                        ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxxx + 1, EnumFacing.Axis.Z)
                     );
                  }
               } else if (☃xxxxxx != -1) {
                  ☃.consume(
                     ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxx, EnumFacing.Axis.X),
                     ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxx, EnumFacing.Axis.Y),
                     ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxx, EnumFacing.Axis.Z),
                     ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxxx, EnumFacing.Axis.X),
                     ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxxx, EnumFacing.Axis.Y),
                     ☃.func_197517_a(☃xxxx, ☃xxxxx, ☃xxxxxxx, EnumFacing.Axis.Z)
                  );
