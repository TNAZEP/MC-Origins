...
public class RenamedRecipes extends DataFix {
   private static final Map<String, String> field_209673_a = ImmutableMap.builder()
   ...
   protected TypeRewriteRule makeRule() {
      Type<Pair<String, String>> ☃ = DSL.named(TypeReferences.field_211304_t.typeName(), DSL.namespacedString());
      if (!Objects.equals(☃, this.getInputSchema().getType(TypeReferences.field_211304_t))) {
         throw new IllegalStateException("Recipe type is not what was expected.");
      } else {
         return this.fixTypeEverywhere("Recipes fix", ☃, var0 -> var0x -> var0x.mapSecond(var0xx -> (String)field_209673_a.getOrDefault(var0xx, var0xx)));
      }
   }
}
