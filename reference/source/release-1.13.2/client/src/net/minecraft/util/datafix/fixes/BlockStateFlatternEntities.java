...
public class BlockStateFlatternEntities extends DataFix {
   private static final Map<String, Integer> field_199172_a = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   public static int func_199171_a(String var0) {
      Integer ☃ = (Integer)field_199172_a.get(☃);
      return ☃ == null ? 0 : ☃;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Function<Typed<?>, Typed<?>> ☃xx = var1x -> this.func_211434_a(var1x, "DisplayTile", "DisplayData", "DisplayState");
      Function<Typed<?>, Typed<?>> ☃xxx = var1x -> this.func_211434_a(var1x, "inTile", "inData", "inBlockState");
      Type<Pair<Either<Pair<String, Either<Integer, String>>, Unit>, Dynamic<?>>> ☃xxxx = DSL.and(
         DSL.optional(DSL.field("inTile", DSL.named(TypeReferences.field_211300_p.typeName(), DSL.or(DSL.intType(), DSL.namespacedString())))),
         DSL.remainderType()
      );
      Function<Typed<?>, Typed<?>> ☃xxxxx = var1x -> var1x.update(☃.finder(), DSL.remainderType(), Pair::getSecond);
      return this.fixTypeEverywhereTyped("EntityBlockStateFix", ☃.getType(TypeReferences.field_211299_o), ☃x.getType(TypeReferences.field_211299_o), var4x -> {
         var4x = this.func_211431_a(var4x, "minecraft:falling_block", this::func_211442_a);
         var4x = this.func_211431_a(var4x, "minecraft:enderman", var1x -> this.func_211434_a(var1x, "carried", "carriedData", "carriedBlockState"));
         var4x = this.func_211431_a(var4x, "minecraft:arrow", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:spectral_arrow", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:egg", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:ender_pearl", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:fireball", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:potion", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:small_fireball", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:snowball", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:wither_skull", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:xp_bottle", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:commandblock_minecart", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:minecart", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:chest_minecart", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:furnace_minecart", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:tnt_minecart", ☃);
         var4x = this.func_211431_a(var4x, "minecraft:hopper_minecart", ☃);
         return this.func_211431_a(var4x, "minecraft:spawner_minecart", ☃);
      });
   }

   private Typed<?> func_211442_a(Typed<?> var1) {
      Type<Either<Pair<String, Either<Integer, String>>, Unit>> ☃ = DSL.optional(
         DSL.field("Block", DSL.named(TypeReferences.field_211300_p.typeName(), DSL.or(DSL.intType(), DSL.namespacedString())))
      );
      Type<Either<Pair<String, Dynamic<?>>, Unit>> ☃x = DSL.optional(
         DSL.field("BlockState", DSL.named(TypeReferences.field_211296_l.typeName(), DSL.remainderType()))
      );
      Dynamic<?> ☃xx = ☃.get(DSL.remainderFinder());
      return ☃.update(☃.finder(), ☃x, var1x -> {
         int ☃ = var1x.map(var0x -> ((Either)var0x.getSecond()).map(var0xx -> var0xx, BlockStateFlatternEntities::func_199171_a), var1xx -> {
            Optional<Number> ☃ = ☃.get("TileID").flatMap(Dynamic::getNumberValue);
            return (Integer)☃.map(Number::intValue).orElseGet(() -> ☃.getByte("Tile") & 0xFF);
         });
         int ☃x = ☃.getInt("Data") & 15;
         return Either.left(Pair.of(TypeReferences.field_211296_l.typeName(), BlockStateFlatteningMap.func_210049_b(☃ << 4 | ☃x)));
      }).set(DSL.remainderFinder(), ☃xx.remove("Data").remove("TileID").remove("Tile"));
   }

   private Typed<?> func_211434_a(Typed<?> var1, String var2, String var3, String var4) {
      Type<Pair<String, Either<Integer, String>>> ☃ = DSL.field(
         ☃, DSL.named(TypeReferences.field_211300_p.typeName(), DSL.or(DSL.intType(), DSL.namespacedString()))
      );
      Type<Pair<String, Dynamic<?>>> ☃x = DSL.field(☃, DSL.named(TypeReferences.field_211296_l.typeName(), DSL.remainderType()));
      Dynamic<?> ☃xx = ☃.getOrCreate(DSL.remainderFinder());
      return ☃.update(☃.finder(), ☃x, var2x -> {
         int ☃ = ((Either)var2x.getSecond()).map(var0x -> var0x, BlockStateFlatternEntities::func_199171_a);
         int ☃x = ☃.getInt(☃) & 15;
         return Pair.of(TypeReferences.field_211296_l.typeName(), BlockStateFlatteningMap.func_210049_b(☃ << 4 | ☃x));
      }).set(DSL.remainderFinder(), ☃xx.remove(☃));
   }

   private Typed<?> func_211431_a(Typed<?> var1, String var2, Function<Typed<?>, Typed<?>> var3) {
      Type<?> ☃ = this.getInputSchema().getChoiceType(TypeReferences.field_211299_o, ☃);
      Type<?> ☃x = this.getOutputSchema().getChoiceType(TypeReferences.field_211299_o, ☃);
      return ☃.updateTyped(DSL.namedChoice(☃, ☃), ☃x, ☃);
   }
}
