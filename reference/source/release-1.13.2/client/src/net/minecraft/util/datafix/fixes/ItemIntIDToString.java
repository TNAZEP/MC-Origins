...
public class ItemIntIDToString extends DataFix {
   private static final Int2ObjectMap<String> field_188221_a = DataFixUtils.make(new Int2ObjectOpenHashMap(), var0 -> {
   ...
   public static String func_199173_a(int var0) {
      return (String)field_188221_a.get(☃);
   }

   @Override
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> ☃ = DSL.or(DSL.intType(), DSL.named(TypeReferences.field_211301_q.typeName(), DSL.namespacedString()));
      Type<Pair<String, String>> ☃x = DSL.named(TypeReferences.field_211301_q.typeName(), DSL.namespacedString());
      OpticFinder<Either<Integer, Pair<String, String>>> ☃xx = DSL.fieldFinder("id", ☃);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(TypeReferences.field_211295_k),
         this.getOutputSchema().getType(TypeReferences.field_211295_k),
         var2x -> var2x.update(☃, ☃, var0x -> var0x.map(var0xx -> Pair.of(TypeReferences.field_211301_q.typeName(), func_199173_a(var0xx)), var0xx -> var0xx))
      );
   }
}
