...
public class BiomeRenames extends DataFix {
   public static final Map<String, String> field_210919_a = ImmutableMap.builder()
   ...
   protected TypeRewriteRule makeRule() {
      Type<Pair<String, String>> ☃ = DSL.named(TypeReferences.field_211305_u.typeName(), DSL.namespacedString());
      if (!Objects.equals(☃, this.getInputSchema().getType(TypeReferences.field_211305_u))) {
         throw new IllegalStateException("Biome type is not what was expected.");
      } else {
         return this.fixTypeEverywhere("Biomes fix", ☃, var0 -> var0x -> var0x.mapSecond(var0xx -> (String)field_210919_a.getOrDefault(var0xx, var0xx)));
      }
   }
}
