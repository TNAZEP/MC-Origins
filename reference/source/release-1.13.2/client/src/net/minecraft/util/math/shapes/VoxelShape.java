...
public abstract class VoxelShape {
   ...
   public double func_197764_a(EnumFacing.Axis var1, double var2, double var4) {
      ...
      int ☃xx = this.func_197749_a(☃, ☃);
      int ☃xxx = this.func_197749_a(☃x, ☃);
      int ☃xxxx = this.field_197768_g.func_197826_a(☃, ☃xx, ☃xxx);
      return ☃xxxx >= this.field_197768_g.func_197819_a(☃) ? Double.POSITIVE_INFINITY : this.func_197759_b(☃, ☃xxxx);
   }
   ...
   public double func_197760_b(EnumFacing.Axis var1, double var2, double var4) {
      ...
      int ☃xx = this.func_197749_a(☃, ☃);
      int ☃xxx = this.func_197749_a(☃x, ☃);
      int ☃xxxx = this.field_197768_g.func_197836_b(☃, ☃xx, ☃xxx);
      return ☃xxxx <= 0 ? Double.NEGATIVE_INFINITY : this.func_197759_b(☃, ☃xxxx);
   }
