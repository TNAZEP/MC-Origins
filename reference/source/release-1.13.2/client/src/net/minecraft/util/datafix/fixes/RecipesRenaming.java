...
public class RecipesRenaming extends DataFix {
   private static final Map<String, String> field_211869_a = ImmutableMap.builder()
   ...
   protected TypeRewriteRule makeRule() {
      ...
      if (!Objects.equals(☃, this.getInputSchema().getType(TypeReferences.field_211304_t))) {
         ...
         return this.fixTypeEverywhere(
            "Recipes renamening fix", ☃, var0 -> var0x -> var0x.mapSecond(var0xx -> (String)field_211869_a.getOrDefault(var0xx, var0xx))
         );
      }
   }
}
