...
public class PotionItems extends DataFix {
   private static final String[] field_188223_a = DataFixUtils.make(new String[128], var0 -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         var2x -> {
            ...
            if (☃.isPresent() && Objects.equals(((Pair)☃.get()).getSecond(), "minecraft:potion")) {
               Dynamic<?> ☃x = var2x.get(DSL.remainderFinder());
               Optional<? extends Typed<?>> ☃xx = var2x.getOptionalTyped(☃);
               short ☃xxx = ((Number)☃x.get("Damage").flatMap(Dynamic::getNumberValue).orElse(0)).shortValue();
               if (☃xx.isPresent()) {
                  Typed<?> ☃xxxx = var2x;
                  Dynamic<?> ☃xxxxx = ((Typed)☃xx.get()).get(DSL.remainderFinder());
                  Optional<String> ☃xxxxxx = ☃xxxxx.get("Potion").flatMap(Dynamic::getStringValue);
                  if (!☃xxxxxx.isPresent()) {
                     String ☃xxxxxxx = field_188223_a[☃xxx & 127];
                     Typed<?> ☃xxxxxxxx = ((Typed)☃xx.get())
                        .set(DSL.remainderFinder(), ☃xxxxx.set("Potion", ☃xxxxx.createString(☃xxxxxxx == null ? "minecraft:water" : ☃xxxxxxx)));
                     ☃xxxx = var2x.set(☃, ☃xxxxxxxx);
                     if ((☃xxx & 16384) == 16384) {
                        ☃xxxx = ☃xxxx.set(☃, Pair.of(TypeReferences.field_211301_q.typeName(), "minecraft:splash_potion"));
                     }
                  }
                  ...
                  return ☃xxxx.set(DSL.remainderFinder(), ☃x);
               }
            }
