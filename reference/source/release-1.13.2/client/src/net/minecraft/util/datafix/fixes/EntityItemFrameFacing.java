...
public class EntityItemFrameFacing extends NamedEntityFix {
   public EntityItemFrameFacing(Schema var1, boolean var2) {
      super(☃, ☃, "EntityItemFrameDirectionFix", TypeReferences.field_211299_o, "minecraft:item_frame");
   }

   public Dynamic<?> func_209651_a(Dynamic<?> var1) {
      return ☃.set("Facing", ☃.createByte(func_210567_a(☃.getByte("Facing"))));
   }

   @Override
   protected Typed<?> func_207419_a(Typed<?> var1) {
      return ☃.update(DSL.remainderFinder(), this::func_209651_a);
   }
