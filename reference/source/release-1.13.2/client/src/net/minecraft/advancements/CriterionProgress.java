...
public class CriterionProgress {
   ...
   public void func_192150_a(PacketBuffer var1) {
      ☃.writeBoolean(this.field_192157_c != null);
      if (this.field_192157_c != null) {
         ☃.func_192574_a(this.field_192157_c);
      }
   }
   ...
   public static CriterionProgress func_209541_a(String var0) {
      ...
      try {
         ☃.field_192157_c = field_192155_a.parse(☃);
         return ☃;
      } catch (ParseException var3) {
         throw new JsonSyntaxException("Invalid datetime: " + ☃, var3);
      }
   }
}
