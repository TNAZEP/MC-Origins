...
public class AdvancementProgress implements Comparable<AdvancementProgress> {
   ...
   public float func_192103_c() {
      if (this.field_192110_a.isEmpty()) {
         ...
         float ☃ = (float)this.field_192111_b.length;
         float ☃x = (float)this.func_194032_h();
         return ☃x / ☃;
      }
   }
   ...
   public String func_193126_d() {
      if (this.field_192110_a.isEmpty()) {
         ...
         int ☃ = this.field_192111_b.length;
         if (☃ <= 1) {
            return null;
         } else {
            int ☃ = this.func_194032_h();
            return ☃ + "/" + ☃;
         }
      }
   }
   ...
   private int func_194032_h() {
      ...
      for(String[] ☃x : this.field_192111_b) {
         boolean ☃xx = false;

         for(String ☃xxx : ☃x) {
            CriterionProgress ☃xxxx = this.func_192106_c(☃xxx);
            if (☃xxxx != null && ☃xxxx.func_192151_a()) {
               ☃xx = true;
               break;
            }
         }
