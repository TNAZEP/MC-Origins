...
public class ParticleArgument implements ArgumentType<IParticleData> {
   ...
   public static final DynamicCommandExceptionType field_197191_a = new DynamicCommandExceptionType(
      var0 -> new TextComponentTranslation("particle.notFound", var0)
   );
   ...
   public static IParticleData func_197189_a(StringReader var0) throws CommandSyntaxException {
      ...
      ParticleType<?> ☃x = IRegistry.field_212632_u.func_212608_b(☃);
      if (☃x == null) {
         throw field_197191_a.create(☃);
      } else {
         return func_199816_a(☃, ☃x);
      }
   }
   ...
   private static <T extends IParticleData> T func_199816_a(StringReader var0, ParticleType<T> var1) throws CommandSyntaxException {
      return ☃.func_197571_g().func_197544_b(☃, ☃);
   }

   @Override
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> var1, SuggestionsBuilder var2) {
      return ISuggestionProvider.func_197014_a(IRegistry.field_212632_u.func_148742_b(), ☃);
   }
}
