...
public class ComponentArgument implements ArgumentType<ITextComponent> {
   ...
   public static final DynamicCommandExceptionType field_197070_a = new DynamicCommandExceptionType(
      var0 -> new TextComponentTranslation("argument.component.invalid", var0)
   );
   ...
   public static ITextComponent func_197068_a(CommandContext<CommandSource> var0, String var1) {
      return ☃.getArgument(☃, ITextComponent.class);
   }
   ...
   public ITextComponent parse(StringReader var1) throws CommandSyntaxException {
      try {
         ITextComponent ☃ = ITextComponent.Serializer.func_197671_a(☃);
         if (☃ == null) {
            throw field_197070_a.createWithContext(☃, "empty");
         } else {
            return ☃;
         }
      } catch (JsonParseException var4) {
         String ☃ = var4.getCause() != null ? var4.getCause().getMessage() : var4.getMessage();
         throw field_197070_a.createWithContext(☃, ☃);
      }
   }
