...
public class RealmsLevelSummary implements Comparable<RealmsLevelSummary> {
   ...
   public int compareTo(RealmsLevelSummary var1) {
      if (this.levelSummary.func_75784_e() < ☃.getLastPlayed()) {
         return 1;
      } else {
         return this.levelSummary.func_75784_e() > ☃.getLastPlayed() ? -1 : this.levelSummary.func_75786_a().compareTo(☃.getLevelId());
      }
   }
}
