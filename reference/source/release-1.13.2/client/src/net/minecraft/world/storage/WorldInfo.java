...
public class WorldInfo {
   ...
   private final Map<DimensionType, NBTTagCompound> field_186348_N = Maps.<DimensionType, NBTTagCompound>newIdentityHashMap();
   ...
   public WorldInfo(NBTTagCompound var1, DataFixer var2, int var3, @Nullable NBTTagCompound var4) {
      this.field_209226_o = ☃;
      if (☃.func_150297_b("Version", 10)) {
         NBTTagCompound ☃ = ☃.func_74775_l("Version");
         this.field_186349_b = ☃.func_74779_i("Name");
         this.field_186350_c = ☃.func_74762_e("Id");
         this.field_186351_d = ☃.func_74767_n("Snapshot");
      }

      this.field_76100_a = ☃.func_74763_f("RandomSeed");
      if (☃.func_150297_b("generatorName", 8)) {
         String ☃ = ☃.func_74779_i("generatorName");
         this.field_76098_b = WorldType.func_77130_a(☃);
         if (this.field_76098_b == null) {
            this.field_76098_b = WorldType.field_77137_b;
         } else if (this.field_76098_b == WorldType.field_180271_f) {
            this.field_211931_h = ☃.func_74779_i("generatorOptions");
         } else if (this.field_76098_b.func_77125_e()) {
            int ☃ = 0;
            if (☃.func_150297_b("generatorVersion", 99)) {
               ☃ = ☃.func_74762_e("generatorVersion");
            }

            this.field_76098_b = this.field_76098_b.func_77132_a(☃);
         }

         this.func_212242_b(☃.func_74775_l("generatorOptions"));
      }

      this.field_76113_q = GameType.func_77146_a(☃.func_74762_e("GameType"));
      if (☃.func_150297_b("legacy_custom_options", 8)) {
         this.field_211931_h = ☃.func_74779_i("legacy_custom_options");
      }

      if (☃.func_150297_b("MapFeatures", 99)) {
         this.field_76112_r = ☃.func_74767_n("MapFeatures");
      } else {
         this.field_76112_r = true;
      }

      this.field_76099_c = ☃.func_74762_e("SpawnX");
      this.field_76096_d = ☃.func_74762_e("SpawnY");
      this.field_76097_e = ☃.func_74762_e("SpawnZ");
      this.field_82575_g = ☃.func_74763_f("Time");
      if (☃.func_150297_b("DayTime", 99)) {
         this.field_76094_f = ☃.func_74763_f("DayTime");
      } else {
         this.field_76094_f = this.field_82575_g;
      }

      this.field_76095_g = ☃.func_74763_f("LastPlayed");
      this.field_76107_h = ☃.func_74763_f("SizeOnDisk");
      this.field_76106_k = ☃.func_74779_i("LevelName");
      this.field_76103_l = ☃.func_74762_e("version");
      this.field_176157_p = ☃.func_74762_e("clearWeatherTime");
      this.field_76101_n = ☃.func_74762_e("rainTime");
      this.field_76104_m = ☃.func_74767_n("raining");
      this.field_76114_p = ☃.func_74762_e("thunderTime");
      this.field_76102_o = ☃.func_74767_n("thundering");
      this.field_76111_s = ☃.func_74767_n("hardcore");
      if (☃.func_150297_b("initialized", 99)) {
         this.field_76109_u = ☃.func_74767_n("initialized");
      } else {
         this.field_76109_u = true;
      }

      if (☃.func_150297_b("allowCommands", 99)) {
         this.field_76110_t = ☃.func_74767_n("allowCommands");
      } else {
      ...
      if (☃.func_150297_b("GameRules", 10)) {
         this.field_82577_x.func_82768_a(☃.func_74775_l("GameRules"));
      }

      if (☃.func_150297_b("Difficulty", 99)) {
         this.field_176158_z = EnumDifficulty.func_151523_a(☃.func_74771_c("Difficulty"));
      }

      if (☃.func_150297_b("DifficultyLocked", 1)) {
         this.field_176150_A = ☃.func_74767_n("DifficultyLocked");
      }

      if (☃.func_150297_b("BorderCenterX", 99)) {
         this.field_176151_B = ☃.func_74769_h("BorderCenterX");
      }

      if (☃.func_150297_b("BorderCenterZ", 99)) {
         this.field_176152_C = ☃.func_74769_h("BorderCenterZ");
      }

      if (☃.func_150297_b("BorderSize", 99)) {
         this.field_176146_D = ☃.func_74769_h("BorderSize");
      }

      if (☃.func_150297_b("BorderSizeLerpTime", 99)) {
         this.field_176147_E = ☃.func_74763_f("BorderSizeLerpTime");
      }

      if (☃.func_150297_b("BorderSizeLerpTarget", 99)) {
         this.field_176148_F = ☃.func_74769_h("BorderSizeLerpTarget");
      }

      if (☃.func_150297_b("BorderSafeZone", 99)) {
         this.field_176149_G = ☃.func_74769_h("BorderSafeZone");
      }

      if (☃.func_150297_b("BorderDamagePerBlock", 99)) {
         this.field_176153_H = ☃.func_74769_h("BorderDamagePerBlock");
      }

      if (☃.func_150297_b("BorderWarningBlocks", 99)) {
         this.field_176154_I = ☃.func_74762_e("BorderWarningBlocks");
      }

      if (☃.func_150297_b("BorderWarningTime", 99)) {
         this.field_176155_J = ☃.func_74762_e("BorderWarningTime");
      }

      if (☃.func_150297_b("DimensionData", 10)) {
         NBTTagCompound ☃ = ☃.func_74775_l("DimensionData");

         for(String ☃x : ☃.func_150296_c()) {
            this.field_186348_N.put(DimensionType.func_186069_a(Integer.parseInt(☃x)), ☃.func_74775_l(☃x));
         }
      }

      if (☃.func_150297_b("DataPacks", 10)) {
         NBTTagCompound ☃ = ☃.func_74775_l("DataPacks");
         NBTTagList ☃x = ☃.func_150295_c("Disabled", 8);

         for(int ☃xx = 0; ☃xx < ☃x.size(); ++☃xx) {
            this.field_197721_N.add(☃x.func_150307_f(☃xx));
         }

         NBTTagList ☃xx = ☃.func_150295_c("Enabled", 8);

         for(int ☃xxx = 0; ☃xxx < ☃xx.size(); ++☃xxx) {
            this.field_197722_O.add(☃xx.func_150307_f(☃xxx));
         }
      }

      if (☃.func_150297_b("CustomBossEvents", 10)) {
         this.field_201358_Q = ☃.func_74775_l("CustomBossEvents");
      }
   }
   ...
   public void func_176127_a(WorldSettings var1) {
      this.field_76100_a = ☃.func_77160_d();
      this.field_76113_q = ☃.func_77162_e();
      this.field_76112_r = ☃.func_77164_g();
      this.field_76111_s = ☃.func_77158_f();
      this.field_76098_b = ☃.func_77165_h();
      this.func_212242_b(Dynamic.convert(JsonOps.INSTANCE, NBTDynamicOps.field_210820_a, ☃.func_205391_j()));
      this.field_76110_t = ☃.func_77163_i();
   }
   ...
   private void func_76064_a(NBTTagCompound var1, NBTTagCompound var2) {
      NBTTagCompound ☃ = new NBTTagCompound();
      ☃.func_74778_a("Name", "1.13.2");
      ☃.func_74768_a("Id", 1631);
      ☃.func_74757_a("Snapshot", false);
      ☃.func_74782_a("Version", ☃);
      ☃.func_74768_a("DataVersion", 1631);
      ☃.func_74772_a("RandomSeed", this.field_76100_a);
      ☃.func_74778_a("generatorName", this.field_76098_b.func_211889_b());
      ☃.func_74768_a("generatorVersion", this.field_76098_b.func_77131_c());
      if (!this.field_82576_c.isEmpty()) {
         ☃.func_74782_a("generatorOptions", this.field_82576_c);
      }

      if (this.field_211931_h != null) {
         ☃.func_74778_a("legacy_custom_options", this.field_211931_h);
      }

      ☃.func_74768_a("GameType", this.field_76113_q.func_77148_a());
      ☃.func_74757_a("MapFeatures", this.field_76112_r);
      ☃.func_74768_a("SpawnX", this.field_76099_c);
      ☃.func_74768_a("SpawnY", this.field_76096_d);
      ☃.func_74768_a("SpawnZ", this.field_76097_e);
      ☃.func_74772_a("Time", this.field_82575_g);
      ☃.func_74772_a("DayTime", this.field_76094_f);
      ☃.func_74772_a("SizeOnDisk", this.field_76107_h);
      ☃.func_74772_a("LastPlayed", Util.func_211179_d());
      ☃.func_74778_a("LevelName", this.field_76106_k);
      ☃.func_74768_a("version", this.field_76103_l);
      ☃.func_74768_a("clearWeatherTime", this.field_176157_p);
      ☃.func_74768_a("rainTime", this.field_76101_n);
      ☃.func_74757_a("raining", this.field_76104_m);
      ☃.func_74768_a("thunderTime", this.field_76114_p);
      ☃.func_74757_a("thundering", this.field_76102_o);
      ☃.func_74757_a("hardcore", this.field_76111_s);
      ☃.func_74757_a("allowCommands", this.field_76110_t);
      ☃.func_74757_a("initialized", this.field_76109_u);
      ☃.func_74780_a("BorderCenterX", this.field_176151_B);
      ☃.func_74780_a("BorderCenterZ", this.field_176152_C);
      ☃.func_74780_a("BorderSize", this.field_176146_D);
      ☃.func_74772_a("BorderSizeLerpTime", this.field_176147_E);
      ☃.func_74780_a("BorderSafeZone", this.field_176149_G);
      ☃.func_74780_a("BorderDamagePerBlock", this.field_176153_H);
      ☃.func_74780_a("BorderSizeLerpTarget", this.field_176148_F);
      ☃.func_74780_a("BorderWarningBlocks", (double)this.field_176154_I);
      ☃.func_74780_a("BorderWarningTime", (double)this.field_176155_J);
      if (this.field_176158_z != null) {
         ☃.func_74774_a("Difficulty", (byte)this.field_176158_z.func_151525_a());
      }

      ☃.func_74757_a("DifficultyLocked", this.field_176150_A);
      ☃.func_74782_a("GameRules", this.field_82577_x.func_82770_a());
      NBTTagCompound ☃ = new NBTTagCompound();

      for(Entry<DimensionType, NBTTagCompound> ☃x : this.field_186348_N.entrySet()) {
         ☃.func_74782_a(String.valueOf(((DimensionType)☃x.getKey()).func_186068_a()), (INBTBase)☃x.getValue());
      }

      ☃.func_74782_a("DimensionData", ☃);
      if (☃ != null) {
         ☃.func_74782_a("Player", ☃);
      }
      ...
      for(String ☃xxx : this.field_197722_O) {
         ☃xx.add((INBTBase)(new NBTTagString(☃xxx)));
      }

      ☃x.func_74782_a("Enabled", ☃xx);
      NBTTagList ☃xxx = new NBTTagList();

      for(String ☃xxxx : this.field_197721_N) {
         ☃xxx.add((INBTBase)(new NBTTagString(☃xxxx)));
      }

      ☃x.func_74782_a("Disabled", ☃xxx);
      ☃.func_74782_a("DataPacks", ☃x);
      if (this.field_201358_Q != null) {
         ☃.func_74782_a("CustomBossEvents", this.field_201358_Q);
      }
   }
   ...
   public void func_176143_a(BlockPos var1) {
      this.field_76099_c = ☃.func_177958_n();
      this.field_76096_d = ☃.func_177956_o();
      this.field_76097_e = ☃.func_177952_p();
   }
   ...
   public void func_85118_a(CrashReportCategory var1) {
      ☃.func_189529_a("Level seed", () -> String.valueOf(this.func_76063_b()));
      ☃.func_189529_a(
         "Level generator",
         () -> String.format(
               "ID %02d - %s, ver %d. Features enabled: %b",
               this.field_76098_b.func_82747_f(),
               this.field_76098_b.func_211888_a(),
               this.field_76098_b.func_77131_c(),
               this.field_76112_r
            )
      );
      ☃.func_189529_a("Level generator options", () -> this.field_82576_c.toString());
      ☃.func_189529_a("Level spawn location", () -> CrashReportCategory.func_184876_a(this.field_76099_c, this.field_76096_d, this.field_76097_e));
      ☃.func_189529_a("Level time", () -> String.format("%d game time, %d day time", this.field_82575_g, this.field_76094_f));
      ☃.func_189529_a("Level dimension", () -> String.valueOf(this.field_76105_j));
      ☃.func_189529_a("Level storage version", () -> {
         String ☃ = "Unknown?";
         ...
         return String.format("0x%05X - %s", this.field_76103_l, ☃);
      });
      ☃.func_189529_a(
         "Level weather",
         () -> String.format(
               "Rain time: %d (now: %b), thunder time: %d (now: %b)", this.field_76101_n, this.field_76104_m, this.field_76114_p, this.field_76102_o
            )
      );
      ☃.func_189529_a(
         "Level game mode",
         () -> String.format(
               ...
               this.field_76113_q.func_77149_b(),
               this.field_76113_q.func_77148_a(),
               this.field_76111_s,
               this.field_76110_t
            )
      );
