...
public class AnvilSaveConverter extends SaveFormatOld {
   ...
   public List<WorldSummary> func_75799_b() throws AnvilConverterException {
      if (!Files.isDirectory(this.field_75808_a, new LinkOption[0])) {
         ...
         File[] ☃x = this.field_75808_a.toFile().listFiles();

         for(File ☃xx : ☃x) {
            if (☃xx.isDirectory()) {
               String ☃xxx = ☃xx.getName();
               WorldInfo ☃xxxx = this.func_75803_c(☃xxx);
               if (☃xxxx != null && (☃xxxx.func_76088_k() == 19132 || ☃xxxx.func_76088_k() == 19133)) {
                  boolean ☃xxxxx = ☃xxxx.func_76088_k() != this.func_75812_c();
                  String ☃xxxxxx = ☃xxxx.func_76065_j();
   ...
   public boolean func_207743_a(String var1) {
      ...
      return ☃ != null && ☃.func_76088_k() == 19132;
   }
