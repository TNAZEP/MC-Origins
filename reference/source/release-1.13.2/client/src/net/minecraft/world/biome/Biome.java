...
public abstract class Biome {
   ...
   public static final Set<Biome> field_201870_ab = Sets.<Biome>newHashSet();
   ...
   protected final List<CompositeFlowerFeature<?>> field_201873_ai = Lists.<CompositeFlowerFeature<?>>newArrayList();
   protected final Map<Structure<?>, IFeatureConfig> field_201874_aj = Maps.<Structure<?>, IFeatureConfig>newHashMap();
   ...
   public static Biome func_185356_b(Biome var0) {
      return field_185373_j.func_148745_a(IRegistry.field_212624_m.func_148757_b(☃));
   }

   public static <C extends IFeatureConfig> WorldCarverWrapper<C> func_203606_a(IWorldCarver<C> var0, C var1) {
      return new WorldCarverWrapper<>(☃, ☃);
   }

   public static <F extends IFeatureConfig, D extends IPlacementConfig> CompositeFeature<F, D> func_201864_a(
      Feature<F> var0, F var1, BasePlacement<D> var2, D var3
   ) {
      return new CompositeFeature<>(☃, ☃, ☃, ☃);
   }
   ...
   public static <D extends IPlacementConfig> CompositeFlowerFeature<D> func_201861_a(AbstractFlowersFeature var0, BasePlacement<D> var1, D var2) {
      return new CompositeFlowerFeature<>(☃, ☃, ☃);
   }

   protected Biome(Biome.BiomeBuilder var1) {
      if (☃.field_205422_a != null
         && ☃.field_205423_b != null
         && ☃.field_205424_c != null
         && ☃.field_205425_d != null
         && ☃.field_205426_e != null
         ...
         && ☃.field_205429_h != null
         && ☃.field_205430_i != null) {
         this.field_201875_ar = ☃.field_205422_a;
         this.field_201878_av = ☃.field_205423_b;
         this.field_201877_au = ☃.field_205424_c;
         this.field_76748_D = ☃.field_205425_d;
         this.field_76749_E = ☃.field_205426_e;
         this.field_76750_F = ☃.field_205427_f;
         this.field_76751_G = ☃.field_205428_g;
         this.field_76759_H = ☃.field_205429_h;
         this.field_204275_aE = ☃.field_205430_i;
         this.field_185364_H = ☃.field_205431_j;

         for(GenerationStage.Decoration ☃ : GenerationStage.Decoration.values()) {
            this.field_201872_ah.put(☃, Lists.newArrayList());
         }

         for(EnumCreatureType ☃ : EnumCreatureType.values()) {
            this.field_201880_ax.put(☃, Lists.newArrayList());
         }
      } else {
   ...
   protected void func_203605_a() {
      this.func_203611_a(
         ...
         func_201864_a(Feature.field_202329_g, new MineshaftConfig(0.004F, MineshaftStructure.Type.NORMAL), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.SURFACE_STRUCTURES,
         func_201864_a(Feature.field_202328_f, new VillageConfig(0, VillagePieces.Type.OAK), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.UNDERGROUND_STRUCTURES,
         func_201864_a(Feature.field_202335_m, new StrongholdConfig(), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.SURFACE_STRUCTURES,
         func_201864_a(Feature.field_202334_l, new SwampHutConfig(), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.SURFACE_STRUCTURES,
         func_201864_a(Feature.field_202332_j, new DesertPyramidConfig(), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.SURFACE_STRUCTURES,
         func_201864_a(Feature.field_202331_i, new JunglePyramidConfig(), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.SURFACE_STRUCTURES,
         func_201864_a(Feature.field_202333_k, new IglooConfig(), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.SURFACE_STRUCTURES,
         func_201864_a(Feature.field_204751_l, new ShipwreckConfig(false), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.SURFACE_STRUCTURES,
         func_201864_a(Feature.field_202336_n, new OceanMonumentConfig(), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.SURFACE_STRUCTURES,
         func_201864_a(Feature.field_202330_h, new WoodlandMansionConfig(), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.SURFACE_STRUCTURES,
         func_201864_a(Feature.field_204029_o, new OceanRuinConfig(OceanRuinStructure.Type.COLD, 0.3F, 0.9F), field_201917_l, IPlacementConfig.field_202468_e)
      );
      this.func_203611_a(
         GenerationStage.Decoration.UNDERGROUND_STRUCTURES,
         func_201864_a(Feature.field_204292_r, new BuriedTreasureConfig(0.01F), field_201917_l, IPlacementConfig.field_202468_e)
      );
   }
   ...
   public int func_76731_a(float var1) {
      ☃ /= 3.0F;
      ☃ = MathHelper.func_76131_a(☃, -1.0F, 1.0F);
      return MathHelper.func_181758_c(0.62222224F - ☃ * 0.05F, 0.5F + ☃ * 0.1F, 1.0F);
   }

   protected void func_201866_a(EnumCreatureType var1, Biome.SpawnListEntry var2) {
      ((List)this.field_201880_ax.get(☃)).add(☃);
   }

   public List<Biome.SpawnListEntry> func_76747_a(EnumCreatureType var1) {
      return (List<Biome.SpawnListEntry>)this.field_201880_ax.get(☃);
   }
   ...
   public float func_180626_a(BlockPos var1) {
      if (☃.func_177956_o() > 64) {
         float ☃ = (float)(field_150605_ac.func_151601_a((double)((float)☃.func_177958_n() / 8.0F), (double)((float)☃.func_177952_p() / 8.0F)) * 4.0);
         return this.func_185353_n() - (☃ + (float)☃.func_177956_o() - 64.0F) * 0.05F / 30.0F;
      } else {
   ...
   public boolean func_201848_a(IWorldReaderBase var1, BlockPos var2) {
      return this.func_201854_a(☃, ☃, true);
   }

   public boolean func_201854_a(IWorldReaderBase var1, BlockPos var2, boolean var3) {
      if (this.func_180626_a(☃) >= 0.15F) {
         return false;
      } else {
         if (☃.func_177956_o() >= 0 && ☃.func_177956_o() < 256 && ☃.func_175642_b(EnumLightType.BLOCK, ☃) < 10) {
            IBlockState ☃ = ☃.func_180495_p(☃);
            IFluidState ☃x = ☃.func_204610_c(☃);
            if (☃x.func_206886_c() == Fluids.field_204546_a && ☃.func_177230_c() instanceof BlockFlowingFluid) {
               if (!☃) {
                  return true;
               }

               boolean ☃xx = ☃.func_201671_F(☃.func_177976_e())
                  && ☃.func_201671_F(☃.func_177974_f())
                  && ☃.func_201671_F(☃.func_177978_c())
                  && ☃.func_201671_F(☃.func_177968_d());
               if (!☃xx) {
                  return true;
               }
            }
   ...
   public boolean func_201850_b(IWorldReaderBase var1, BlockPos var2) {
      if (this.func_180626_a(☃) >= 0.15F) {
         ...
         if (☃.func_177956_o() >= 0 && ☃.func_177956_o() < 256 && ☃.func_175642_b(EnumLightType.BLOCK, ☃) < 10) {
            IBlockState ☃ = ☃.func_180495_p(☃);
            if (☃.func_196958_f() && Blocks.field_150433_aE.func_176223_P().func_196955_c(☃, ☃)) {
               return true;
            }
         }
   ...
   public List<CompositeFeature<?, ?>> func_203607_a(GenerationStage.Decoration var1) {
      return (List<CompositeFeature<?, ?>>)this.field_201872_ah.get(☃);
   }

   public void func_203608_a(
      GenerationStage.Decoration var1, IChunkGenerator<? extends IChunkGenSettings> var2, IWorld var3, long var4, SharedSeedRandom var6, BlockPos var7
   ) {
      int ☃ = 0;

      for(CompositeFeature<?, ?> ☃x : (List)this.field_201872_ah.get(☃)) {
         ☃.func_202426_b(☃, ☃, ☃.ordinal());
         ☃x.func_212245_a(☃, ☃, ☃, ☃, IFeatureConfig.field_202429_e);
         ++☃;
      }
   }

   public int func_180627_b(BlockPos var1) {
      double ☃ = (double)MathHelper.func_76131_a(this.func_180626_a(☃), 0.0F, 1.0F);
      double ☃x = (double)MathHelper.func_76131_a(this.func_76727_i(), 0.0F, 1.0F);
      return GrassColors.func_77480_a(☃, ☃x);
   }

   public int func_180625_c(BlockPos var1) {
      double ☃ = (double)MathHelper.func_76131_a(this.func_180626_a(☃), 0.0F, 1.0F);
      double ☃x = (double)MathHelper.func_76131_a(this.func_76727_i(), 0.0F, 1.0F);
      return FoliageColors.func_77470_a(☃, ☃x);
   }
   ...
   public void func_206854_a(Random var1, IChunk var2, int var3, int var4, int var5, double var6, IBlockState var8, IBlockState var9, int var10, long var11) {
      this.field_201875_ar.func_205548_a(☃);
      this.field_201875_ar.func_205610_a_(☃, ☃, this, ☃, ☃, ☃, ☃, ☃, ☃, ☃, ☃, field_205408_ag);
   }

   public Biome.TempCategory func_150561_m() {
      if (this.field_201877_au == Biome.Category.OCEAN) {
         return Biome.TempCategory.OCEAN;
      } else if ((double)this.func_185353_n() < 0.2) {
         return Biome.TempCategory.COLD;
      } else {
         return (double)this.func_185353_n() < 1.0 ? Biome.TempCategory.MEDIUM : Biome.TempCategory.WARM;
      }
   }
   ...
   public ITextComponent func_205403_k() {
      return new TextComponentTranslation(this.func_210773_k());
   }
   ...
   private static void func_185354_a(int var0, String var1, Biome var2) {
      IRegistry.field_212624_m.func_177775_a(☃, new ResourceLocation(☃), ☃);
      if (☃.func_185363_b()) {
         field_185373_j.func_148746_a(☃, IRegistry.field_212624_m.func_148757_b(IRegistry.field_212624_m.func_212608_b(new ResourceLocation(☃.field_185364_H))));
      }
   }
