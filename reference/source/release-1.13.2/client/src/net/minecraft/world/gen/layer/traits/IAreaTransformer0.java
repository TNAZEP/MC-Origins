...
public interface IAreaTransformer0 {
   default <R extends IArea> IAreaFactory<R> func_202823_a(IContextExtended<R> var1) {
      return var2 -> ☃.func_201490_a_(var2, (var3, var4) -> {
            ☃.func_202698_a((long)(var3 + var2.func_202690_a()), (long)(var4 + var2.func_202691_b()));
            return this.func_202821_a(☃, var2, var3, var4);
         });
   }
