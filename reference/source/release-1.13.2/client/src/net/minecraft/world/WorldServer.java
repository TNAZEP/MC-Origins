...
public class WorldServer extends World implements IThreadListener {
   ...
   public void func_72974_f() {
      ...
      int ☃ = this.field_72986_A.func_76079_c();
      int ☃x = this.field_72986_A.func_76074_e();
      int ☃xx = 0;

      while(this.func_184141_c(new BlockPos(☃, 0, ☃x)).func_196958_f()) {
         ☃ += this.field_73012_v.nextInt(8) - this.field_73012_v.nextInt(8);
         ☃x += this.field_73012_v.nextInt(8) - this.field_73012_v.nextInt(8);
         if (++☃xx == 10000) {
            break;
         }
      }

      this.field_72986_A.func_76058_a(☃);
      this.field_72986_A.func_76087_c(☃x);
   }
