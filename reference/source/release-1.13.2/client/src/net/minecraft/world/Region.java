...
public class Region implements IWorldReader {
   ...
   public int func_175626_b(BlockPos var1, int var2) {
      int ☃ = this.func_175629_a(EnumLightType.SKY, ☃);
      int ☃x = this.func_175629_a(EnumLightType.BLOCK, ☃);
      if (☃x < ☃) {
         ☃x = ☃;
      }
   ...
   private int func_175629_a(EnumLightType var1, BlockPos var2) {
      if (☃ == EnumLightType.SKY && !this.field_72815_e.func_201675_m().func_191066_m()) {
         return 0;
         ...
         if (this.func_180495_p(☃).func_200130_c(this, ☃)) {
            ...
            for(EnumFacing ☃x : EnumFacing.values()) {
               int ☃xx = this.func_175642_b(☃, ☃.func_177972_a(☃x));
               if (☃xx > ☃) {
                  ☃ = ☃xx;
               }
