...
public enum EnumDifficulty {
   ...
   private static final EnumDifficulty[] field_151530_e = (EnumDifficulty[])Arrays.stream(values())
      .sorted(Comparator.comparingInt(EnumDifficulty::func_151525_a))
      .toArray(var0 -> new EnumDifficulty[var0]);
   ...
   public ITextComponent func_199285_b() {
      return new TextComponentTranslation("options.difficulty." + this.field_151528_g);
   }

   public static EnumDifficulty func_151523_a(int var0) {
      return field_151530_e[☃ % field_151530_e.length];
   }
