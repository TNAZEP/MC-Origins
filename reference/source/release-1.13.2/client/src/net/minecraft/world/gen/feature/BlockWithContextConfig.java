...
public class BlockWithContextConfig implements IFeatureConfig {
   ...
   public BlockWithContextConfig(IBlockState var1, IBlockState[] var2, IBlockState[] var3, IBlockState[] var4) {
      this.field_206924_a = ☃;
      this.field_206925_b = Lists.<IBlockState>newArrayList(☃);
      this.field_206926_c = Lists.<IBlockState>newArrayList(☃);
      this.field_206927_d = Lists.<IBlockState>newArrayList(☃);
   }
}
