...
public class DimensionType {
   ...
   private static DimensionType func_212677_a(String var0, DimensionType var1) {
      IRegistry.field_212622_k.func_177775_a(☃.field_186074_d, new ResourceLocation(☃), ☃);
      return ☃;
   }
   ...
   public File func_212679_a(File var1) {
      return this.field_212682_f.isEmpty() ? ☃ : new File(☃, this.field_212682_f);
   }
   ...
   public static DimensionType func_186069_a(int var0) {
      return IRegistry.field_212622_k.func_148754_a(☃ - -1);
   }

   @Nullable
   public static DimensionType func_193417_a(ResourceLocation var0) {
      return IRegistry.field_212622_k.func_212608_b(☃);
   }

   @Nullable
   public static ResourceLocation func_212678_a(DimensionType var0) {
      return IRegistry.field_212622_k.func_177774_c(☃);
   }
}
