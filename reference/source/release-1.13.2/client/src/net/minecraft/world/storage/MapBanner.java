...
public class MapBanner {
   ...
   public static MapBanner func_204300_a(NBTTagCompound var0) {
      ...
      EnumDyeColor ☃x = EnumDyeColor.func_204271_a(☃.func_74779_i("Color"));
      ITextComponent ☃xx = ☃.func_74764_b("Name") ? ITextComponent.Serializer.func_150699_a(☃.func_74779_i("Name")) : null;
      return new MapBanner(☃, ☃x, ☃xx);
   }
   ...
   public static MapBanner func_204301_a(IBlockReader var0, BlockPos var1) {
      ...
      if (☃ instanceof TileEntityBanner) {
         TileEntityBanner ☃x = (TileEntityBanner)☃;
         EnumDyeColor ☃xx = ☃x.func_195533_l(() -> ☃.func_180495_p(☃));
         ITextComponent ☃xxx = ☃x.func_145818_k_() ? ☃x.func_200201_e() : null;
         return new MapBanner(☃, ☃xx, ☃xxx);
      } else {
         return null;
      }
   }
   ...
   public boolean equals(Object var1) {
      if (this == ☃) {
         ...
         MapBanner ☃ = (MapBanner)☃;
         return Objects.equals(this.field_204306_a, ☃.field_204306_a)
            && this.field_204307_b == ☃.field_204307_b
            && Objects.equals(this.field_204308_c, ☃.field_204308_c);
      } else {
         return false;
      }
   }
   ...
   public NBTTagCompound func_204303_e() {
      ...
      ☃.func_74782_a("Pos", NBTUtil.func_186859_a(this.field_204306_a));
      ☃.func_74778_a("Color", this.field_204307_b.func_176762_d());
      if (this.field_204308_c != null) {
         ☃.func_74778_a("Name", ITextComponent.Serializer.func_150696_a(this.field_204308_c));
      }
