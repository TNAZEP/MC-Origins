...
public abstract class BiomeProvider implements ITickable {
   private static final List<Biome> field_201540_a = Lists.<Biome>newArrayList(
   ...
   protected final Set<IBlockState> field_205707_b = Sets.<IBlockState>newHashSet();
   ...
   public Biome[] func_201539_b(int var1, int var2, int var3, int var4) {
      return this.func_201537_a(☃, ☃, ☃, ☃, true);
   }
