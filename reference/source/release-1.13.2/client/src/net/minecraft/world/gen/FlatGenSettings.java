...
public class FlatGenSettings extends ChunkGenSettings {
   ...
   private static FlatLayerInfo func_197526_a(String var0, int var1) {
      ...
      if (☃x.length == 2) {
         try {
            ☃ = MathHelper.func_76125_a(Integer.parseInt(☃x[0]), 0, 256 - ☃);
      ...
      if (☃ == null) {
         field_211404_q.error("Error while parsing flat world string => Unknown block, {}", ☃x[☃x.length - 1]);
         return null;
      } else {
         FlatLayerInfo ☃ = new FlatLayerInfo(☃, ☃);
         ☃.func_82660_d(☃);
         return ☃;
      }
   }
   ...
   private static List<FlatLayerInfo> func_197527_b(String var0) {
      List<FlatLayerInfo> ☃ = Lists.<FlatLayerInfo>newArrayList();
      String[] ☃x = ☃.split(",");
      int ☃xx = 0;

      for(String ☃xxx : ☃x) {
         FlatLayerInfo ☃xxxx = func_197526_a(☃xxx, ☃xx);
         if (☃xxxx == null) {
            return Collections.emptyList();
         }

         ☃.add(☃xxxx);
         ☃xx += ☃xxxx.func_82657_a();
      }
         ...
         this.field_82655_a
            ...
            .map(
               var1x -> ☃.createMap(
                     ImmutableMap.of(
                        ☃.createString("height"),
                        ☃.createInt(var1x.func_82657_a()),
                        ☃.createString("block"),
                        ☃.createString(IRegistry.field_212618_g.func_177774_c(var1x.func_175900_c().func_177230_c()).toString())
                     )
                  )
            )
      );
      T ☃x = ☃.createMap(
         (Map<T, T>)this.field_82653_b
            .entrySet()
            .stream()
            .map(
               var1x -> Pair.of(
      ...
      return new Dynamic<>(
         ...
         ☃.createMap(
            ImmutableMap.of(
               ...
               ☃,
               ☃.createString("biome"),
               ☃.createString(IRegistry.field_212624_m.func_177774_c(this.field_82654_c).toString()),
               ☃.createString("structures"),
               ☃x
            )
         )
      );
   ...
   public static FlatGenSettings func_82651_a(String var0) {
      Iterator<String> ☃ = Splitter.on(';').split(☃).iterator();
      if (!☃.hasNext()) {
         return func_82649_e();
      } else {
         FlatGenSettings ☃ = ChunkGeneratorType.field_205489_f.func_205483_a();
         List<FlatLayerInfo> ☃x = func_197527_b((String)☃.next());
         if (☃x.isEmpty()) {
            return func_82649_e();
         } else {
            ☃.func_82650_c().addAll(☃x);
            ☃.func_82645_d();
            Biome ☃ = ☃.hasNext() ? IRegistry.field_212624_m.func_212608_b(new ResourceLocation((String)☃.next())) : null;
            ☃.func_82647_a(☃ == null ? Biomes.field_76772_c : ☃);
            if (☃.hasNext()) {
               String[] ☃x = ((String)☃.next()).toLowerCase(Locale.ROOT).split(",");

               for(String ☃xx : ☃x) {
                  String[] ☃xxx = ☃xx.split("\\(", 2);
                  if (!☃xxx[0].isEmpty()) {
                     ☃.func_202234_c(☃xxx[0]);
                     if (☃xxx.length > 1 && ☃xxx[1].endsWith(")") && ☃xxx[1].length() > 1) {
                        String[] ☃xxxx = ☃xxx[1].substring(0, ☃xxx[1].length() - 1).split(" ");

                        for(String ☃xxxxx : ☃xxxx) {
                           String[] ☃xxxxxx = ☃xxxxx.split("=", 2);
                           if (☃xxxxxx.length == 2) {
                              ☃.func_202229_a(☃xxx[0], ☃xxxxxx[0], ☃xxxxxx[1]);
                           }
                        }
                     }
                  }
   ...
   private void func_202234_c(String var1) {
      ...
      this.field_82653_b.put(☃, ☃);
   }

   private void func_202229_a(String var1, String var2, String var3) {
      ((Map)this.field_82653_b.get(☃)).put(☃, ☃);
      if ("village".equals(☃) && "distance".equals(☃)) {
         this.field_202180_a = MathHelper.func_82714_a(☃, this.field_202180_a, 9);
      }

      if ("biome_1".equals(☃) && "distance".equals(☃)) {
         this.field_202186_g = MathHelper.func_82714_a(☃, this.field_202186_g, 9);
      }

      if ("stronghold".equals(☃)) {
         if ("distance".equals(☃)) {
            this.field_202183_d = MathHelper.func_82714_a(☃, this.field_202183_d, 1);
         } else if ("count".equals(☃)) {
            this.field_202184_e = MathHelper.func_82714_a(☃, this.field_202184_e, 1);
         } else if ("spread".equals(☃)) {
            this.field_202185_f = MathHelper.func_82714_a(☃, this.field_202185_f, 1);
         }
      }

      if ("oceanmonument".equals(☃)) {
         if ("separation".equals(☃)) {
            this.field_202182_c = MathHelper.func_82714_a(☃, this.field_202182_c, 1);
         } else if ("spacing".equals(☃)) {
            this.field_202181_b = MathHelper.func_82714_a(☃, this.field_202181_b, 1);
         }
      }

      if ("endcity".equals(☃) && "distance".equals(☃)) {
         this.field_202187_h = MathHelper.func_82714_a(☃, this.field_202187_h, 1);
      }

      if ("mansion".equals(☃) && "distance".equals(☃)) {
         this.field_202188_i = MathHelper.func_82714_a(☃, this.field_202188_i, 1);
      }
   }
