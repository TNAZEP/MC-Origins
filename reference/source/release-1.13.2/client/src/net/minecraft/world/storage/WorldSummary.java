...
public class WorldSummary implements Comparable<WorldSummary> {
   ...
   public WorldSummary(WorldInfo var1, String var2, String var3, long var4, boolean var6) {
      this.field_75797_a = ☃;
      this.field_75795_b = ☃;
      this.field_75796_c = ☃.func_76057_l();
      this.field_75793_d = ☃;
      this.field_75791_f = ☃.func_76077_q();
      this.field_75794_e = ☃;
      this.field_75792_g = ☃.func_76093_s();
      this.field_75798_h = ☃.func_76086_u();
      this.field_186358_i = ☃.func_186346_M();
      this.field_186359_j = ☃.func_186344_K();
      this.field_186360_k = ☃.func_186343_L();
      this.field_202843_l = ☃.func_76067_t();
   }
   ...
   public int compareTo(WorldSummary var1) {
      if (this.field_75796_c < ☃.field_75796_c) {
         return 1;
      } else {
         return this.field_75796_c > ☃.field_75796_c ? -1 : this.field_75797_a.compareTo(☃.field_75797_a);
      }
   }
   ...
   public ITextComponent func_200538_i() {
      return (ITextComponent)(StringUtils.func_151246_b(this.field_186358_i)
         ? new TextComponentTranslation("selectWorld.versionUnknown")
         : new TextComponentString(this.field_186358_i));
   }
