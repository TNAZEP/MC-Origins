...
public class SPacketMaps implements Packet<INetHandlerPlayClient> {
   ...
   public void func_179734_a(MapData var1) {
      ☃.field_76197_d = this.field_179739_b;
      ☃.field_186210_e = this.field_186950_c;
      ☃.field_76203_h.clear();

      for(int ☃ = 0; ☃ < this.field_179740_c.length; ++☃) {
         MapDecoration ☃x = this.field_179740_c[☃];
         ☃.field_76203_h.put("icon-" + ☃, ☃x);
      }

      for(int ☃ = 0; ☃ < this.field_179735_f; ++☃) {
         for(int ☃x = 0; ☃x < this.field_179736_g; ++☃x) {
            ☃.field_76198_e[this.field_179737_d + ☃ + (this.field_179738_e + ☃x) * 128] = this.field_179741_h[☃ + ☃x * this.field_179735_f];
         }
      }
   }
}
