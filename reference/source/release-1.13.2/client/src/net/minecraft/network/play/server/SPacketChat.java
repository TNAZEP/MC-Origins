...
public class SPacketChat implements Packet<INetHandlerPlayClient> {
   ...
   public void func_148837_a(PacketBuffer var1) throws IOException {
      this.field_148919_a = ☃.func_179258_d();
      this.field_179842_b = ChatType.func_192582_a(☃.readByte());
   }

   @Override
   public void func_148840_b(PacketBuffer var1) throws IOException {
      ☃.func_179256_a(this.field_148919_a);
      ☃.writeByte(this.field_179842_b.func_192583_a());
   }
