...
public class SPacketScoreboardObjective implements Packet<INetHandlerPlayClient> {
   ...
   public SPacketScoreboardObjective(ScoreObjective var1, int var2) {
      this.field_149343_a = ☃.func_96679_b();
      this.field_149341_b = ☃.func_96678_d();
      this.field_199857_c = ☃.func_199865_f();
      this.field_149342_c = ☃;
   }

   @Override
   public void func_148837_a(PacketBuffer var1) throws IOException {
      this.field_149343_a = ☃.func_150789_c(16);
      this.field_149342_c = ☃.readByte();
      if (this.field_149342_c == 0 || this.field_149342_c == 2) {
         this.field_149341_b = ☃.func_179258_d();
         this.field_199857_c = ☃.func_179257_a(ScoreCriteria.RenderType.class);
      }
   }

   @Override
   public void func_148840_b(PacketBuffer var1) throws IOException {
      ☃.func_180714_a(this.field_149343_a);
      ☃.writeByte(this.field_149342_c);
      if (this.field_149342_c == 0 || this.field_149342_c == 2) {
         ☃.func_179256_a(this.field_149341_b);
         ☃.func_179249_a(this.field_199857_c);
      }
   }
