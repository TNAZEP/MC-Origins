...
public class SPacketWorldBorder implements Packet<INetHandlerPlayClient> {
   ...
   public void func_179788_a(WorldBorder var1) {
      switch(this.field_179795_a) {
         case SET_SIZE:
            ☃.func_177750_a(this.field_179792_e);
            break;
         case LERP_SIZE:
            ☃.func_177738_a(this.field_179789_f, this.field_179792_e, this.field_179790_g);
            break;
         case SET_CENTER:
            ☃.func_177739_c(this.field_179794_c, this.field_179791_d);
            break;
         case SET_WARNING_BLOCKS:
            ☃.func_177747_c(this.field_179797_i);
            break;
         case SET_WARNING_TIME:
            ☃.func_177723_b(this.field_179796_h);
            break;
         case INITIALIZE:
            ☃.func_177739_c(this.field_179794_c, this.field_179791_d);
            ...
            ☃.func_177725_a(this.field_179793_b);
            ☃.func_177747_c(this.field_179797_i);
            ☃.func_177723_b(this.field_179796_h);
      }
   }
