...
public class CPacketEntityAction implements Packet<INetHandlerPlayServer> {
   ...
   public CPacketEntityAction(Entity var1, CPacketEntityAction.Action var2, int var3) {
      this.field_149517_a = ☃.func_145782_y();
      this.field_149515_b = ☃;
      this.field_149516_c = ☃;
   }
   ...
   public void func_148837_a(PacketBuffer var1) throws IOException {
      this.field_149517_a = ☃.func_150792_a();
      this.field_149515_b = ☃.func_179257_a(CPacketEntityAction.Action.class);
      this.field_149516_c = ☃.func_150792_a();
   }

   @Override
   public void func_148840_b(PacketBuffer var1) throws IOException {
      ☃.func_150787_b(this.field_149517_a);
      ☃.func_179249_a(this.field_149515_b);
      ☃.func_150787_b(this.field_149516_c);
   }
