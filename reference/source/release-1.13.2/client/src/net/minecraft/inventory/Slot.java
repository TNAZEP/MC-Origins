...
public class Slot {
   ...
   public void func_75220_a(ItemStack var1, ItemStack var2) {
      int ☃ = ☃.func_190916_E() - ☃.func_190916_E();
      if (☃ > 0) {
         this.func_75210_a(☃, ☃);
      }
   }
   ...
   public void func_75215_d(ItemStack var1) {
      this.field_75224_c.func_70299_a(this.field_75225_a, ☃);
      this.func_75218_e();
   }
   ...
   public ItemStack func_75209_a(int var1) {
      return this.field_75224_c.func_70298_a(this.field_75225_a, ☃);
   }

   public boolean func_75217_a(IInventory var1, int var2) {
      return ☃ == this.field_75224_c && ☃ == this.field_75225_a;
   }
