...
public class GameRules {
   private static final TreeMap<String, GameRules.ValueDefinition> field_196232_a = Util.func_200696_a(new TreeMap(), var0 -> {
      ...
      var0.put("reducedDebugInfo", new GameRules.ValueDefinition("false", GameRules.ValueType.BOOLEAN_VALUE, (var0x, var1) -> {
         byte ☃ = (byte)(var1.func_82758_b() ? 22 : 23);

         for(EntityPlayerMP ☃x : var0x.func_184103_al().func_181057_v()) {
            ☃x.field_71135_a.func_147359_a(new SPacketEntityStatus(☃x, ☃));
         }
      }));
   ...
   public GameRules() {
      for(Entry<String, GameRules.ValueDefinition> ☃ : field_196232_a.entrySet()) {
         this.field_82771_a.put(☃.getKey(), ((GameRules.ValueDefinition)☃.getValue()).func_199595_a());
      }
   }

   public void func_82764_b(String var1, String var2, @Nullable MinecraftServer var3) {
      GameRules.Value ☃ = (GameRules.Value)this.field_82771_a.get(☃);
      if (☃ != null) {
         ☃.func_201200_a(☃, ☃);
      }
   }
   ...
   public boolean func_82766_b(String var1) {
      GameRules.Value ☃ = (GameRules.Value)this.field_82771_a.get(☃);
      return ☃ != null ? ☃.func_82758_b() : false;
   }

   public int func_180263_c(String var1) {
      GameRules.Value ☃ = (GameRules.Value)this.field_82771_a.get(☃);
      return ☃ != null ? ☃.func_180255_c() : 0;
   }

   public NBTTagCompound func_82770_a() {
      NBTTagCompound ☃ = new NBTTagCompound();

      for(String ☃x : this.field_82771_a.keySet()) {
         GameRules.Value ☃xx = (GameRules.Value)this.field_82771_a.get(☃x);
         ☃.func_74778_a(☃x, ☃xx.func_82756_a());
      }
   ...
   public void func_82768_a(NBTTagCompound var1) {
      for(String ☃ : ☃.func_150296_c()) {
         this.func_82764_b(☃, ☃.func_74779_i(☃), null);
      }
   }

   public GameRules.Value func_196230_f(String var1) {
      return (GameRules.Value)this.field_82771_a.get(☃);
   }
   ...
   public static class Value {
      ...
      public Value(String var1, GameRules.ValueType var2, BiConsumer<MinecraftServer, GameRules.Value> var3) {
         this.field_180256_e = ☃;
         this.field_201201_f = ☃;
         this.func_201200_a(☃, null);
      }

      public void func_201200_a(String var1, @Nullable MinecraftServer var2) {
         this.field_82762_a = ☃;
         this.field_82760_b = Boolean.parseBoolean(☃);
         this.field_82761_c = this.field_82760_b ? 1 : 0;

         try {
            this.field_82761_c = Integer.parseInt(☃);
         } catch (NumberFormatException var5) {
         }

         try {
            this.field_82759_d = Double.parseDouble(☃);
         } catch (NumberFormatException var4) {
         }

         if (☃ != null) {
            this.field_201201_f.accept(☃, this);
         }
      }
   ...
   public static enum ValueType {
      ANY_VALUE(StringArgumentType::greedyString, (var0, var1) -> var0.getArgument(var1, String.class)),
      BOOLEAN_VALUE(BoolArgumentType::bool, (var0, var1) -> ((Boolean)var0.getArgument(var1, Boolean.class)).toString()),
      NUMERICAL_VALUE(IntegerArgumentType::integer, (var0, var1) -> ((Integer)var0.getArgument(var1, Integer.class)).toString());
      ...
      public RequiredArgumentBuilder<CommandSource, ?> func_199809_a(String var1) {
         return Commands.func_197056_a(☃, (ArgumentType)this.field_196228_e.get());
      }

      public void func_196222_a(CommandContext<CommandSource> var1, String var2, GameRules.Value var3) {
         ☃.func_201200_a((String)this.field_196229_f.apply(☃, ☃), ☃.getSource().func_197028_i());
      }
   }
}
