...
public enum ItemTier implements IItemTier {
   WOOD(0, 59, 2.0F, 0.0F, 15, () -> Ingredient.func_199805_a(ItemTags.field_199905_b)),
   STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.func_199804_a(Blocks.field_150347_e)),
   IRON(2, 250, 6.0F, 2.0F, 14, () -> Ingredient.func_199804_a(Items.field_151042_j)),
   DIAMOND(3, 1561, 8.0F, 3.0F, 10, () -> Ingredient.func_199804_a(Items.field_151045_i)),
   GOLD(0, 32, 12.0F, 0.0F, 22, () -> Ingredient.func_199804_a(Items.field_151043_k));
   ...
   private ItemTier(int var3, int var4, float var5, float var6, int var7, Supplier<Ingredient> var8) {
      ...
      this.field_78011_i = ☃;
      this.field_78008_j = ☃;
      this.field_200940_k = new LazyLoadBase<>(☃);
   }
