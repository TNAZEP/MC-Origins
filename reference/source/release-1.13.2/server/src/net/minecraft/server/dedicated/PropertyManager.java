...
public class PropertyManager {
   ...
   public PropertyManager(File var1) {
      ...
      if (☃.exists()) {
         ...
         try {
            ☃ = new FileInputStream(☃);
            this.field_73672_b.load(☃);
         } catch (Exception var12) {
            field_164440_a.warn("Failed to load {}", ☃, var12);
            this.func_73666_a();
         } finally {
            if (☃ != null) {
               try {
         ...
         field_164440_a.warn("{} does not exist", ☃);
         this.func_73666_a();
      }
   }
   ...
   public void func_73668_b() {
      ...
      try {
         ☃ = new FileOutputStream(this.field_73673_c);
         this.field_73672_b.store(☃, "Minecraft server properties");
   ...
   public String func_73671_a(String var1, String var2) {
      if (!this.field_73672_b.containsKey(☃)) {
         this.field_73672_b.setProperty(☃, ☃);
         this.func_73668_b();
         this.func_73668_b();
      }

      return this.field_73672_b.getProperty(☃, ☃);
   }

   public int func_73669_a(String var1, int var2) {
      try {
         return Integer.parseInt(this.func_73671_a(☃, "" + ☃));
   ...
   public long func_179885_a(String var1, long var2) {
      try {
         return Long.parseLong(this.func_73671_a(☃, "" + ☃));
   ...
   public boolean func_73670_a(String var1, boolean var2) {
      try {
         return Boolean.parseBoolean(this.func_73671_a(☃, "" + ☃));
      } catch (Exception var4) {
         this.field_73672_b.setProperty(☃, "" + ☃);
         this.func_73668_b();
         return ☃;
   ...
   public boolean func_187239_a(String var1) {
      return this.field_73672_b.containsKey(☃);
   }

   public void func_187238_b(String var1) {
      this.field_73672_b.remove(☃);
   }
}
