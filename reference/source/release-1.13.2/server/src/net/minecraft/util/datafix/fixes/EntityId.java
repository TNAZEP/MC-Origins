...
public class EntityId extends DataFix {
   private static final Map<String, String> field_191276_a = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> ☃xx = this.getInputSchema().getType(TypeReferences.field_211295_k);
      Type<?> ☃xxx = this.getOutputSchema().getType(TypeReferences.field_211295_k);
      return TypeRewriteRule.seq(
         this.convertUnchecked("item stack entity name hook converter", ☃xx, ☃xxx),
         this.fixTypeEverywhere("EntityIdFix", ☃, ☃x, var0 -> var0x -> var0x.mapFirst(var0xx -> (String)field_191276_a.getOrDefault(var0xx, var0xx)))
      );
   }
}
