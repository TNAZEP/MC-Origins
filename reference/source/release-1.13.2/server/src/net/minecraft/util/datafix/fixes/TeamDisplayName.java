...
public class TeamDisplayName extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<Pair<String, Dynamic<?>>> ☃ = DSL.named(TypeReferences.field_211874_u.typeName(), DSL.remainderType());
      if (!Objects.equals(☃, this.getInputSchema().getType(TypeReferences.field_211874_u))) {
