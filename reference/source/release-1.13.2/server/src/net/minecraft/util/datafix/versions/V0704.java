...
public class V0704 extends Schema {
   protected static final Map<String, String> field_206647_b = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   protected static final HookFunction field_206648_c = new HookFunction() {
      ...
      public <T> T apply(DynamicOps<T> var1, T var2) {
         return V0099.func_209869_a(new Dynamic<>(☃, ☃), V0704.field_206647_b, "ArmorStand");
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference var1, String var2) {
      return Objects.equals(☃.typeName(), TypeReferences.field_211294_j.typeName())
         ? super.getChoiceType(☃, NamespacedSchema.func_206477_f(☃))
         : super.getChoiceType(☃, ☃);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema var1) {
      ...
      func_206645_a(☃, ☃, "minecraft:furnace");
      func_206645_a(☃, ☃, "minecraft:chest");
      ...
      func_206645_a(☃, ☃, "minecraft:dispenser");
      func_206645_a(☃, ☃, "minecraft:dropper");
      ...
      ☃.registerSimple(☃, "minecraft:noteblock");
      ☃.registerSimple(☃, "minecraft:piston");
      func_206645_a(☃, ☃, "minecraft:brewing_stand");
      ...
      func_206645_a(☃, ☃, "minecraft:hopper");
   ...
   public void registerTypes(Schema var1, Map<String, Supplier<TypeTemplate>> var2, Map<String, Supplier<TypeTemplate>> var3) {
      super.registerTypes(☃, ☃, ☃);
      ☃.registerType(false, TypeReferences.field_211294_j, () -> DSL.taggedChoiceLazy("id", DSL.namespacedString(), ☃));
      ☃.registerType(
         true,
