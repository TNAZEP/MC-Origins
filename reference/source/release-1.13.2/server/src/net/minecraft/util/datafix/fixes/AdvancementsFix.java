...
public class AdvancementsFix extends DataFix {
   private static final Map<String, String> field_209693_a = ImmutableMap.builder()
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped(
         "AdvancementsFix",
         this.getInputSchema().getType(TypeReferences.field_211293_i),
         var0 -> var0.update(DSL.remainderFinder(), var0x -> var0x.updateMapValues(var1 -> {
                  String ☃ = (String)((Dynamic)var1.getFirst()).getStringValue().orElse("");
                  return var1.mapFirst(var2x -> var0x.createString((String)field_209693_a.getOrDefault(☃, ☃)));
               }))
      );
   }
}
