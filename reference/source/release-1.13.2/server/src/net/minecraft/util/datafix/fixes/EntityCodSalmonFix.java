...
public class EntityCodSalmonFix extends TypedEntityRenameHelper {
   public static final Map<String, String> field_207460_a = ImmutableMap.builder()
      .put("minecraft:salmon_mob", "minecraft:salmon")
      .put("minecraft:cod_mob", "minecraft:cod")
      .build();
   public static final Map<String, String> field_209759_b = ImmutableMap.builder()
   ...
   public EntityCodSalmonFix(Schema var1, boolean var2) {
      super("EntityCodSalmonFix", ☃, ☃);
   }

   @Override
   protected String func_211311_a(String var1) {
      return (String)field_207460_a.getOrDefault(☃, ☃);
   }
}
