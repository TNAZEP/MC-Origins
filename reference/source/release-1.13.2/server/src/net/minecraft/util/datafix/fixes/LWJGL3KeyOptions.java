...
public class LWJGL3KeyOptions extends DataFix {
   private static final Int2ObjectMap<String> field_199186_a = DataFixUtils.make(new Int2ObjectOpenHashMap(), var0 -> {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         var0 -> var0.update(
               ...
               var0x -> (Dynamic)var0x.getMapValues()
                     .map(var1 -> var0x.createMap((Map<? extends Dynamic<?>, ? extends Dynamic<?>>)var1.entrySet().stream().map(var0xx -> {
                           if (((String)((Dynamic)var0xx.getKey()).getStringValue().orElse("")).startsWith("key_")) {
                              int ☃ = Integer.parseInt((String)((Dynamic)var0xx.getValue()).getStringValue().orElse(""));
                              if (☃ < 0) {
                                 int ☃xx = ☃ + 100;
                                 String ☃x;
                                 if (☃xx == 0) {
                                 ...
                                 return Pair.of(var0xx.getKey(), ((Dynamic)var0xx.getValue()).createString(☃x));
                              } else {
                                 String ☃ = (String)field_199186_a.getOrDefault(☃, "key.unknown");
                                 return Pair.of(var0xx.getKey(), ((Dynamic)var0xx.getValue()).createString(☃));
                              }
                           } else {
