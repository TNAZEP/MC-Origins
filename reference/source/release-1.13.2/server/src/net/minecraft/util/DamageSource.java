...
public class DamageSource {
   ...
   public static DamageSource func_76353_a(EntityArrow var0, @Nullable Entity var1) {
      return new EntityDamageSourceIndirect("arrow", ☃, ☃).func_76349_b();
   }

   public static DamageSource func_203096_a(Entity var0, @Nullable Entity var1) {
      return new EntityDamageSourceIndirect("trident", ☃, ☃).func_76349_b();
   }

   public static DamageSource func_76362_a(EntityFireball var0, @Nullable Entity var1) {
      return ☃ == null
         ? new EntityDamageSourceIndirect("onFire", ☃, ☃).func_76361_j().func_76349_b()
         : new EntityDamageSourceIndirect("fireball", ☃, ☃).func_76361_j().func_76349_b();
   }

   public static DamageSource func_76356_a(Entity var0, @Nullable Entity var1) {
      return new EntityDamageSourceIndirect("thrown", ☃, ☃).func_76349_b();
   }

   public static DamageSource func_76354_b(Entity var0, @Nullable Entity var1) {
      return new EntityDamageSourceIndirect("indirectMagic", ☃, ☃).func_76348_h().func_82726_p();
   }

   public static DamageSource func_92087_a(Entity var0) {
      return new EntityDamageSource("thorns", ☃).func_180138_v().func_82726_p();
   }

   public static DamageSource func_94539_a(@Nullable Explosion var0) {
      return ☃ != null && ☃.func_94613_c() != null
         ? new EntityDamageSource("explosion.player", ☃.func_94613_c()).func_76351_m().func_94540_d()
   ...
   public static DamageSource func_188405_b(@Nullable EntityLivingBase var0) {
      return ☃ != null
         ? new EntityDamageSource("explosion.player", ☃).func_76351_m().func_94540_d()
         : new DamageSource("explosion").func_76351_m().func_94540_d();
   }
   ...
   public ITextComponent func_151519_b(EntityLivingBase var1) {
      ...
      String ☃xx = ☃x + ".player";
      return ☃ != null ? new TextComponentTranslation(☃xx, ☃.func_145748_c_(), ☃.func_145748_c_()) : new TextComponentTranslation(☃x, ☃.func_145748_c_());
   }
   ...
   public boolean func_180136_u() {
      Entity ☃ = this.func_76346_g();
      return ☃ instanceof EntityPlayer && ((EntityPlayer)☃).field_71075_bZ.field_75098_d;
   }
