...
public class ChunkStructuresTemplateRenameFix extends DataFix {
   private static final ImmutableMap<String, Pair<String, ImmutableMap<String, String>>> field_207912_a = ImmutableMap.builder()
      .put(
         "EndCity",
         Pair.of(
            "ECP",
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder<?> ☃x = ☃.findField("Children");
      return this.fixTypeEverywhereTyped(
         "ChunkStructuresTemplateRenameFix",
         ☃,
         var2x -> var2x.updateTyped(☃, var2xx -> var2xx.update(DSL.remainderFinder(), var2xxx -> this.func_209729_a(var2x.get(DSL.remainderFinder()), var2xxx)))
      );
   }

   private Dynamic<?> func_209729_a(Dynamic<?> var1, Dynamic<?> var2) {
      String ☃ = ☃.getString("id");
      if (field_207912_a.containsKey(☃)) {
         Pair<String, ImmutableMap<String, String>> ☃x = field_207912_a.get(☃);
         if (((String)☃x.getFirst()).equals(☃.getString("id"))) {
            String ☃xx = ☃.getString("Template");
            ☃ = ☃.set("Template", ☃.createString((String)☃x.getSecond().getOrDefault(☃xx, ☃xx)));
         }
      }
