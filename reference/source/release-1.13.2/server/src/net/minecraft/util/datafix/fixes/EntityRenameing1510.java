...
public class EntityRenameing1510 extends TypedEntityRenameHelper {
   public static final Map<String, String> field_210595_a = ImmutableMap.builder()
      ...
      .build();
   public static final Map<String, String> field_210596_b = ImmutableMap.builder()
      ...
      .build();
   public static final Map<String, String> field_210597_c = ImmutableMap.builder()
      .putAll(field_210596_b)
   ...
   public EntityRenameing1510(Schema var1, boolean var2) {
      super("EntityTheRenameningBlock", ☃, ☃);
   }

   @Override
   protected String func_211311_a(String var1) {
      if (☃.startsWith("minecraft:bred_")) {
         ☃ = "minecraft:" + ☃.substring("minecraft:bred_".length());
      }

      return (String)field_210595_a.getOrDefault(☃, ☃);
   }
}
