...
public class BlockSourceImpl implements IBlockSource {
   ...
   public double func_82615_a() {
      return (double)this.field_179317_b.func_177958_n() + 0.5;
   }

   @Override
   public double func_82617_b() {
      return (double)this.field_179317_b.func_177956_o() + 0.5;
   }

   @Override
   public double func_82616_c() {
      return (double)this.field_179317_b.func_177952_p() + 0.5;
   }
