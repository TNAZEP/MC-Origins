...
public enum EnumConnectionState {
   ...
   private final Map<EnumPacketDirection, BiMap<Integer, Class<? extends Packet<?>>>> field_179247_h = Maps.newEnumMap(EnumPacketDirection.class);
   ...
   protected EnumConnectionState func_179245_a(EnumPacketDirection var1, Class<? extends Packet<?>> var2) {
      BiMap<Integer, Class<? extends Packet<?>>> ☃ = (BiMap)this.field_179247_h.get(☃);
      if (☃ == null) {
         ☃ = HashBiMap.create();
         this.field_179247_h.put(☃, ☃);
      }
   ...
   public Integer func_179246_a(EnumPacketDirection var1, Packet<?> var2) throws Exception {
      return (Integer)((BiMap)this.field_179247_h.get(☃)).inverse().get(☃.getClass());
   }

   @Nullable
   public Packet<?> func_179244_a(EnumPacketDirection var1, int var2) throws IllegalAccessException, InstantiationException {
      Class<? extends Packet<?>> ☃ = (Class)((BiMap)this.field_179247_h.get(☃)).get(☃);
      return ☃ == null ? null : (Packet)☃.newInstance();
   }
   ...
   public static EnumConnectionState func_150760_a(int var0) {
      return ☃ >= -1 && ☃ <= 2 ? field_150764_e[☃ - -1] : null;
   }

   public static EnumConnectionState func_150752_a(Packet<?> var0) {
      return (EnumConnectionState)field_150761_f.get(☃.getClass());
   }
   ...
   static {
      for(EnumConnectionState ☃ : values()) {
         ...
         for(EnumPacketDirection ☃x : ☃.field_179247_h.keySet()) {
            for(Class<? extends Packet<?>> ☃xx : ((BiMap)☃.field_179247_h.get(☃x)).values()) {
               if (field_150761_f.containsKey(☃xx) && field_150761_f.get(☃xx) != ☃) {
                  throw new Error("Packet " + ☃xx + " is already assigned to protocol " + field_150761_f.get(☃xx) + " - can't reassign to " + ☃);
               }

               try {
                  ☃xx.newInstance();
               } catch (Throwable var10) {
                  throw new Error("Packet " + ☃xx + " fails instantiation checks! " + ☃xx);
               }

               field_150761_f.put(☃xx, ☃);
            }
         }
      }
   }
