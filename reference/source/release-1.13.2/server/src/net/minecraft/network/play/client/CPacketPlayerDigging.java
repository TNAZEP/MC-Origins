...
public class CPacketPlayerDigging implements Packet<INetHandlerPlayServer> {
   ...
   public void func_148837_a(PacketBuffer var1) throws IOException {
      this.field_149508_e = ☃.func_179257_a(CPacketPlayerDigging.Action.class);
      this.field_179717_a = ☃.func_179259_c();
      this.field_179716_b = EnumFacing.func_82600_a(☃.readUnsignedByte());
   }

   @Override
   public void func_148840_b(PacketBuffer var1) throws IOException {
      ☃.func_179249_a(this.field_149508_e);
      ☃.func_179255_a(this.field_179717_a);
      ☃.writeByte(this.field_179716_b.func_176745_a());
   }
