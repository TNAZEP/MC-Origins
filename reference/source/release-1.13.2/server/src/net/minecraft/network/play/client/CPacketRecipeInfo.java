...
public class CPacketRecipeInfo implements Packet<INetHandlerPlayServer> {
   ...
   public CPacketRecipeInfo(IRecipe var1) {
      ...
      this.field_193649_d = ☃.func_199560_c();
   }

   @Override
   public void func_148837_a(PacketBuffer var1) throws IOException {
      this.field_194157_a = ☃.func_179257_a(CPacketRecipeInfo.Purpose.class);
      if (this.field_194157_a == CPacketRecipeInfo.Purpose.SHOWN) {
         this.field_193649_d = ☃.func_192575_l();
      } else if (this.field_194157_a == CPacketRecipeInfo.Purpose.SETTINGS) {
         this.field_192631_e = ☃.readBoolean();
         this.field_192632_f = ☃.readBoolean();
         this.field_202498_e = ☃.readBoolean();
         this.field_202499_f = ☃.readBoolean();
      }
   }

   @Override
   public void func_148840_b(PacketBuffer var1) throws IOException {
      ☃.func_179249_a(this.field_194157_a);
      if (this.field_194157_a == CPacketRecipeInfo.Purpose.SHOWN) {
         ☃.func_192572_a(this.field_193649_d);
      } else if (this.field_194157_a == CPacketRecipeInfo.Purpose.SETTINGS) {
         ☃.writeBoolean(this.field_192631_e);
         ☃.writeBoolean(this.field_192632_f);
         ☃.writeBoolean(this.field_202498_e);
         ☃.writeBoolean(this.field_202499_f);
      }
   }
