...
public class Fluids {
   ...
   private static Fluid func_207211_a(String var0) {
      Fluid ☃ = IRegistry.field_212619_h.func_82594_a(new ResourceLocation(☃));
      if (!field_207214_f.add(☃)) {
         throw new IllegalStateException("Invalid Fluid requested: " + ☃);
      } else {
         return ☃;
      }
   }
   ...
   static {
      if (!Bootstrap.func_179869_a()) {
         ...
         field_207214_f = Sets.<Fluid>newHashSet((Fluid)null);
