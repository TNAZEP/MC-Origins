...
public class EntityAIRunAroundLikeCrazy extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (!this.field_111180_a.func_110248_bS() && this.field_111180_a.func_184207_aI()) {
         Vec3d ☃ = RandomPositionGenerator.func_75463_a(this.field_111180_a, 5, 4);
         if (☃ == null) {
            return false;
         } else {
            this.field_111179_c = ☃.field_72450_a;
            this.field_111176_d = ☃.field_72448_b;
            this.field_111177_e = ☃.field_72449_c;
            return true;
         }
      } else {
         return false;
   ...
   public void func_75246_d() {
      if (!this.field_111180_a.func_110248_bS() && this.field_111180_a.func_70681_au().nextInt(50) == 0) {
         ...
         if (☃ instanceof EntityPlayer) {
            int ☃ = this.field_111180_a.func_110252_cg();
            int ☃x = this.field_111180_a.func_190676_dC();
            if (☃x > 0 && this.field_111180_a.func_70681_au().nextInt(☃x) < ☃) {
