...
public class EntityBlaze extends EntityMob {
   ...
   public EntityBlaze(World var1) {
      super(EntityType.field_200792_f, ☃);
   ...
   protected void func_70619_bc() {
      ...
      if (☃ != null && ☃.field_70163_u + (double)☃.func_70047_e() > this.field_70163_u + (double)this.func_70047_e() + (double)this.field_70847_d) {
         this.field_70181_x += (0.3F - this.field_70181_x) * 0.3F;
   ...
   public void func_70844_e(boolean var1) {
      byte ☃ = this.field_70180_af.func_187225_a(field_184712_c);
      if (☃) {
         ☃ = (byte)(☃ | 1);
      } else {
         ☃ = (byte)(☃ & -2);
      ...
      this.field_70180_af.func_187227_b(field_184712_c, ☃);
   }
   ...
   static class AIFireballAttack extends EntityAIBase {
      ...
      public boolean func_75250_a() {
         EntityLivingBase ☃ = this.field_179469_a.func_70638_az();
      ...
      public void func_75246_d() {
         --this.field_179468_c;
         EntityLivingBase ☃ = this.field_179469_a.func_70638_az();
         double ☃x = this.field_179469_a.func_70068_e(☃);
         if (☃x < 4.0) {
            if (this.field_179468_c <= 0) {
               this.field_179468_c = 20;
               this.field_179469_a.func_70652_k(☃);
            }

            this.field_179469_a.func_70605_aq().func_75642_a(☃.field_70165_t, ☃.field_70163_u, ☃.field_70161_v, 1.0);
         } else if (☃x < this.func_191523_f() * this.func_191523_f()) {
            double ☃ = ☃.field_70165_t - this.field_179469_a.field_70165_t;
            double ☃x = ☃.func_174813_aQ().field_72338_b
               + (double)(☃.field_70131_O / 2.0F)
               - (this.field_179469_a.field_70163_u + (double)(this.field_179469_a.field_70131_O / 2.0F));
            double ☃xx = ☃.field_70161_v - this.field_179469_a.field_70161_v;
            if (this.field_179468_c <= 0) {
               ++this.field_179467_b;
               ...
               if (this.field_179467_b > 1) {
                  float ☃xxx = MathHelper.func_76129_c(MathHelper.func_76133_a(☃x)) * 0.5F;
                  this.field_179469_a
                     .field_70170_p
                     .func_180498_a(
                        null,
                        1018,
                        new BlockPos((int)this.field_179469_a.field_70165_t, (int)this.field_179469_a.field_70163_u, (int)this.field_179469_a.field_70161_v),
                        0
                     );

                  for(int ☃xxxx = 0; ☃xxxx < 1; ++☃xxxx) {
                     EntitySmallFireball ☃xxxxx = new EntitySmallFireball(
                        this.field_179469_a.field_70170_p,
                        this.field_179469_a,
                        ☃ + this.field_179469_a.func_70681_au().nextGaussian() * (double)☃xxx,
                        ☃x,
                        ☃xx + this.field_179469_a.func_70681_au().nextGaussian() * (double)☃xxx
                     );
                     ☃xxxxx.field_70163_u = this.field_179469_a.field_70163_u + (double)(this.field_179469_a.field_70131_O / 2.0F) + 0.5;
                     this.field_179469_a.field_70170_p.func_72838_d(☃xxxxx);
                  }
               }
            }

            this.field_179469_a.func_70671_ap().func_75651_a(☃, 10.0F, 10.0F);
         } else {
      ...
      private double func_191523_f() {
         IAttributeInstance ☃ = this.field_179469_a.func_110148_a(SharedMonsterAttributes.field_111265_b);
