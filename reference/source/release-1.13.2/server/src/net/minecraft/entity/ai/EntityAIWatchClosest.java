      ...
      if (this.field_75332_b.func_70681_au().nextFloat() >= this.field_75331_e) {
         ...
         if (this.field_75329_f == EntityPlayer.class) {
            this.field_75334_a = this.field_75332_b
               .field_70170_p
               .func_190525_a(
                  this.field_75332_b.field_70165_t,
                  this.field_75332_b.field_70163_u,
                  this.field_75332_b.field_70161_v,
                  (double)this.field_75333_c,
                  EntitySelectors.field_180132_d.and(EntitySelectors.func_200820_b(this.field_75332_b))
               );
         } else {
            this.field_75334_a = this.field_75332_b
               .field_70170_p
               .func_72857_a(
                  this.field_75329_f,
                  this.field_75332_b.func_174813_aQ().func_72314_b((double)this.field_75333_c, 3.0, (double)this.field_75333_c),
                  this.field_75332_b
               );
         }
   ...
   public void func_75246_d() {
      this.field_75332_b
         ...
         .func_75650_a(
            ...
            (float)this.field_75332_b.func_184649_cE(),
