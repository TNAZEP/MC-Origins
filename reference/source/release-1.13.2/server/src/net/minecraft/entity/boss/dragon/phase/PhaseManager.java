...
public class PhaseManager {
   ...
   public void func_188758_a(PhaseType<?> var1) {
      if (this.field_188762_d == null || ☃ != this.field_188762_d.func_188652_i()) {
         if (this.field_188762_d != null) {
            this.field_188762_d.func_188658_e();
         }

         this.field_188762_d = this.func_188757_b(☃);
         if (!this.field_188760_b.field_70170_p.field_72995_K) {
            this.field_188760_b.func_184212_Q().func_187227_b(EntityDragon.field_184674_a, ☃.func_188740_b());
         }

         field_188759_a.debug("Dragon is now in phase {} on the {}", ☃, this.field_188760_b.field_70170_p.field_72995_K ? "client" : "server");
   ...
   public <T extends IPhase> T func_188757_b(PhaseType<T> var1) {
      int ☃ = ☃.func_188740_b();
      if (this.field_188761_c[☃] == null) {
         this.field_188761_c[☃] = ☃.func_188736_a(this.field_188760_b);
      }

      return (T)this.field_188761_c[☃];
   }
}
