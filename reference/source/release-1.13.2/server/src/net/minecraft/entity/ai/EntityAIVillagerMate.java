...
public class EntityAIVillagerMate extends EntityAIBase {
   ...
   public EntityAIVillagerMate(EntityVillager var1) {
      this.field_75450_b = ☃;
      this.field_75448_d = ☃.field_70170_p;
      this.func_75248_a(3);
   }
   ...
   private boolean func_75446_f() {
      if (!this.field_75452_a.func_82686_i()) {
         ...
         int ☃ = (int)((double)((float)this.field_75452_a.func_75567_c()) * 0.35);
         return this.field_75452_a.func_75562_e() < ☃;
      }
   }

   private void func_75447_i() {
      EntityVillager ☃ = this.field_75450_b.func_90011_a(this.field_75451_c);
      ...
      ☃.func_70873_a(-24000);
      ☃.func_70012_b(this.field_75450_b.field_70165_t, this.field_75450_b.field_70163_u, this.field_75450_b.field_70161_v, 0.0F, 0.0F);
      this.field_75448_d.func_72838_d(☃);
      this.field_75448_d.func_72960_a(☃, (byte)12);
   }
}
