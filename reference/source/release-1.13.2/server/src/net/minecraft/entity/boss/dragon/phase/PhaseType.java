...
public class PhaseType<T extends IPhase> {
   ...
   public IPhase func_188736_a(EntityDragon var1) {
      try {
         Constructor<? extends IPhase> ☃ = this.func_188737_a();
         return (IPhase)☃.newInstance(☃);
   ...
   public static PhaseType<?> func_188738_a(int var0) {
      return ☃ >= 0 && ☃ < field_188752_l.length ? field_188752_l[☃] : field_188741_a;
   }
