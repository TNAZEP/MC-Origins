...
public class EntityDonkey extends AbstractChestHorse {
   public EntityDonkey(World var1) {
      super(EntityType.field_200798_l, ☃);
   }
   ...
   public EntityAgeable func_90011_a(EntityAgeable var1) {
      AbstractHorse ☃ = (AbstractHorse)(☃ instanceof EntityHorse ? new EntityMule(this.field_70170_p) : new EntityDonkey(this.field_70170_p));
      this.func_190681_a(☃, ☃);
      return ☃;
   }
}
